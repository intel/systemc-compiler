...
bool VerilogKeywords::init = false;

std::string VerilogKeywords::keywords[] = 
{
...
"unique", "unsigned", "use", "uwire", "var", 
"vectored", "virtual", "void", "wait", "wait_order", 
"wand", "weak0", "weak1", "while", "wildcard", 
"wire", "with", "within", "wor", "xnor", 
"xor" 
};

std::unordered_set<std::string> VerilogKeywords::wordset;
