...
const std::string SCElabASTConsumer::TOOL_VERSION = "1.3.14";
const std::string SCElabASTConsumer::TOOL_DATE = "03 Mar, 2021";

void SCElabASTConsumer::HandleTranslationUnit(clang::ASTContext &astCtx)
{
    std::cout << "--------------------------------------------------------------" << std::endl;
    std::cout << " Intel Compiler for SystemC (ICSC) version "  <<
                  TOOL_VERSION << ", " << TOOL_DATE << std::endl;
    std::cout << "--------------------------------------------------------------" << std::endl;
    
    //replaceConstByValue.setValue(true);
    //std::cout << "replaceConstByValue " << replaceConstByValue << std::endl;
                            ...
                            const std::unordered_map<size_t, size_t>& movedObjs) 
{
    ...
    ofs << "//==============================================================================\n";
    ofs << "//\n";
    ofs << "// The code is generated by Intel Compiler for SystemC, version " << 
           TOOL_VERSION << "\n";
