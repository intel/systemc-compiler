...
\subsection{Special assertions}\label{section:latch_assert}

Beside immediate and temporal assertions, there are special assertions mostly intended for tool developers. Only {\tt sct\_assert\_latch} assertion is considered to be used in the design code, see~\ref{section:method_latches}.
%
\begin{itemize}
