...
// C++ data variables
localparam logic [31:0] N = 'd4000000;

//------------------------------------------------------------------------------
// Clocked THREAD: tests (test_fifo.cpp:75:5) 
...
always_comb begin : tests_comb     // test_fifo.cpp:75:5
    tests_func;
end
function void tests_func;
    ...
    case (tests_PROC_STATE)
        default : begin
            ...
            tests_PROC_STATE_next = 0; return;    // test_fifo.cpp:77:9;
        end
        0: begin
            ...
            i_next = 0;
            in_next = i_next;
            tests_PROC_STATE_next = 1; return;    // test_fifo.cpp:82:13;
        end
        1: begin
            i_next++;
            if (i_next < N)
...
//------------------------------------------------------------------------------
// Clocked THREAD: reqProc (test_fifo.cpp:29:5) 
...
// Next-state combinational logic
always_comb begin : reqProc_comb     // test_fifo.cpp:29:5
    reqProc_func;
end
...
//------------------------------------------------------------------------------
// Clocked THREAD: respProc (test_fifo.cpp:40:5) 
...
// Next-state combinational logic
always_comb begin : respProc_comb     // test_fifo.cpp:40:5
    respProc_func;
end
