...
function(svc_target exe_target)
    ...
    # Flags:
    # KEEP_CONST_VARIABLES -- keep constant variable not replace them with value
    ...
    set(boolOptions KEEP_CONST_VARIABLES 
                    NO_SVA_GENERATE
    ...
    set(oneValueArgs GOLDEN ELAB_TOP)
    ...
    if (${PARAM_KEEP_CONST_VARIABLES})
        set(KEEP_CONST_VARIABLES -keep_const_variables)
    endif()
    ...
    set(TOOL_OPTS
            ...
            -std=c++14 ${INCLUDE_DIRS} ${COMP_DEFINITIONS}
    ...
    if (PARAM_GOLDEN)
        add_test(NAME ${exe_target}_DIFF COMMAND sh -c "diff -U 3 -dHrN \"${VERILOG_OUT}\" \"${CMAKE_CURRENT_SOURCE_DIR}/${PARAM_GOLDEN}\" > ${exe_target}.diff"
                )
