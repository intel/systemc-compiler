...
begin : assign_proc     // test_const_negative.cpp:74:5
    ...
    j_1 = 6'd42;
    `ifndef INTEL_SVA_OFF
        assert (j_1 == 6'd42) else $error("Assertion failed at test_const_negative.cpp:24:20>");
    `endif // INTEL_SVA_OFF
    j_1 = -7'sd42;
    `ifndef INTEL_SVA_OFF
    ...
    j_2 = 42;
    `ifndef INTEL_SVA_OFF
        assert (j_2 == 7'sd42) else $error("Assertion failed at test_const_negative.cpp:24:20>");
    `endif // INTEL_SVA_OFF
    j_2 = -7'sd42;
    `ifndef INTEL_SVA_OFF
    ...
    j_3 = 6'd42;
    `ifndef INTEL_SVA_OFF
        assert (j_3 == 6'd42) else $error("Assertion failed at test_const_negative.cpp:24:20>");
    `endif // INTEL_SVA_OFF
    j_3 = -7'sd42;
    `ifndef INTEL_SVA_OFF
    ...
    j_4 = 6'd42;
    `ifndef INTEL_SVA_OFF
        assert (j_4 == 6'd42) else $error("Assertion failed at test_const_negative.cpp:24:20>");
    `endif // INTEL_SVA_OFF
    j_4 = -7'sd42;
    `ifndef INTEL_SVA_OFF
    ...
    j_5 = 42;
    `ifndef INTEL_SVA_OFF
        assert (j_5 == 7'sd42) else $error("Assertion failed at test_const_negative.cpp:24:20>");
    `endif // INTEL_SVA_OFF
    j_5 = -7'sd42;
    `ifndef INTEL_SVA_OFF
    ...
    j_6 = 6'd42;
    `ifndef INTEL_SVA_OFF
        assert (signed'({1'b0, j_6}) == 7'sd42) else $error("Assertion failed at test_const_negative.cpp:24:20>");
    `endif // INTEL_SVA_OFF
    j_6 = -7'sd42;
    `ifndef INTEL_SVA_OFF
    ...
    j_7 = C2;
    `ifndef INTEL_SVA_OFF
        assert (j_7 == 7'sd42) else $error("Assertion failed at test_const_negative.cpp:24:20>");
    `endif // INTEL_SVA_OFF
    j_7 = -C2;
    `ifndef INTEL_SVA_OFF
    ...
    k = -signed'({1'b0, l1_7});
    `ifndef INTEL_SVA_OFF
        assert (signed'({1'b0, k}) == 17'sd65494) else $error("Assertion failed at test_const_negative.cpp:24:20>");
    `endif // INTEL_SVA_OFF
    l2 = 6'd42;
    j_8 = -signed'({1'b0, l2});
    `ifndef INTEL_SVA_OFF
...
begin : unary_proc     // test_const_negative.cpp:163:5
    ...
    j_1++;
    `ifndef INTEL_SVA_OFF
        assert (j_1 == 1'd1) else $error("Assertion failed at test_const_negative.cpp:24:20>");
    `endif // INTEL_SVA_OFF
    j_1 = -C1;
    j_1 = j_1;
    `ifndef INTEL_SVA_OFF
    ...
    j_1 = ~j_1;
    `ifndef INTEL_SVA_OFF
        assert (j_1 == 6'd41) else $error("Assertion failed at test_const_negative.cpp:24:20>");
    `endif // INTEL_SVA_OFF
    // Call unary() end
    ...
    j_2++;
    `ifndef INTEL_SVA_OFF
        assert (j_2 == 2'sd1) else $error("Assertion failed at test_const_negative.cpp:24:20>");
    `endif // INTEL_SVA_OFF
    j_2 = -C1;
    j_2 = j_2;
    `ifndef INTEL_SVA_OFF
    ...
    j_2 = ~j_2;
    `ifndef INTEL_SVA_OFF
        assert (j_2 == 7'sd41) else $error("Assertion failed at test_const_negative.cpp:24:20>");
    `endif // INTEL_SVA_OFF
    // Call unary() end
    neg_val1_3 = 16'd65535; neg_val2_3 = 16'd65494;
    // Call unary() begin
    j_3 = 1'd1;
    j_3--;
    j_3--;
    ...
    j_3++;
    `ifndef INTEL_SVA_OFF
        assert (j_3 == 1'd1) else $error("Assertion failed at test_const_negative.cpp:24:20>");
    `endif // INTEL_SVA_OFF
    j_3 = -C1;
    j_3 = j_3;
    `ifndef INTEL_SVA_OFF
    ...
    j_3 = ~j_3;
    `ifndef INTEL_SVA_OFF
        assert (j_3 == 6'd41) else $error("Assertion failed at test_const_negative.cpp:24:20>");
    `endif // INTEL_SVA_OFF
    // Call unary() end
    ...
    j_4++;
    `ifndef INTEL_SVA_OFF
        assert (j_4 == 1'd1) else $error("Assertion failed at test_const_negative.cpp:24:20>");
    `endif // INTEL_SVA_OFF
    j_4 = -C1;
    j_4 = j_4;
    `ifndef INTEL_SVA_OFF
    ...
    j_4 = ~j_4;
    `ifndef INTEL_SVA_OFF
        assert (j_4 == 6'd41) else $error("Assertion failed at test_const_negative.cpp:24:20>");
    `endif // INTEL_SVA_OFF
    // Call unary() end
    ...
    j_5++;
    `ifndef INTEL_SVA_OFF
        assert (j_5 == 2'sd1) else $error("Assertion failed at test_const_negative.cpp:24:20>");
    `endif // INTEL_SVA_OFF
    j_5 = -C1;
    j_5 = j_5;
    `ifndef INTEL_SVA_OFF
    ...
    j_6++;
    `ifndef INTEL_SVA_OFF
        assert (signed'({1'b0, j_6}) == 2'sd1) else $error("Assertion failed at test_const_negative.cpp:24:20>");
    `endif // INTEL_SVA_OFF
    j_6 = -C1;
    j_6 = j_6;
    `ifndef INTEL_SVA_OFF
...
begin : binary_proc     // test_const_negative.cpp:242:5
    ...
    `endif // INTEL_SVA_OFF
    // Call binary() end
    neg_val1_1 = 32'hFFFFFFD7; neg_val2_1 = 32'hFFFFFFAC; neg_val3_1 = 1'd0; doDiv_1 = 0;
    // Call binary() begin
    j_1 = -C1;
    r_1 = 32'(j_1 + 1'd1);
    `ifndef INTEL_SVA_OFF
    ...
    r_1 = -C1 - (-j_1);
    r_1 = -C1 - j_1;
    r_1 = 32'(32'(j_1 * 1'd1) - 2'sd1 * (-2'sd1));
    `ifndef INTEL_SVA_OFF
        assert (r_1 == neg_val1_1) else $error("Assertion failed at test_const_negative.cpp:24:20>");
    `endif // INTEL_SVA_OFF
    r_1 = 32'((-j_1) * (-3'sd2));
    ...
    `ifndef INTEL_SVA_OFF
        assert (r_2 == neg_val1_2) else $error("Assertion failed at test_const_negative.cpp:24:20>");
    `endif // INTEL_SVA_OFF
    r_2 = 19'(-j_2 * 4'sd4) / (-3'sd2);
    `ifndef INTEL_SVA_OFF
        assert (r_2 == neg_val3_2) else $error("Assertion failed at test_const_negative.cpp:24:20>");
    `endif // INTEL_SVA_OFF
    // Call binary() end
    neg_val1_3 = 16'd65495; neg_val2_3 = 16'd65452; neg_val3_3 = 1'd0; doDiv_3 = 0;
    // Call binary() begin
    j_3 = -C1;
    r_3 = j_3 + 1'd1;
    `ifndef INTEL_SVA_OFF
    ...
    `endif // INTEL_SVA_OFF
    // Call binary() end
    neg_val1_4 = 33'h1FFFFFFD7; neg_val2_4 = 33'h1FFFFFFAC; neg_val3_4 = 1'd0; doDiv_4 = 0;
    // Call binary() begin
    j_4 = -C1;
    r_4 = j_4 + 1'd1;
    `ifndef INTEL_SVA_OFF
    ...
    r_6 = -C1 - signed'({1'b0, j_6});
    r_6 = signed'({1'b0, j_6}) * 2'sd1 - 2'sd1 * (-2'sd1);
    `ifndef INTEL_SVA_OFF
        assert (r_6 == neg_val1_6) else $error("Assertion failed at test_const_negative.cpp:24:20>");
    `endif // INTEL_SVA_OFF
    ...
    `ifndef INTEL_SVA_OFF
        assert (r_6 == neg_val1_6) else $error("Assertion failed at test_const_negative.cpp:24:20>");
    `endif // INTEL_SVA_OFF
    r_6 = 36'(-signed'({1'b0, j_6}) * 4'sd4) / (-3'sd2);
    `ifndef INTEL_SVA_OFF
    ...
    j_7 = -7'sd42;
    r_7 = signed'({1'b0, j_7}) / 2'sd1 - 2'sd1 / (-2'sd1);
    `ifndef INTEL_SVA_OFF
        assert (signed'({1'b0, r_7}) == 17'sd65495) else $error("Assertion failed at test_const_negative.cpp:24:20>");
    `endif // INTEL_SVA_OFF
    r_7 = 19'(-signed'({1'b0, j_7}) * 4'sd4) / (-3'sd2);
    `ifndef INTEL_SVA_OFF
        assert (signed'({1'b0, r_7}) == 17'sd65452) else $error("Assertion failed at test_const_negative.cpp:24:20>");
    `endif // INTEL_SVA_OFF
    y = -4'sd5;
    z = y - signed'({1'b0, j_7});
    `ifndef INTEL_SVA_OFF
        assert (z == 7'sd37) else $error("Assertion failed at test_const_negative.cpp:24:20>");
    `endif // INTEL_SVA_OFF
    z = -y * signed'({1'b0, j_7});
    `ifndef INTEL_SVA_OFF
    ...
    `endif // INTEL_SVA_OFF
    l1 = 6'd42;
    k = 2'sd1 + (-signed'({1'b0, l1}));
    `ifndef INTEL_SVA_OFF
        assert (signed'({1'b0, k}) == 17'sd65495) else $error("Assertion failed at test_const_negative.cpp:24:20>");
    `endif // INTEL_SVA_OFF
    l2 = 6'd42;
    jj = 2'sd1 + (-signed'({1'b0, l2}));
    `ifndef INTEL_SVA_OFF
...
begin : compound_proc     // test_const_negative.cpp:342:5
    ...
    j = j * 2'sd1;
    `ifndef INTEL_SVA_OFF
        assert (32'(j + 2'sd1) == neg_val1) else $error("Assertion failed at test_const_negative.cpp:24:20>");
    `endif // INTEL_SVA_OFF
    j = C1;
    j = j * (-3'sd2);
    `ifndef INTEL_SVA_OFF
    ...
    j = j / (-3'sd2);
    // Call compound() end
    neg_val1_1 = 32'hFFFFFFD7; neg_val2_1 = 32'hFFFFFFAC; neg_val3_1 = 1'd0;
    // Call compound() begin
    j_1 = -C1;
    j_1 = j_1 + 1'd1;
    `ifndef INTEL_SVA_OFF
    ...
    j_1 = j_1 * 1'd1;
    `ifndef INTEL_SVA_OFF
        assert (32'(j_1 + 1'd1) == neg_val1_1) else $error("Assertion failed at test_const_negative.cpp:24:20>");
    `endif // INTEL_SVA_OFF
    j_1 = C1;
    j_1 = j_1 * (-3'sd2);
    `ifndef INTEL_SVA_OFF
    ...
    j_2 = j_2 * 2'sd1;
    `ifndef INTEL_SVA_OFF
        assert (17'(j_2 + 2'sd1) == neg_val1_2) else $error("Assertion failed at test_const_negative.cpp:24:20>");
    `endif // INTEL_SVA_OFF
    j_2 = C1;
    j_2 = j_2 * (-3'sd2);
    `ifndef INTEL_SVA_OFF
    ...
    j_2 = j_2 / (-3'sd2);
    // Call compound() end
    neg_val1_3 = 16'd65495; neg_val2_3 = 16'd65452; neg_val3_3 = 1'd0;
    // Call compound() begin
    j_3 = -C1;
    j_3 = j_3 + 1'd1;
    `ifndef INTEL_SVA_OFF
    ...
    j_3 = j_3 * 1'd1;
    `ifndef INTEL_SVA_OFF
        assert (17'(j_3 + 1'd1) == neg_val1_3) else $error("Assertion failed at test_const_negative.cpp:24:20>");
    `endif // INTEL_SVA_OFF
    j_3 = C1;
    j_3 = j_3 * (-3'sd2);
    `ifndef INTEL_SVA_OFF
    ...
    j_3 = j_3 / (-3'sd2);
    // Call compound() end
    neg_val1_4 = 33'h1FFFFFFD7; neg_val2_4 = 33'h1FFFFFFAC; neg_val3_4 = 1'd0;
    // Call compound() begin
    j_4 = -C1;
    j_4 = j_4 + 1'd1;
    `ifndef INTEL_SVA_OFF
    ...
    j_4 = j_4 * 1'd1;
    `ifndef INTEL_SVA_OFF
        assert (34'(j_4 + 1'd1) == neg_val1_4) else $error("Assertion failed at test_const_negative.cpp:24:20>");
    `endif // INTEL_SVA_OFF
    j_4 = C1;
    j_4 = j_4 * (-3'sd2);
    `ifndef INTEL_SVA_OFF
    ...
    j_5 = j_5 * 2'sd1;
    `ifndef INTEL_SVA_OFF
        assert (34'(j_5 + 2'sd1) == neg_val1_5) else $error("Assertion failed at test_const_negative.cpp:24:20>");
    `endif // INTEL_SVA_OFF
    j_5 = C1;
    j_5 = j_5 * (-3'sd2);
    `ifndef INTEL_SVA_OFF
    ...
    j_6 = j_6 * 1;
    `ifndef INTEL_SVA_OFF
        assert (34'(signed'({1'b0, j_6}) + 2'sd1) == signed'({1'b0, neg_val1_6})) else $error("Assertion failed at test_const_negative.cpp:24:20>");
    `endif // INTEL_SVA_OFF
    j_6 = C1;
    j_6 = j_6 * (-3'sd2);
    `ifndef INTEL_SVA_OFF
    ...
    j_7 = j_7 / 1;
    `ifndef INTEL_SVA_OFF
        assert (signed'({1'b0, j_7}) == 17'sd65494) else $error("Assertion failed at test_const_negative.cpp:24:20>");
    `endif // INTEL_SVA_OFF
    j_7 = -7'sd42;
    j_7 = j_7 * (-4'sd4);
    j_7 = j_7 / (-3'sd2);
    ...
    y = y + (-signed'({1'b0, j_7}));
    `ifndef INTEL_SVA_OFF
        assert (y == 7'sd37) else $error("Assertion failed at test_const_negative.cpp:24:20>");
    `endif // INTEL_SVA_OFF
    y = y * signed'({1'b0, j_7});
    `ifndef INTEL_SVA_OFF
    ...
    jj = jj + signed'({1'b0, l2});
    `ifndef INTEL_SVA_OFF
        assert (jj == 2'sd1) else $error("Assertion failed at test_const_negative.cpp:24:20>");
    `endif // INTEL_SVA_OFF
    jj = -7'sd41;
    jj = jj - signed'({1'b0, l2});
    `ifndef INTEL_SVA_OFF
