...
//------------------------------------------------------------------------------
// Method process: slave_methProc (test_sc_port_array2.cpp:74:5) 
...
always_comb 
begin : slave_methProc     // test_sc_port_array2.cpp:74:5
    logic [3:0] val;
    logic [3:0] l;
    logic [3:0] val_1;
    logic [3:0] l_1[2];
    ...
    i = tars_r[1];
    tars_a[1][i] = l_1[i];
    tars_t1[1] = tars_a[1][i];
    // Call fa() end
end

//------------------------------------------------------------------------------
// Clocked THREAD: slave_thrdProc1 (test_sc_port_array2.cpp:80:5) 
...
always_comb begin : slave_thrdProc1_comb     // test_sc_port_array2.cpp:80:5
...
//------------------------------------------------------------------------------
// Clocked THREAD: slave_thrdProc2 (test_sc_port_array2.cpp:90:5) 

// Thread-local variables
logic [3:0] tars_r_next[2];

// Next-state combinational logic
always_comb begin : slave_thrdProc2_comb     // test_sc_port_array2.cpp:90:5
