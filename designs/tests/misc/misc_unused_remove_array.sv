...
//------------------------------------------------------------------------------
// Method process: remove_local (test_unused_remove_array.cpp:50:5) 

always_comb 
begin : remove_local     // test_unused_remove_array.cpp:50:5
...
//------------------------------------------------------------------------------
// Method process: remove_member (test_unused_remove_array.cpp:135:5) 
...
always_comb 
begin : remove_member     // test_unused_remove_array.cpp:135:5
    t0 = m3[s];
    t0 = m4[s][1];
    t0 = 32'(m5[s][0]);
    m6[s] = m7[0];
...
//------------------------------------------------------------------------------
// Method process: remove_ref (test_unused_remove_array.cpp:209:5) 

always_comb 
begin : remove_ref     // test_unused_remove_array.cpp:209:5
end

//------------------------------------------------------------------------------
// Method process: not_remove_ref (test_unused_remove_array.cpp:223:5) 

always_comb 
begin : not_remove_ref     // test_unused_remove_array.cpp:223:5
    logic mm;
    integer a;
    logic aarr[3];
    logic barr[3];
...
//------------------------------------------------------------------------------
// Clocked THREAD: remove_member_thread (test_unused_remove_array.cpp:145:5) 
...
// Next-state combinational logic
always_comb begin : remove_member_thread_comb     // test_unused_remove_array.cpp:145:5
...
//------------------------------------------------------------------------------
// Clocked THREAD: remove_ref_thread (test_unused_remove_array.cpp:240:5) 
...
// Next-state combinational logic
always_comb begin : remove_ref_thread_comb     // test_unused_remove_array.cpp:240:5
...
function void remove_ref_thread_func;
    ...
    case (remove_ref_thread_PROC_STATE)
        0: begin
            remove_ref_thread_PROC_STATE_next = 1; return;    // test_unused_remove_array.cpp:244:13;
        end
        1: begin
            remove_ref_thread_PROC_STATE_next = 1; return;    // test_unused_remove_array.cpp:244:13;
        end
...
begin : remove_ref_thread_ff
    if ( ~nrst ) begin
        remove_ref_thread_PROC_STATE <= 0;    // test_unused_remove_array.cpp:241:9;
    end
    else begin
...
//------------------------------------------------------------------------------
// Clocked THREAD: not_remove_ref_thread (test_unused_remove_array.cpp:249:5) 
...
logic carr0[3];
logic carr_next[3];
logic signed [31:0] t0_next1;

// Next-state combinational logic
always_comb begin : not_remove_ref_thread_comb     // test_unused_remove_array.cpp:249:5
    not_remove_ref_thread_func;
end
function void not_remove_ref_thread_func;
    logic mm;
    integer a;
    aarr_next = aarr0;
    barr_next = barr0;
    carr_next = carr0;
    t0_next1 = t0;
    // Call not_remove_ref() begin
    mm = 0;
    a = 42 + mm;
    aarr_next[0] = 0; aarr_next[1] = 0; aarr_next[2] = 0;
    a = 42 + aarr_next[s];
    barr_next[0] = 0; barr_next[1] = 0; barr_next[2] = 0;
    // Call refParamZero() begin
    barr_next[s] = 1;
    // Call refParamZero() end
    carr_next[0] = 0; carr_next[1] = 0; carr_next[2] = 0;
    t0_next1 = aarr_next[0] + barr_next[0] + carr_next[0] + a;
    // Call not_remove_ref() end
endfunction

// Synchronous register update
always_ff @(posedge clk or negedge nrst) 
begin : not_remove_ref_thread_ff
    if ( ~nrst ) begin
    end
    else begin
        aarr0 <= aarr_next;
