...
function void sct_assert_1d_func;
    ...
    case (sct_assert_1d_PROC_STATE)
        0: begin
            sct_assert_1d_PROC_STATE_next = 0; return;    // test_sva_generate_proc_loop.cpp:65:13;
        end
    endcase
endfunction
...
function void sct_assert_2d_func;
    ...
    case (sct_assert_2d_PROC_STATE)
        0: begin
            sct_assert_2d_PROC_STATE_next = 0; return;    // test_sva_generate_proc_loop.cpp:87:13;
        end
    endcase
endfunction
