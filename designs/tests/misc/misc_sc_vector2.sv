...
logic signed [31:0] req3D[3][2][2];

// Local parameters generated for C++ constants
localparam logic [31:0] N = 3;

//------------------------------------------------------------------------------
// Clocked THREAD: mainProc (test_sc_vector2.cpp:101:5) 

// Thread-local variables
logic req_next[3];
logic signed [31:0] req3D_next[3][2][2];
logic [1:0] mainProc_PROC_STATE;
logic [1:0] mainProc_PROC_STATE_next;

// Next-state combinational logic
always_comb begin : mainProc_comb     // test_sc_vector2.cpp:101:5
    mainProc_func;
end
function void mainProc_func;
    ...
    case (mainProc_PROC_STATE)
        0: begin
            req_next[0] = 1'd1;
            mainProc_PROC_STATE_next = 1; return;    // test_sc_vector2.cpp:111:13;
        end
        1: begin
            req_next[0] = |req3D[0][0][0];
            if (!(|data[1]))
            begin
                mainProc_PROC_STATE_next = 2; return;    // test_sc_vector2.cpp:114:37;
            end
            req_next[1] = 1'd1;
            mainProc_PROC_STATE_next = 3; return;    // test_sc_vector2.cpp:116:13;
        end
        2: begin
            if (!(|data[1]))
            begin
...
begin : mainProc_ff
    if ( ~rstn ) begin
        ...
        begin
            req[i] <= '0;
            req2D[i][0] <= i;
            req3D[i][0][0] <= 32'(i + 2'sd1);
        end
        mainProc_PROC_STATE <= '0;    // test_sc_vector2.cpp:107:9;
    end
    else begin
        req <= req_next;
        req3D <= req3D_next;
...
//==============================================================================
//
// Module: Producer (test_sc_vector2.cpp:78:5)
//
