...
begin : constMeth     // test_const_large.cpp:45:5
    ...
    integer i;
    logic signed [63:0] d;
    a = 64'(64'(64'(64'(64'(64'(64'(64'(64'(64'(BIG_CONST1 + BIG_CONST2) + BIG_CONST3) + INT_CONST1) + INT_CONST2) + INT_CONST3) + INT_CONST4) + INT_CONST6) + INT_CONST7) + INT_CONST8) + INT_CONST9);
    b = 34'h2540BE400;
    b = -35'sh2540BE400;
    b = 64'(a + 34'h2540BE400);
    c = 64'(64'(BIG_CONST5 + BIG_CONST6) + BIG_CONST7);
    i = (-10'sh100) - 8'sd100;
    d = INT_CONST3;
    d = INT_CONST5;
    d = -32'sd2147483647;
