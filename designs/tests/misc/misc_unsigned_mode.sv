...
begin : unary     // test_unsigned_mode.cpp:40:5
    ...
    `ifndef INTEL_SVA_OFF
        assert (signed'({1'b0, bres}) == 21'shFFFF3) else $error("Assertion failed at test_unsigned_mode.cpp:38:24>");
    `endif // INTEL_SVA_OFF
    bres = --bx;
    bres = ++bx;
    bres = ~bx;
    `ifndef INTEL_SVA_OFF
        assert (signed'({1'b0, bres}) == 21'shFFFF2) else $error("Assertion failed at test_unsigned_mode.cpp:38:24>");
    `endif // INTEL_SVA_OFF
end
...
begin : binary     // test_unsigned_mode.cpp:62:5
    ...
    res = 32'(32'(u - u1) + u2);
    `ifndef INTEL_SVA_OFF
        assert (res == 4'd13) else $error("Assertion failed at test_unsigned_mode.cpp:38:24>");
    `endif // INTEL_SVA_OFF
    res = u - x + 2'd3;
    `ifndef INTEL_SVA_OFF
        assert (res == 1'd1) else $error("Assertion failed at test_unsigned_mode.cpp:38:24>");
    `endif // INTEL_SVA_OFF
    res = 2'd2 * (u - x) + u1;
    `ifndef INTEL_SVA_OFF
        assert (res == 4'd9) else $error("Assertion failed at test_unsigned_mode.cpp:38:24>");
    `endif // INTEL_SVA_OFF
end
...
begin : biguint     // test_unsigned_mode.cpp:99:5
    ...
    bres = 4'sd4 / (signed'({1'b0, bx}) - 5'sd15) + signed'({1'b0, x});
    `ifndef INTEL_SVA_OFF
        assert (signed'({1'b0, bres}) == 5'sd10) else $error("Assertion failed at test_unsigned_mode.cpp:38:24>");
    `endif // INTEL_SVA_OFF
    bres = 32'(5'd31 + u);
    bres = u - 12'd42;
    bres = 32'(u - 32'd42);
