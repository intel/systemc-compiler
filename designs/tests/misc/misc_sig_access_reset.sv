...
function void assert_sig_func;
    ...
    case (assert_sig_PROC_STATE)
        0: begin
            assert_sig_PROC_STATE_next = 1; return;    // test_sig_access_reset.cpp:96:13;
        end
        1: begin
            assert_sig_PROC_STATE_next = 1; return;    // test_sig_access_reset.cpp:96:13;
        end
...
begin : assert_sig_ff
    if ( rst ) begin
        tb <= 0;
        rb <= 0;
        assert_sig_PROC_STATE <= 0;    // test_sig_access_reset.cpp:92:9;
...
function void assert_global_func;
    ...
    case (assert_global_PROC_STATE)
        0: begin
            assert_global_PROC_STATE_next = 1; return;    // test_sig_access_reset.cpp:115:13;
        end
        1: begin
            assert_global_PROC_STATE_next = 1; return;    // test_sig_access_reset.cpp:115:13;
        end
...
begin : assert_global_ff
    if ( rst ) begin
        a <= 0;
        c <= 1;
        assert_global_PROC_STATE <= 0;    // test_sig_access_reset.cpp:111:9;
...
function void assert_local_func;
    ...
    case (assert_local_PROC_STATE)
        0: begin
            assert_local_PROC_STATE_next = 1; return;    // test_sig_access_reset.cpp:133:13;
        end
        1: begin
            assert_local_PROC_STATE_next = 1; return;    // test_sig_access_reset.cpp:133:13;
        end
...
begin : assert_local_ff
    if ( rst ) begin
        g <= 0;
        h <= 0;
        assert_local_PROC_STATE <= 0;    // test_sig_access_reset.cpp:129:9;
