...
struct A : public sc_module 
{
    ...
    A(const sc_module_name& name) : sc_module(name) 
    {
        ...
        async_reset_signal_is(nrst, 0);
        SC_CTHREAD(not_remove_ref_thread, clk.pos());
        async_reset_signal_is(nrst, 0);
    }
