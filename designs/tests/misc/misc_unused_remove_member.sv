...
function void remove_member2_thread_func;
    ...
    case (remove_member2_thread_PROC_STATE)
        0: begin
            ...
            mmt = 1;
            t0c_next = mmt++;
            remove_member2_thread_PROC_STATE_next = 0; return;    // test_unused_remove_member.cpp:175:13;
        end
    endcase
endfunction
...
begin : remove_member2_thread_ff
    if ( ~nrst ) begin
        mm <= 1;
        remove_member2_thread_PROC_STATE <= 0;    // test_unused_remove_member.cpp:167:9;
    end
    else begin
        mm <= mm_next;
        t0c <= t0c_next;
