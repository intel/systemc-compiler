    ...
    case (remove_vars1_thread_PROC_STATE)
        0: begin
            ...
            begin
                ...
                remove_vars1_thread_PROC_STATE_next = 1; return;    // test_unused_remove_general.cpp:103:43;
            end
            i_next = r;
            remove_vars1_thread_PROC_STATE_next = 2; return;    // test_unused_remove_general.cpp:105:13;
        end
        1: begin
            if (!(|s))
            begin
