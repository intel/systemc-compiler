...
begin : zero_width_ff
    ...
    `ifndef INTEL_SVA_OFF
        sctAssertLine209r : assert property ( 0 |-> 0 );
        sctAssertLine210r : assert property ( 0 |-> 0 );
    `endif // INTEL_SVA_OFF
    end
    else begin

    `ifndef INTEL_SVA_OFF
        sctAssertLine209 : assert property ( 0 |-> 0 );
        sctAssertLine210 : assert property ( 0 |-> 0 );
    `endif // INTEL_SVA_OFF
    end
end
...
begin : sct_assert_thread_var1_ff
    ...
    `ifndef INTEL_SVA_OFF
        sctAssertLine341r : assert property ( |c_next |=> d_next == 1 );
    `endif // INTEL_SVA_OFF
    end
    else begin
        c <= c_next;
    ...
    `ifndef INTEL_SVA_OFF
        sctAssertLine341 : assert property ( |c_next |=> d_next == 1 );
    `endif // INTEL_SVA_OFF
    end
end
