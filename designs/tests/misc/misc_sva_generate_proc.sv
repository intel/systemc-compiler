...
function void sct_assert_several_multi1_func;
    ...
    case (sct_assert_several_multi1_PROC_STATE)
        ...
        1: begin
            sct_assert_several_multi1_PROC_STATE_next = 0; return;    // test_sva_generate_proc.cpp:186:13;
        end
    endcase
endfunction
...
function void sct_assert_several_multi2_func;
    ...
    case (sct_assert_several_multi2_PROC_STATE)
        0: begin
            ...
            sct_assert_several_multi2_PROC_STATE_next = 0; return;    // test_sva_generate_proc.cpp:201:13;
        end
        1: begin
            sct_assert_several_multi2_PROC_STATE_next = 0; return;    // test_sva_generate_proc.cpp:201:13;
        end
...
function void sct_assert_several_multi3_func;
    ...
    case (sct_assert_several_multi3_PROC_STATE)
        0: begin
            if (|s)
            begin
                sct_assert_several_multi3_PROC_STATE_next = 0; return;    // test_sva_generate_proc.cpp:216:17;
            end else begin
                sct_assert_several_multi3_PROC_STATE_next = 0; return;    // test_sva_generate_proc.cpp:220:17;
            end
        end
    endcase
endfunction
...
function void sct_assert_thread_loc3_func;
    ...
    case (sct_assert_thread_loc3_PROC_STATE)
        ...
        1: begin
            j_next = i_next1 == s;
            k_next = l_next == s;
            sct_assert_thread_loc3_PROC_STATE_next = 0; return;    // test_sva_generate_proc.cpp:292:13;
        end
    endcase
endfunction
...
begin : sct_assert_thread_loc3_ff
    ...
    `ifndef INTEL_SVA_OFF
        ...
        sctAssertLine285 : assert property ( k_next || |l_next |-> ##[2:3] |s );
    `endif // INTEL_SVA_OFF
    end
end
...
function void sct_assert_cond_func;
    ...
    case (sct_assert_cond_PROC_STATE)
        0: begin
            sct_assert_cond_PROC_STATE_next = 0; return;    // test_sva_generate_proc.cpp:305:13;
        end
    endcase
endfunction
