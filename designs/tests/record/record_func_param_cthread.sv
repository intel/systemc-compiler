...
//------------------------------------------------------------------------------
// Clocked THREAD: record_fcall_ref (test_func_param_cthread.cpp:88:5) 
...
always_comb begin : record_fcall_ref_comb     // test_func_param_cthread.cpp:88:5
...
function void record_fcall_ref_func;
    ...
    case (record_fcall_ref_PROC_STATE)
        0: begin
            ...
            s_b_next = 2;
            // Call f1() end
            record_fcall_ref_PROC_STATE_next = 1; return;    // test_func_param_cthread.cpp:96:13;
        end
        1: begin
            t0_next = s_b_next;
            s_b_next = 1;
...
begin : record_fcall_ref_ff
    if ( ~rstn ) begin
        logic s_a;
        record_fcall_ref_PROC_STATE <= 0;    // test_func_param_cthread.cpp:91:9;
    end
    else begin
        s_b <= s_b_next;
        t0 <= t0_next;
...
//------------------------------------------------------------------------------
// Clocked THREAD: record_fcall_val_reg (test_func_param_cthread.cpp:104:5) 
...
// Next-state combinational logic
always_comb begin : record_fcall_val_reg_comb     // test_func_param_cthread.cpp:104:5
...
//------------------------------------------------------------------------------
// Clocked THREAD: record_fcall_val_comb (test_func_param_cthread.cpp:117:5) 

// Thread-local variables
logic signed [31:0] t1_next0;

// Next-state combinational logic
always_comb begin : record_fcall_val_comb_comb     // test_func_param_cthread.cpp:117:5
...
//------------------------------------------------------------------------------
// Clocked THREAD: record_fcall_two_val (test_func_param_cthread.cpp:129:5) 
...
// Next-state combinational logic
always_comb begin : record_fcall_two_val_comb     // test_func_param_cthread.cpp:129:5
...
//------------------------------------------------------------------------------
// Clocked THREAD: record_fcall_two_val2 (test_func_param_cthread.cpp:142:5) 

// Thread-local variables
logic signed [31:0] gr_b;
logic signed [31:0] gr_b_next;
logic signed [31:0] t2_next0;
logic gr_a;

// Next-state combinational logic
always_comb begin : record_fcall_two_val2_comb     // test_func_param_cthread.cpp:142:5
...
//------------------------------------------------------------------------------
// Clocked THREAD: record_fcall_two_ref (test_func_param_cthread.cpp:155:5) 
...
// Next-state combinational logic
always_comb begin : record_fcall_two_ref_comb     // test_func_param_cthread.cpp:155:5
...
function void record_fcall_two_ref_func;
    ...
    case (record_fcall_two_ref_PROC_STATE)
        0: begin
            record_fcall_two_ref_PROC_STATE_next = 1; return;    // test_func_param_cthread.cpp:160:13;
        end
        1: begin
            // Call f4() begin
            b = s_a_next1 && r_a;
...
begin : record_fcall_two_ref_ff
    if ( ~rstn ) begin
        record_fcall_two_ref_PROC_STATE <= 0;    // test_func_param_cthread.cpp:157:9;
    end
    else begin
        s_a2 <= s_a_next1;
        t3 <= t3_next;
...
//------------------------------------------------------------------------------
// Clocked THREAD: record_fcall_two_ref2 (test_func_param_cthread.cpp:170:5) 
...
// Next-state combinational logic
always_comb begin : record_fcall_two_ref2_comb     // test_func_param_cthread.cpp:170:5
...
//------------------------------------------------------------------------------
// Clocked THREAD: record_fcall_const_ref1 (test_func_param_cthread.cpp:190:5) 
...
// Next-state combinational logic
always_comb begin : record_fcall_const_ref1_comb     // test_func_param_cthread.cpp:190:5
...
function void record_fcall_const_ref1_func;
    ...
    case (record_fcall_const_ref1_PROC_STATE)
        0: begin
            ...
            // Call cref_copy() end
            r_a_next0 = t_a_next; r_b_next = t_b_next;
            record_fcall_const_ref1_PROC_STATE_next = 1; return;    // test_func_param_cthread.cpp:197:13;
        end
        1: begin
            // Call cref_cmp() begin
...
begin : record_fcall_const_ref1_ff
    if ( ~rstn ) begin
        record_fcall_const_ref1_PROC_STATE <= 0;    // test_func_param_cthread.cpp:193:9;
    end
    else begin
        t_a <= t_a_next;
        t_b <= t_b_next;
...
//------------------------------------------------------------------------------
// Clocked THREAD: record_fcall_const_ref2 (test_func_param_cthread.cpp:209:5) 
...
// Next-state combinational logic
always_comb begin : record_fcall_const_ref2_comb     // test_func_param_cthread.cpp:209:5
...
function void record_fcall_const_ref2_func;
    ...
    case (record_fcall_const_ref2_PROC_STATE)
        0: begin
            t_a_next0 = 1;
            record_fcall_const_ref2_PROC_STATE_next = 1; return;    // test_func_param_cthread.cpp:215:13;
        end
        1: begin
            // Call cref_cmp() begin
...
begin : record_fcall_const_ref2_ff
    if ( ~rstn ) begin
        record_fcall_const_ref2_PROC_STATE <= 0;    // test_func_param_cthread.cpp:212:9;
    end
    else begin
        r_a2 <= r_a_next1;
        t_a0 <= t_a_next0;
...
//------------------------------------------------------------------------------
// Clocked THREAD: record_fcall_const_ref3 (test_func_param_cthread.cpp:228:5) 
...
// Next-state combinational logic
always_comb begin : record_fcall_const_ref3_comb     // test_func_param_cthread.cpp:228:5
...
function void record_fcall_const_ref3_func;
    ...
    case (record_fcall_const_ref3_PROC_STATE)
        0: begin
            // Call cref_sum() begin
            record_fcall_const_ref3_PROC_STATE_next = 1; return;    // test_func_param_cthread.cpp:222:9;
            // Call cref_sum() end
        end
        1: begin
            // Call cref_sum() begin
            ...
            i = TMP_0;
            // Call cref_sum() begin
            record_fcall_const_ref3_PROC_STATE_next = 2; return;    // test_func_param_cthread.cpp:222:9;
            // Call cref_sum() end
        end
        2: begin
            // Call cref_sum() begin
...
begin : record_fcall_const_ref3_ff
    if ( ~rstn ) begin
        record_fcall_const_ref3_PROC_STATE <= 0;    // test_func_param_cthread.cpp:231:9;
    end
    else begin
        r_a3 <= r_a_next2;
        r_b2 <= r_b_next1;
