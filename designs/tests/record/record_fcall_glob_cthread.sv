...
function void single_rec_call_reg_func;
    ...
    case (single_rec_call_reg_PROC_STATE)
        0: begin
            ...
            s_a_next = par;
            // Call setA() end
            single_rec_call_reg_PROC_STATE_next = 0; return;    // test_fcall_glob_cthread.cpp:97:13;
        end
    endcase
endfunction
...
function void pointer_rec_call_reg_func;
    ...
    case (pointer_rec_call_reg_PROC_STATE)
        0: begin
            ...
            sp_a_next = par;
            // Call setA() end
            pointer_rec_call_reg_PROC_STATE_next = 0; return;    // test_fcall_glob_cthread.cpp:125:13;
        end
    endcase
endfunction
...
function void rec_arr_call_reg_func;
    ...
    case (rec_arr_call_reg_PROC_STATE)
        0: begin
            ...
            t_a_next[1] = par;
            // Call setA() end
            rec_arr_call_reg_PROC_STATE_next = 0; return;    // test_fcall_glob_cthread.cpp:154:13;
        end
    endcase
endfunction
...
function void pointer_arr_call_reg_func;
    ...
    case (pointer_arr_call_reg_PROC_STATE)
        0: begin
            ...
            w_a_next[1] = par;
            // Call setA() end
            pointer_arr_call_reg_PROC_STATE_next = 0; return;    // test_fcall_glob_cthread.cpp:180:13;
        end
    endcase
endfunction
