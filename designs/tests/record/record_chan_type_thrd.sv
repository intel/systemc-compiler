...
//------------------------------------------------------------------------------
// Clocked THREAD: resetRecord (test_chan_type_thrd.cpp:118:5) 
...
always_comb begin : resetRecord_comb     // test_chan_type_thrd.cpp:118:5
    resetRecord_func;
end
...
//------------------------------------------------------------------------------
// Clocked THREAD: bodyRecord (test_chan_type_thrd.cpp:131:5) 
...
// Next-state combinational logic
always_comb begin : bodyRecord_comb     // test_chan_type_thrd.cpp:131:5
    bodyRecord_func;
end
function void bodyRecord_func;
    ...
    case (bodyRecord_PROC_STATE)
        0: begin
            ...
            t0_next = 32'(ss_b_1 + rr_b_next);
            bodyRecord_PROC_STATE_next = 1; return;    // test_chan_type_thrd.cpp:140:13;
        end
        1: begin
...
begin : bodyRecord_ff
    if ( ~nrst ) begin
        bodyRecord_PROC_STATE <= '0;    // test_chan_type_thrd.cpp:132:9;
    end
    else begin
        rr_a <= rr_a_next;
        rr_b <= rr_b_next;
...
//------------------------------------------------------------------------------
// Clocked THREAD: threadSignal (test_chan_type_thrd.cpp:146:5) 
...
// Next-state combinational logic
always_comb begin : threadSignal_comb     // test_chan_type_thrd.cpp:146:5
    threadSignal_func;
end
...
//------------------------------------------------------------------------------
// Clocked THREAD: threadCombSignal (test_chan_type_thrd.cpp:178:5) 
...
// Next-state combinational logic
always_comb begin : threadCombSignal_comb     // test_chan_type_thrd.cpp:178:5
...
//------------------------------------------------------------------------------
// Clocked THREAD: threadPort (test_chan_type_thrd.cpp:207:5) 
...
// Next-state combinational logic
always_comb begin : threadPort_comb     // test_chan_type_thrd.cpp:207:5
    threadPort_func;
end
...
//------------------------------------------------------------------------------
// Clocked THREAD: threadArr (test_chan_type_thrd.cpp:232:5) 
...
// Next-state combinational logic
always_comb begin : threadArr_comb     // test_chan_type_thrd.cpp:232:5
    threadArr_func;
end
...
//------------------------------------------------------------------------------
// Clocked THREAD: threadCtor (test_chan_type_thrd.cpp:266:5) 
...
// Next-state combinational logic
always_comb begin : threadCtor_comb     // test_chan_type_thrd.cpp:266:5
    threadCtor_func;
end
function void threadCtor_func;
    ...
    wim_b_next = wim_b;
    i = s;
    ss_a_1 = TMP_2_a; ss_b_1 = TMP_2_b;
    ss_a_1 = TMP_3_a; ss_b_1 = TMP_3_b;
    wim_a_next = TMP_4_a; wim_b_next = TMP_4_b;
    wim_a_next = TMP_5_a; wim_b_next = TMP_5_b;
    wim_a_next = TMP_6_a; wim_b_next = TMP_6_b;
    wim_a_next = TMP_7_a; wim_b_next = TMP_7_b;
    tvec_a_next[i] = TMP_8_a; tvec_b_next[i] = TMP_8_b;
    tvec_a_next[i + 1] = TMP_9_a; tvec_b_next[i + 1] = TMP_9_b;
    tt_a_1 = ss_a_1; tt_b_1 = ss_b_1;
endfunction
...
begin : threadCtor_ff
    if ( ~nrst ) begin
        ...
        logic TMP_1_a;
        integer TMP_1_b;
        ss_a_1 = TMP_0_a; ss_b_1 = TMP_0_b;
        tvec_a[0] <= TMP_1_a; tvec_b[0] <= TMP_1_b;
    end
    else begin
        tvec_a <= tvec_a_next;
        tvec_b <= tvec_b_next;
