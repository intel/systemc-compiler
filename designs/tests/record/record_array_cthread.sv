...
//==============================================================================
//
// Module: A (test_array_cthread.cpp:770:5)
//
...
function void code_scope_state_clean1_func;
    ...
    case (code_scope_state_clean1_PROC_STATE)
        ...
        1: begin
            k_next0++;
            dd_a[k_next0] = 2;
            code_scope_state_clean1_PROC_STATE_next = 2; return;    // test_array_cthread.cpp:262:13;
        end
        2: begin
            dd_a[k_next0] = 1;
            code_scope_state_clean1_PROC_STATE_next = 1; return;    // test_array_cthread.cpp:255:17;
...
//------------------------------------------------------------------------------
// Clocked THREAD: rec_arr_elem_const_val1 (test_array_cthread.cpp:528:5) 
...
// Next-state combinational logic
always_comb begin : rec_arr_elem_const_val1_comb     // test_array_cthread.cpp:528:5
...
function void rec_arr_elem_const_val1_func;
    ...
    case (rec_arr_elem_const_val1_PROC_STATE)
        0: begin
            ...
            // Call ff1() begin
            rec_arr_elem_const_val1_PROC_STATE_next = 1; return;    // test_array_cthread.cpp:523:9;
            // Call ff1() end
        end
        1: begin
            // Call ff1() begin
            ...
            t14_next = i;
            // Call ff1() end
            rec_arr_elem_const_val1_PROC_STATE_next = 2; return;    // test_array_cthread.cpp:536:13;
        end
        2: begin
            sr_a = 0;
            sr_b = 0;
...
begin : rec_arr_elem_const_val1_ff
    if ( ~nrst ) begin
        rec_arr_elem_const_val1_PROC_STATE <= 0;    // test_array_cthread.cpp:530:9;
    end
    else begin
        par_a <= par_a_next;
        par_b <= par_b_next;
...
//------------------------------------------------------------------------------
// Clocked THREAD: rec_arr_elem_const_val2 (test_array_cthread.cpp:540:5) 
...
// Next-state combinational logic
always_comb begin : rec_arr_elem_const_val2_comb     // test_array_cthread.cpp:540:5
...
function void rec_arr_elem_const_val2_func;
    ...
    case (rec_arr_elem_const_val2_PROC_STATE)
        0: begin
            sr_a_next = 0;
            sr_b_next = 0;
            rec_arr_elem_const_val2_PROC_STATE_next = 1; return;    // test_array_cthread.cpp:545:13;
        end
        1: begin
            par_a_next0 = sr_a_next; par_b_next0 = sr_b_next;
            // Call ff1() begin
            rec_arr_elem_const_val2_PROC_STATE_next = 2; return;    // test_array_cthread.cpp:523:9;
            // Call ff1() end
        end
        2: begin
            // Call ff1() begin
...
begin : rec_arr_elem_const_val2_ff
    if ( ~nrst ) begin
        rec_arr_elem_const_val2_PROC_STATE <= 0;    // test_array_cthread.cpp:542:9;
    end
    else begin
        par_a0 <= par_a_next0;
        par_b0 <= par_b_next0;
...
//------------------------------------------------------------------------------
// Clocked THREAD: rec_arr_elem_const_val3 (test_array_cthread.cpp:551:5) 
...
logic signed [31:0] t14_next1;
logic [1:0] rec_arr_elem_const_val3_PROC_STATE;
logic [1:0] rec_arr_elem_const_val3_PROC_STATE_next;

// Next-state combinational logic
always_comb begin : rec_arr_elem_const_val3_comb     // test_array_cthread.cpp:551:5
...
function void rec_arr_elem_const_val3_func;
    ...
    case (rec_arr_elem_const_val3_PROC_STATE)
        0: begin
            ...
            // Call ff1() begin
            rec_arr_elem_const_val3_PROC_STATE_next = 1; return;    // test_array_cthread.cpp:523:9;
            // Call ff1() end
        end
        1: begin
            // Call ff1() begin
            ...
            t14_next1 = i;
            // Call ff1() end
            rec_arr_elem_const_val3_PROC_STATE_next = 2; return;    // test_array_cthread.cpp:557:13;
        end
        2: begin
            par_a_next1 = crra_a_next[1]; par_b_next1 = crra_b_next[1];
            // Call ff1() begin
...
begin : rec_arr_elem_const_val3_ff
    if ( ~nrst ) begin
        rec_arr_elem_const_val3_PROC_STATE <= 0;    // test_array_cthread.cpp:554:9;
    end
    else begin
        crra_a <= crra_a_next;
        crra_b <= crra_b_next;
...
//------------------------------------------------------------------------------
// Clocked THREAD: rec_arr_elem_const_val4 (test_array_cthread.cpp:561:5) 
...
// Next-state combinational logic
always_comb begin : rec_arr_elem_const_val4_comb     // test_array_cthread.cpp:561:5
...
function void rec_arr_elem_const_val4_func;
    ...
    case (rec_arr_elem_const_val4_PROC_STATE)
        0: begin
            rec_arr_elem_const_val4_PROC_STATE_next = 1; return;    // test_array_cthread.cpp:566:13;
        end
        1: begin
            i = sig;
            par_a_next2 = crrb_a_next[i]; par_b_next2 = crrb_b_next[i];
            // Call ff1() begin
            rec_arr_elem_const_val4_PROC_STATE_next = 2; return;    // test_array_cthread.cpp:523:9;
            // Call ff1() end
        end
        2: begin
            // Call ff1() begin
...
begin : rec_arr_elem_const_val4_ff
    if ( ~nrst ) begin
        rec_arr_elem_const_val4_PROC_STATE <= 0;    // test_array_cthread.cpp:564:9;
    end
    else begin
        par_a2 <= par_a_next2;
        par_b2 <= par_b_next2;
...
//------------------------------------------------------------------------------
// Clocked THREAD: rec_arr_elem_func_param_val (test_array_cthread.cpp:481:5) 

// Thread-local variables
logic signed [31:0] t13_next;

// Next-state combinational logic
always_comb begin : rec_arr_elem_func_param_val_comb     // test_array_cthread.cpp:481:5
...
//------------------------------------------------------------------------------
// Clocked THREAD: rec_arr_elem_func_param_val2 (test_array_cthread.cpp:493:5) 
...
logic signed [31:0] t13_next0;

// Next-state combinational logic
always_comb begin : rec_arr_elem_func_param_val2_comb     // test_array_cthread.cpp:493:5
...
//------------------------------------------------------------------------------
// Clocked THREAD: rec_arr_elem_func_param_val3 (test_array_cthread.cpp:506:5) 
...
logic signed [31:0] t13_next1;

// Next-state combinational logic
always_comb begin : rec_arr_elem_func_param_val3_comb     // test_array_cthread.cpp:506:5
...
//------------------------------------------------------------------------------
// Clocked THREAD: rec_arr_elem_func_param_ref (test_array_cthread.cpp:580:5) 
...
// Next-state combinational logic
always_comb begin : rec_arr_elem_func_param_ref_comb     // test_array_cthread.cpp:580:5
...
function void rec_arr_elem_func_param_ref_func;
    ...
    case (rec_arr_elem_func_param_ref_PROC_STATE)
        0: begin
            ...
            t15_next = k_1;
            // Call f2() end
            rec_arr_elem_func_param_ref_PROC_STATE_next = 1; return;    // test_array_cthread.cpp:586:13;
        end
        1: begin
            i = sig;
            // Call f2() begin
...
begin : rec_arr_elem_func_param_ref_ff
    if ( ~nrst ) begin
        rec_arr_elem_func_param_ref_PROC_STATE <= 0;    // test_array_cthread.cpp:582:9;
    end
    else begin
        vr_b <= vr_b_next;
        t15 <= t15_next;
...
//------------------------------------------------------------------------------
// Clocked THREAD: rec_arr_elem_func_param_ref2 (test_array_cthread.cpp:624:5) 
...
// Next-state combinational logic
always_comb begin : rec_arr_elem_func_param_ref2_comb     // test_array_cthread.cpp:624:5
...
function void rec_arr_elem_func_param_ref2_func;
    ...
    case (rec_arr_elem_func_param_ref2_PROC_STATE)
        0: begin
            ...
            t16_next = k_1;
            // Call f2_two() end
            rec_arr_elem_func_param_ref2_PROC_STATE_next = 1; return;    // test_array_cthread.cpp:635:13;
        end
        1: begin
            w_a = 0;
            w_b = 0;
...
begin : rec_arr_elem_func_param_ref2_ff
    if ( ~nrst ) begin
        logic signed [1:0] wrr_a[2];
        i9 <= sig;
        rec_arr_elem_func_param_ref2_PROC_STATE <= 0;    // test_array_cthread.cpp:628:9;
    end
    else begin
        i9 <= i_next8;
        wrr_b <= wrr_b_next;
...
//------------------------------------------------------------------------------
// Clocked THREAD: rec_arr_elem_func_param_ref3 (test_array_cthread.cpp:647:5) 
...
// Next-state combinational logic
always_comb begin : rec_arr_elem_func_param_ref3_comb     // test_array_cthread.cpp:647:5
...
function void rec_arr_elem_func_param_ref3_func;
    ...
    case (rec_arr_elem_func_param_ref3_PROC_STATE)
        0: begin
            ...
            vr_b_1[i_next9 + 1] = 1;
            // Call f3() end
            rec_arr_elem_func_param_ref3_PROC_STATE_next = 1; return;    // test_array_cthread.cpp:657:13;
        end
        1: begin
            // Call f3() begin
            vr_b_1[i_next9 - 1] = 1;
...
begin : rec_arr_elem_func_param_ref3_ff
    if ( ~nrst ) begin
        i10 <= sig;
        rec_arr_elem_func_param_ref3_PROC_STATE <= 0;    // test_array_cthread.cpp:650:9;
    end
    else begin
        i10 <= i_next9;
        vr_a0 <= vr_a_next;
...
//------------------------------------------------------------------------------
// Clocked THREAD: rec_arr_func_param_val (test_array_cthread.cpp:741:5) 
...
// Next-state combinational logic
always_comb begin : rec_arr_func_param_val_comb     // test_array_cthread.cpp:741:5
...
//------------------------------------------------------------------------------
// Clocked THREAD: rec_arr_func_param_val2 (test_array_cthread.cpp:751:5) 
...
logic signed [31:0] t21_next0;
logic rec_arr_func_param_val2_PROC_STATE;
logic rec_arr_func_param_val2_PROC_STATE_next;

// Next-state combinational logic
always_comb begin : rec_arr_func_param_val2_comb     // test_array_cthread.cpp:751:5
...
function void rec_arr_func_param_val2_func;
    ...
    case (rec_arr_func_param_val2_PROC_STATE)
        0: begin
            ...
            ar_a_next0[i] = 0;
            ar_b_next2[i] = 1;
            rec_arr_func_param_val2_PROC_STATE_next = 1; return;    // test_array_cthread.cpp:759:13;
        end
        1: begin
            // Call f5() begin
            indx = ar_b_next2[1];
...
begin : rec_arr_func_param_val2_ff
    if ( ~nrst ) begin
        rec_arr_func_param_val2_PROC_STATE <= 0;    // test_array_cthread.cpp:753:9;
    end
    else begin
        ar_b2 <= ar_b_next2;
        ar_a1 <= ar_a_next0;
...
//------------------------------------------------------------------------------
// Clocked THREAD: rec_arr_elem_func_param_cref1 (test_array_cthread.cpp:673:5) 
...
// Next-state combinational logic
always_comb begin : rec_arr_elem_func_param_cref1_comb     // test_array_cthread.cpp:673:5
...
function void rec_arr_elem_func_param_cref1_func;
    ...
    case (rec_arr_elem_func_param_cref1_PROC_STATE)
        0: begin
            ...
            t18_next = res;
            // Call cref_sum() end
            rec_arr_elem_func_param_cref1_PROC_STATE_next = 1; return;    // test_array_cthread.cpp:681:13;
        end
        1: begin
            indx = sig;
            // Call cref_sum() begin
            ...
            t18_next = res;
            // Call cref_sum() end
            rec_arr_elem_func_param_cref1_PROC_STATE_next = 2; return;    // test_array_cthread.cpp:686:13;
        end
        2: begin
            // Call cref_sum() begin
            res = cvr_a_next[1] + cvr_b_next[1];
...
begin : rec_arr_elem_func_param_cref1_ff
    if ( ~nrst ) begin
        integer indx;
        indx = 0;
        rec_arr_elem_func_param_cref1_PROC_STATE <= 0;    // test_array_cthread.cpp:676:9;
    end
    else begin
        cvr_a <= cvr_a_next;
        cvr_b <= cvr_b_next;
...
//------------------------------------------------------------------------------
// Clocked THREAD: rec_arr_elem_func_param_cref2 (test_array_cthread.cpp:699:5) 
...
// Next-state combinational logic
always_comb begin : rec_arr_elem_func_param_cref2_comb     // test_array_cthread.cpp:699:5
    ...
    case (rec_arr_elem_func_param_cref2_PROC_STATE)
        0: begin
            ...
            begin
                ...
                rec_arr_elem_func_param_cref2_PROC_STATE_next = 1; return;    // test_array_cthread.cpp:693:9;
                // Call cref_wait() end
            end
            rec_arr_elem_func_param_cref2_PROC_STATE_next = 2; return;    // test_array_cthread.cpp:710:13;
        end
        1: begin
            // Call cref_wait() begin
...
begin : rec_arr_elem_func_param_cref2_ff
    if ( ~nrst ) begin
        rec_arr_elem_func_param_cref2_PROC_STATE <= 0;    // test_array_cthread.cpp:702:9;
    end
    else begin
        cvrr_a <= cvrr_a_next;
        res0 <= res_next;
...
//------------------------------------------------------------------------------
// Clocked THREAD: rec_arr_elem_func_param_cref3 (test_array_cthread.cpp:715:5) 
...
// Next-state combinational logic
always_comb begin : rec_arr_elem_func_param_cref3_comb     // test_array_cthread.cpp:715:5
    ...
    case (rec_arr_elem_func_param_cref3_PROC_STATE)
        0: begin
            ...
            begin
                ...
                rec_arr_elem_func_param_cref3_PROC_STATE_next = 1; return;    // test_array_cthread.cpp:693:9;
                // Call cref_wait() end
            end
            rec_arr_elem_func_param_cref3_PROC_STATE_next = 2; return;    // test_array_cthread.cpp:727:13;
        end
        1: begin
            // Call cref_wait() begin
...
begin : rec_arr_elem_func_param_cref3_ff
    if ( ~nrst ) begin
        indx0 <= 0;
        rec_arr_elem_func_param_cref3_PROC_STATE <= 0;    // test_array_cthread.cpp:718:9;
    end
    else begin
        cwrr_a <= cwrr_a_next;
        res1 <= res_next0;
