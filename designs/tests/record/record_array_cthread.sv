...
function void rec_arr_elem_const_val1_func;
    ...
    case (rec_arr_elem_const_val1_PROC_STATE)
        ...
        1: begin
            ...
            t14_next = i;
            // Call ff1() end
            rec_arr_elem_const_val1_PROC_STATE_next = 0; return;    // test_array_cthread.cpp:536:13;
        end
    endcase
endfunction
...
function void rec_arr_elem_const_val3_func;
    ...
    case (rec_arr_elem_const_val3_PROC_STATE)
        ...
        1: begin
            ...
            t14_next1 = i;
            // Call ff1() end
            rec_arr_elem_const_val3_PROC_STATE_next = 0; return;    // test_array_cthread.cpp:557:13;
        end
    endcase
endfunction
...
function void rec_arr_elem_func_param_cref1_func;
    ...
    case (rec_arr_elem_func_param_cref1_PROC_STATE)
        ...
        1: begin
            ...
            t18_next = res;
            // Call cref_sum() end
            rec_arr_elem_func_param_cref1_PROC_STATE_next = 0; return;    // test_array_cthread.cpp:686:13;
        end
    endcase
endfunction
...
function void rec_arr_elem_func_param_cref2_func;
    ...
    case (rec_arr_elem_func_param_cref2_PROC_STATE)
        0: begin
            ...
            rec_arr_elem_func_param_cref2_PROC_STATE_next = 0; return;    // test_array_cthread.cpp:710:13;
        end
        1: begin
            // Call cref_wait() begin
...
function void rec_arr_elem_func_param_cref3_func;
    ...
    case (rec_arr_elem_func_param_cref3_PROC_STATE)
        0: begin
            ...
            rec_arr_elem_func_param_cref3_PROC_STATE_next = 0; return;    // test_array_cthread.cpp:727:13;
        end
        1: begin
            // Call cref_wait() begin
