...
begin : binary_comparison_pos     // test_cast.cpp:378:5
    ...
    uu = signed'({1'b0, u}) + y;
    `ifndef INTEL_SVA_OFF
        assert (uu == 5'd26) else $error("Assertion failed at test_cast.cpp:70:24>");
    `endif // INTEL_SVA_OFF
end
...
begin : cast_to_unsigned_compound     // test_cast.cpp:729:5
    ...
    x = x + i;
    `ifndef INTEL_SVA_OFF
        assert (x == 15'd32767) else $error("Assertion failed at test_cast.cpp:70:24>");
    `endif // INTEL_SVA_OFF
    bx = bx * i;
    `ifndef INTEL_SVA_OFF
...
begin : const_cpp_type_cast     // test_cast.cpp:924:5
    ...
    i = l + 1'd1;
    `ifndef INTEL_SVA_OFF
        assert (i == 1'd1) else $error("Assertion failed at test_cast.cpp:70:24>");
    `endif // INTEL_SVA_OFF
    i = 1'd1;
    `ifndef INTEL_SVA_OFF
        assert (i == 1'd1) else $error("Assertion failed at test_cast.cpp:70:24>");
    ...
    `ifndef INTEL_SVA_OFF
        assert (i == 2'd2) else $error("Assertion failed at test_cast.cpp:70:24>");
    `endif // INTEL_SVA_OFF
end
...
begin : const_cpp_ref_expl_cast     // test_cast.cpp:981:5
    ...
    j = 8'(s_1);
    `ifndef INTEL_SVA_OFF
        assert (j == 1'd1) else $error("Assertion failed at test_cast.cpp:70:24>");
    `endif // INTEL_SVA_OFF
    `ifndef INTEL_SVA_OFF
        assert (signed'({1'b0, s_1}) == 257) else $error("Assertion failed at test_cast.cpp:70:24>");
    `endif // INTEL_SVA_OFF
    ...
    `ifndef INTEL_SVA_OFF
        assert (j == 2'd2) else $error("Assertion failed at test_cast.cpp:70:24>");
    `endif // INTEL_SVA_OFF
end
...
begin : const_sc_type_cast     // test_cast.cpp:1033:5
    ...
    y = x;
    `ifndef INTEL_SVA_OFF
        assert (y == 3'd4) else $error("Assertion failed at test_cast.cpp:70:24>");
    `endif // INTEL_SVA_OFF
    sx = -4'sd7;
    sy = sx;
    `ifndef INTEL_SVA_OFF
        assert (sy == 2'sd1) else $error("Assertion failed at test_cast.cpp:70:24>");
    `endif // INTEL_SVA_OFF
    z = 3'(x);
    `ifndef INTEL_SVA_OFF
        assert (z == 3'd4) else $error("Assertion failed at test_cast.cpp:70:24>");
    `endif // INTEL_SVA_OFF
    z = 3'(x + 1'd1);
    `ifndef INTEL_SVA_OFF
        assert (z == 3'd5) else $error("Assertion failed at test_cast.cpp:70:24>");
    `endif // INTEL_SVA_OFF
    z = 3'd13;
    `ifndef INTEL_SVA_OFF
        assert (z == 3'd5) else $error("Assertion failed at test_cast.cpp:70:24>");
    ...
    z = 2'd15;
    `ifndef INTEL_SVA_OFF
        assert (z == 2'd3) else $error("Assertion failed at test_cast.cpp:70:24>");
    `endif // INTEL_SVA_OFF
    i = 4'd14;
    z = 2'(i);
    `ifndef INTEL_SVA_OFF
        assert (z == 2'd2) else $error("Assertion failed at test_cast.cpp:70:24>");
    `endif // INTEL_SVA_OFF
    sz = '0;
    sz = 3'(sx);
    `ifndef INTEL_SVA_OFF
        assert (sz == 2'sd1) else $error("Assertion failed at test_cast.cpp:70:24>");
    `endif // INTEL_SVA_OFF
    sz = -3'sd13;
    `ifndef INTEL_SVA_OFF
        assert (sz == 3'sd3) else $error("Assertion failed at test_cast.cpp:70:24>");
    `endif // INTEL_SVA_OFF
end
...
begin : var_sc_type_cast     // test_cast.cpp:1069:5
    ...
    u1 = i;
    `ifndef INTEL_SVA_OFF
        assert (u1 == 8'hCD) else $error("Assertion failed at test_cast.cpp:70:24>");
    `endif // INTEL_SVA_OFF
    u1 = l;
    `ifndef INTEL_SVA_OFF
        assert (u1 == 8'hEE) else $error("Assertion failed at test_cast.cpp:70:24>");
    `endif // INTEL_SVA_OFF
    u2 = i;
    `ifndef INTEL_SVA_OFF
        assert (u2 == 16'hBBCD) else $error("Assertion failed at test_cast.cpp:70:24>");
    `endif // INTEL_SVA_OFF
    u2 = l;
    `ifndef INTEL_SVA_OFF
        assert (u2 == 16'hDDEE) else $error("Assertion failed at test_cast.cpp:70:24>");
    `endif // INTEL_SVA_OFF
    b1 = i;
    `ifndef INTEL_SVA_OFF
...
begin : read_to_int     // test_cast.cpp:1122:5
    d = signed'({1'b0, 32'(a)}) + signed'({1'b0, 32'(b)}) + 32'(c) / 4'sd4;
end
