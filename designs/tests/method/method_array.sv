...
begin : signal_array     // test_array.cpp:201:5
    ...
    sig1[1] = sig1[2];
    sig2[1][2] = sig2[0][1];
    sig2[0][1] = 32'(sig2[1][2] + sig2[2][1]) + sig1[0];
end
...
begin : port_pointer_array     // test_array.cpp:230:5
    ...
    out_ports_p2[1][2] = 32'(in_ports_p2[0][1] + in_ports_p2[2][2]);
end
...
begin : sig_pointer_array     // test_array.cpp:249:5
    ...
    sig_p2[1][2] = sig_p2[1][2];
    sig_p1[i * i] = 32'(sig_p2[i][i] + sig_p2[1][2]);
end
