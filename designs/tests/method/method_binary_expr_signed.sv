...
//==============================================================================
//
// Module: A (test_binary_expr_signed.cpp:224:5)
//
...
begin : binary     // test_binary_expr_signed.cpp:33:5
    ...
    z = (uu * 3'd4) - i;
    `ifndef INTEL_SVA_OFF
        assert (z == 7'sd33) else $error("Assertion failed at test_binary_expr_signed.cpp:31:24>");
    `endif // INTEL_SVA_OFF
    z = (uu * 3'd4) - i + x * ux;
    bz = x / (i - 2'sd1) * (uu - ux);
    `ifndef INTEL_SVA_OFF
...
begin : binary_liter     // test_binary_expr_signed.cpp:95:5
    ...
    `ifndef INTEL_SVA_OFF
        assert (z == 5'sd10) else $error("Assertion failed at test_binary_expr_signed.cpp:31:24>");
    `endif // INTEL_SVA_OFF
    z = (uu * 3'd4) - i + x * ux + 1'd1;
    bz = x / (i - 2'sd1) * (uu - ux + 1'd1);
    `ifndef INTEL_SVA_OFF
        assert (bz == 0) else $error("Assertion failed at test_binary_expr_signed.cpp:31:24>");
    `endif // INTEL_SVA_OFF
...
begin : compound     // test_binary_expr_signed.cpp:131:5
    ...
    ux = ux * (ux - x + 1'd1);
    `ifndef INTEL_SVA_OFF
        assert (ux == 4'd14) else $error("Assertion failed at test_binary_expr_signed.cpp:31:24>");
    `endif // INTEL_SVA_OFF
    x = (ux * (x + 2'sd1)) - ux;
    `ifndef INTEL_SVA_OFF
    ...
    ux = 2;
    bz = 1;
    bz = bz - (x / (i + 2'sd1) * (uu - ux + 1'd1));
end

//------------------------------------------------------------------------------
// Method process: unary (test_binary_expr_signed.cpp:167:5) 

always_comb 
begin : unary     // test_binary_expr_signed.cpp:167:5
    integer z;
    logic signed [32:0] bz;
    integer i;
    integer unsigned uu;
...
//------------------------------------------------------------------------------
// Method process: ternary (test_binary_expr_signed.cpp:189:5) 

always_comb 
begin : ternary     // test_binary_expr_signed.cpp:189:5
    integer z;
    logic signed [32:0] bz;
    integer i;
    integer unsigned uu;
