...
//------------------------------------------------------------------------------
// Clocked THREAD: array_ref_wait (test_fcall_ref_arr_unkwn.cpp:78:5) 
...
always_comb begin : array_ref_wait_comb     // test_fcall_ref_arr_unkwn.cpp:78:5
    array_ref_wait_func;
end
function void array_ref_wait_func;
    ...
    case (array_ref_wait_PROC_STATE)
        0: begin
            // Call ref_wait() begin
            array_ref_wait_PROC_STATE_next = 1; return;    // test_fcall_ref_arr_unkwn.cpp:74:9;
            // Call ref_wait() end
        end
        1: begin
            // Call ref_wait() begin
            ...
            // Call ref_wait() end
            b = TMP_0;
            array_ref_wait_PROC_STATE_next = '0; return;    // test_fcall_ref_arr_unkwn.cpp:85:13;
        end
    endcase
endfunction
...
begin : array_ref_wait_ff
    if ( ~nrst ) begin
        logic lb;
        array_ref_wait_PROC_STATE <= '0;    // test_fcall_ref_arr_unkwn.cpp:81:9;
    end
    else begin
        arr <= arr_next;
