...
begin : sc_type_for_bigint     // test_forloop_other_types.cpp:62:5
    ...
    for (logic signed [9:0] i2 = 0; i2 < 5'sd10; i2++)
    begin
        a2[32'(i2)] = 32'(i2);
    end
    for (logic signed [63:0] i3 = 0; i3 < 5'sd10; i3++)
    begin
        a_u[32'(i3)] = 32'(i3);
    end
    for (logic signed [39:0] i3_1 = 0; i3_1 < 5'sd10; i3_1++)
    begin
        a_l[64'(i3_1)] = 64'(i3_1);
    end
    for (logic signed [39:0] i3_2 = 0; i3_2 < 5'sd10; i3_2++)
    begin
        a_ul[64'(i3_2)] = 64'(i3_2);
    end
    a_bint = '0;
    for (logic signed [114:0] i4 = 0; i4 < 5'sd10; i4++)
    begin
        a_bint[32'(i4)] = |i4;
    end
end
...
begin : sc_type_for_biguint     // test_forloop_other_types.cpp:89:5
    ...
    logic [39:0] a_buint;
    for (logic [39:0] ibu2 = 1'd0; signed'({1'b0, ibu2}) < 5'sd10; ibu2++)
    begin
        abuint2[32'(ibu2)] = 32'(ibu2);
    end
    for (logic [44:0] ibu3 = 1'd0; signed'({1'b0, ibu3}) < 5'sd10; ibu3++)
    begin
        abuint_u[32'(ibu3)] = 32'(ibu3);
    end
    for (logic [139:0] ibu3_1 = 1'd0; signed'({1'b0, ibu3_1}) < 5'sd10; ibu3_1++)
    begin
        abuint_l[64'(ibu3_1)] = 64'(ibu3_1);
    end
    for (logic [64:0] ibu3_2 = 1'd0; signed'({1'b0, ibu3_2}) < 5'sd10; ibu3_2++)
    begin
        abuint_ul[64'(ibu3_2)] = 64'(ibu3_2);
    end
    a_buint = '0;
    for (logic [4:0] ibu4 = 1'd0; signed'({1'b0, ibu4}) < 5'sd10; ibu4++)
    begin
