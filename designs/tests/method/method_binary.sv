//==============================================================================
//
// The code is generated by Intel Compiler for SystemC, version 1.6.35
...
begin : enumOperation     // test_binary.cpp:140:5
    ...
    `ifndef INTEL_SVA_OFF
        assert (z == 3'sd2) else $error("Assertion failed at test_binary.cpp:60:24>");
    `endif // INTEL_SVA_OFF
...
begin : sc_type_shift     // test_binary.cpp:221:5
    ...
    x = x <<< 70;
    `ifndef INTEL_SVA_OFF
        assert (signed'({1'b0, x}) == 0) else $error("Assertion failed at test_binary.cpp:60:24>");
    `endif // INTEL_SVA_OFF
    y = 130'(i) >>> 71;
    `ifndef INTEL_SVA_OFF
        assert (signed'({1'b0, y}) == 0) else $error("Assertion failed at test_binary.cpp:60:24>");
    `endif // INTEL_SVA_OFF
    y = x >>> 67;
    `ifndef INTEL_SVA_OFF
        assert (signed'({1'b0, y}) == 0) else $error("Assertion failed at test_binary.cpp:60:24>");
...
begin : sc_type_main     // test_binary.cpp:277:5
    ...
    `ifndef INTEL_SVA_OFF
        assert (r0 == 5'sd8) else $error("Assertion failed at test_binary.cpp:60:24>");
    `endif // INTEL_SVA_OFF
    r1 = x * bux;
    `ifndef INTEL_SVA_OFF
        assert (signed'({1'b0, r1}) == 4'sd7) else $error("Assertion failed at test_binary.cpp:60:24>");
    `endif // INTEL_SVA_OFF
    r2 = signed'({1'b0, x}) * (signed'({1'b0, bux}) + 2'sd1);
    `ifndef INTEL_SVA_OFF
        assert (r2 == 5'sd8) else $error("Assertion failed at test_binary.cpp:60:24>");
    `endif // INTEL_SVA_OFF
    t2a = 32'(32'(32'(r0) + signed'({1'b0, 32'(r1)})) + 32'(r2));
    z = x + y;
    ...
    `ifndef INTEL_SVA_OFF
        assert (bz == 5'sd9) else $error("Assertion failed at test_binary.cpp:60:24>");
    `endif // INTEL_SVA_OFF
    z = (y >>> 1) + (bx >>> x);
    `ifndef INTEL_SVA_OFF
        assert (z == 4'sd4) else $error("Assertion failed at test_binary.cpp:60:24>");
    ...
    `ifndef INTEL_SVA_OFF
        assert (bz == 3'sd3) else $error("Assertion failed at test_binary.cpp:60:24>");
    `endif // INTEL_SVA_OFF
    bz = 9'((y % bx) * signed'({1'b0, (x + 4'd10)})) / signed'({1'b0, bux});
    `ifndef INTEL_SVA_OFF
        assert (bz == 2'sd1) else $error("Assertion failed at test_binary.cpp:60:24>");
    `endif // INTEL_SVA_OFF
end
...
begin : sc_type_main_signed     // test_binary.cpp:333:5
    ...
    bz = (x * y) <<< (32'(by) >>> 1);
    `ifndef INTEL_SVA_OFF
        assert (bz == 7'sd40) else $error("Assertion failed at test_binary.cpp:60:24>");
    `endif // INTEL_SVA_OFF
    bz = (x + y) - (++by);
    `ifndef INTEL_SVA_OFF
...
begin : sc_type_logic_bitwise     // test_binary.cpp:370:5
    ...
    `endif // INTEL_SVA_OFF
    z = signed'({1'b0, (x ^ 32'(uu + 1'd1))}) + (y | signed'({1'b0, bx}) | by);
    `ifndef INTEL_SVA_OFF
...
begin : logic_bitwise_literal     // test_binary.cpp:414:5
    ...
    z = i | 7'sh24;
    `ifndef INTEL_SVA_OFF
        assert (signed'({1'b0, z}) == 10'sh127) else $error("Assertion failed at test_binary.cpp:60:24>");
    `endif // INTEL_SVA_OFF
    z = i & 7'sh24;
    `ifndef INTEL_SVA_OFF
        assert (signed'({1'b0, z}) == 7'sh20) else $error("Assertion failed at test_binary.cpp:60:24>");
    `endif // INTEL_SVA_OFF
    z = i ^ 7'sh24;
    `ifndef INTEL_SVA_OFF
        assert (signed'({1'b0, z}) == 10'sh107) else $error("Assertion failed at test_binary.cpp:60:24>");
    `endif // INTEL_SVA_OFF
    z = j | 3'sh3;
    `ifndef INTEL_SVA_OFF
        assert (signed'({1'b0, z}) == 42'sh12300000007) else $error("Assertion failed at test_binary.cpp:60:24>");
    `endif // INTEL_SVA_OFF
    z = j & 6'sh16;
    `ifndef INTEL_SVA_OFF
        assert (signed'({1'b0, z}) == 4'sh4) else $error("Assertion failed at test_binary.cpp:60:24>");
    `endif // INTEL_SVA_OFF
    z = j ^ 6'sh11;
    `ifndef INTEL_SVA_OFF
        assert (signed'({1'b0, z}) == 42'sh12300000014) else $error("Assertion failed at test_binary.cpp:60:24>");
    `endif // INTEL_SVA_OFF
    z = j | 40'sh4400000002;
    `ifndef INTEL_SVA_OFF
        assert (signed'({1'b0, z}) == 42'sh16700000007) else $error("Assertion failed at test_binary.cpp:60:24>");
    `endif // INTEL_SVA_OFF
    z = j & 40'sh4500000004;
    `ifndef INTEL_SVA_OFF
        assert (signed'({1'b0, z}) == 34'sh100000004) else $error("Assertion failed at test_binary.cpp:60:24>");
    `endif // INTEL_SVA_OFF
    z = j | 46'sh140000000000;
    `ifndef INTEL_SVA_OFF
        assert (signed'({1'b0, z}) == 46'sh152300000005) else $error("Assertion failed at test_binary.cpp:60:24>");
    `endif // INTEL_SVA_OFF
    z = j & 46'sh153000000000;
    `ifndef INTEL_SVA_OFF
        assert (signed'({1'b0, z}) == 42'sh12000000000) else $error("Assertion failed at test_binary.cpp:60:24>");
    `endif // INTEL_SVA_OFF
end
...
begin : sc_type_comp     // test_binary.cpp:446:5
    ...
    `ifndef INTEL_SVA_OFF
        assert (b_1) else $error("Assertion failed at test_binary.cpp:60:24>");
    `endif // INTEL_SVA_OFF
    b_1 = x == 2'd2 && bx == 32'(uu + 3'd4);
    `ifndef INTEL_SVA_OFF
        assert (b_1) else $error("Assertion failed at test_binary.cpp:60:24>");
    `endif // INTEL_SVA_OFF
    b_1 = x <= y;
    b_1 = x <= y && signed'({1'b0, bx}) > by && 1;
    b_1 = x < y;
    b_1 = x < 5'(y + 2'sd1) && 1;
end
...
begin : large_types     // test_binary.cpp:481:5
    ...
    `ifndef INTEL_SVA_OFF
        assert (x == 6'sd22) else $error("Assertion failed at test_binary.cpp:60:24>");
    `endif // INTEL_SVA_OFF
    y = x <<< 50;
    `ifndef INTEL_SVA_OFF
