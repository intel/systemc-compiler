...
//==============================================================================
//
// Module: A (test_binary.cpp:637:5)
//
...
//------------------------------------------------------------------------------
// Method process: sc_type_shift (test_binary.cpp:222:5) 

always_comb 
begin : sc_type_shift     // test_binary.cpp:222:5
    logic [36:0] i;
    logic [38:0] j;
    logic [71:0] x;
    logic [129:0] y;
...
//------------------------------------------------------------------------------
// Method process: sc_type_main (test_binary.cpp:278:5) 

always_comb 
begin : sc_type_main     // test_binary.cpp:278:5
    logic [2:0] x;
    logic signed [3:0] y;
    ...
    `endif // INTEL_SVA_OFF
    r2 = signed'({1'b0, x}) * (signed'({1'b0, bux}) + 1);
    `ifndef INTEL_SVA_OFF
...
//------------------------------------------------------------------------------
// Method process: sc_type_main_neg (test_binary.cpp:242:5) 

always_comb 
begin : sc_type_main_neg     // test_binary.cpp:242:5
    logic [4:0] x;
    logic signed [4:0] y;
    logic signed [32:0] bx;
    logic signed [41:0] bz;
...
//------------------------------------------------------------------------------
// Method process: sc_type_main_signed (test_binary.cpp:334:5) 

always_comb 
begin : sc_type_main_signed     // test_binary.cpp:334:5
    logic signed [2:0] x;
    logic signed [3:0] y;
    logic signed [32:0] bx;
...
//------------------------------------------------------------------------------
// Method process: sc_type_logic_bitwise (test_binary.cpp:371:5) 

always_comb 
begin : sc_type_logic_bitwise     // test_binary.cpp:371:5
    integer i;
    integer unsigned uu;
    logic [4:0] x;
    logic signed [3:0] y;
...
//------------------------------------------------------------------------------
// Method process: logic_bitwise_literal (test_binary.cpp:415:5) 

always_comb 
begin : logic_bitwise_literal     // test_binary.cpp:415:5
    integer i;
    integer unsigned uu;
    logic signed [63:0] j;
    logic [99:0] z;
...
//------------------------------------------------------------------------------
// Method process: sc_type_comp (test_binary.cpp:447:5) 

always_comb 
begin : sc_type_comp     // test_binary.cpp:447:5
    integer i;
    integer unsigned uu;
    logic [4:0] x;
    logic signed [3:0] y;
...
//------------------------------------------------------------------------------
// Method process: large_types (test_binary.cpp:482:5) 

always_comb 
begin : large_types     // test_binary.cpp:482:5
...
//------------------------------------------------------------------------------
// Method process: sc_relational_ops (test_binary.cpp:511:5) 

always_comb 
begin : sc_relational_ops     // test_binary.cpp:511:5
...
//------------------------------------------------------------------------------
// Method process: sc_fp_bitwise_fns (test_binary.cpp:588:5) 

// Process-local variables
logic signed [31:0] iter;

always_comb 
begin : sc_fp_bitwise_fns     // test_binary.cpp:588:5
    logic [9:0] par1;
    logic [11:0] par2;
    logic [21:0] par3;
    logic [29:0] par4;
