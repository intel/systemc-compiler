...
//==============================================================================
//
// Module: A (test_cthread_wait_states.cpp:142:5)
//
...
function void not_single_state2_func;
    ...
    case (not_single_state2_PROC_STATE)
        ...
        1: begin
            i = 2;
            t2_next = i;
            not_single_state2_PROC_STATE_next = 2; return;    // test_cthread_wait_states.cpp:80:13;
        end
        2: begin
            i = 2;
            t2_next = i;
...
function void not_single_state3_func;
    ...
    case (not_single_state3_PROC_STATE)
        0: begin
            ...
            i = 2;
            t3_next = i;
            not_single_state3_PROC_STATE_next = 2; return;    // test_cthread_wait_states.cpp:97:13;
        end
        1: begin
            i = 2;
            t3_next = i;
...
function void state_in_if_func;
    ...
    case (state_in_if_PROC_STATE)
        0: begin
            ...
            t4_next = b_next;
            state_in_if_PROC_STATE_next = 2; return;    // test_cthread_wait_states.cpp:113:13;
        end
        1: begin
            t4_next = b_next;
            state_in_if_PROC_STATE_next = 2; return;    // test_cthread_wait_states.cpp:113:13;
    ...
    case (state_in_for_PROC_STATE)
        ...
        1: begin
            ...
            begin
                // break begin
                t5_next = b_next0;
                state_in_for_PROC_STATE_next = 2; return;    // test_cthread_wait_states.cpp:130:13;
                // break end
            end
            i_next++;
            if (i_next < 3)
