...
function void for_stmt_other_types_fns_func;
    ...
    i_3 = par1_3;
    k_3 = '0;
    for (i_3 = '0; signed'({1'b0, i_3}) < 3'sd2; i_3++)
    begin
        k_3 = 32'(i_3);
    end
    t0_next = k_3;
    ...
    for (i_4 = '0; i_4 < 2; i_4++)
    begin
        k_4 = 32'(signed'({1'b0, 32'(i_4)}) + 3'sd2);
    end
    k_4 = 3;
    t1_next = k_4;
    ...
    k_7 = '0;
    k_7 = 1;
    for (i_7 = '0; signed'({1'b0, i_7}) < 3'sd2; i_7++)
    begin
        k_7 = 32'(signed'({1'b0, 32'(i_7)}) + 3'sd2);
    end
    k_7 = 3;
    t1_next = k_7;
    // Call for_stmt_wait0() end
    ...
    i_11 = par1_11;
    k_11 = '0;
    for (i_11 = '0; signed'({1'b0, i_11}) < 3'sd2; i_11++)
    begin
        k_11 = 1;
    end
    k_11 = 2;
    ...
    i_15 = par1_15;
    k_15 = '0;
    for (i_15 = '0; signed'({1'b0, i_15}) < 3'sd2; i_15++)
    begin
        k_15 = 1;
    end
    k_15 = 2;
