...
function void var_init_reset_func;
    ...
    r0_next = r0;
    vi_next = vi;
    r0_next = 32'(32'(mi_next + vi_next) + ci);
endfunction
...
function void local_const_ref_func;
    ...
    case (local_const_ref_PROC_STATE)
        0: begin
            x_next[0] = 6'd44; x_next[1] = 6'd45;
            c2_next = 32'(i_next[1] + 2'sd1);
            c4_next = x_next[1] + 1'd1;
            local_const_ref_PROC_STATE_next = 1; return;    // test_cthread_var_reg.cpp:102:13;
        end
        1: begin
            c6_next = x_next[1] + 1'd1;
            ss_next = 32'(32'(j_next + i_next[0]) + c2_next);
...
function void variables_in_scope2_func;
    ...
    case (variables_in_scope2_PROC_STATE)
        ...
        1: begin
            r5_next = 32'(i_next0 + 32'(lbi_next));
            variables_in_scope2_PROC_STATE_next = 2; return;    // test_cthread_var_reg.cpp:250:17;
        end
        2: begin
            ++i_next0;
...
function void local_record_array1_func;
    ...
    s9_next = s9;
    rarr2_b[1] = 42;
    s9_next = 32'(32'(rarr0_b_next[0] + rarr1_b_next[0]) + rarr2_b[1]);
    rarr1_b_next[s8] = 43;
endfunction
