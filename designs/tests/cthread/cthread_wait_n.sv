...
//------------------------------------------------------------------------------
// Clocked THREAD: thread_waitn_no_reset (test_cthread_wait_n.cpp:136:5) 

// Thread-local variables
logic [3:0] usig_next0;

// Next-state combinational logic
always_comb begin : thread_waitn_no_reset_comb     // test_cthread_wait_n.cpp:136:5
...
//------------------------------------------------------------------------------
// Clocked THREAD: thread_waitn_first_cond (test_cthread_wait_n.cpp:144:5) 
...
// Next-state combinational logic
always_comb begin : thread_waitn_first_cond_comb     // test_cthread_wait_n.cpp:144:5
    ...
    case (thread_waitn_first_cond_PROC_STATE)
        0: begin
            if (thread_waitn_first_cond_WAIT_N_COUNTER != 1) begin
                ...
                thread_waitn_first_cond_PROC_STATE_next = 0; return;    // test_cthread_wait_n.cpp:151:17;
            end;
            usig_next1 = 1;
            thread_waitn_first_cond_PROC_STATE_next = 1; return;    // test_cthread_wait_n.cpp:154:13;
        end
        1: begin
...
begin : thread_waitn_first_cond_ff
    if ( ~rstn ) begin
        ...
        thread_waitn_first_cond_PROC_STATE <= 0;    // test_cthread_wait_n.cpp:151:17;
    end
    else begin
...
//------------------------------------------------------------------------------
// Clocked THREAD: thread_waitn_cond (test_cthread_wait_n.cpp:158:5) 
...
// Next-state combinational logic
always_comb begin : thread_waitn_cond_comb     // test_cthread_wait_n.cpp:158:5
    ...
    case (thread_waitn_cond_PROC_STATE)
        0: begin
            ...
            begin
                ...
                thread_waitn_cond_PROC_STATE_next = 1; return;    // test_cthread_wait_n.cpp:164:17;
            end else begin
                thread_waitn_cond_WAIT_N_COUNTER_next = 5;
                thread_waitn_cond_PROC_STATE_next = 2; return;    // test_cthread_wait_n.cpp:166:17;
            end
        end
        1: begin
            ...
            thread_waitn_cond_PROC_STATE_next = 0; return;    // test_cthread_wait_n.cpp:161:13;
        end
        2: begin
            if (thread_waitn_cond_WAIT_N_COUNTER != 1) begin
                thread_waitn_cond_WAIT_N_COUNTER_next = thread_waitn_cond_WAIT_N_COUNTER - 1;
            ...
            thread_waitn_cond_PROC_STATE_next = 3; return;    // test_cthread_wait_n.cpp:168:17;
        end
        3: begin
            if (thread_waitn_cond_WAIT_N_COUNTER != 1) begin
                thread_waitn_cond_WAIT_N_COUNTER_next = thread_waitn_cond_WAIT_N_COUNTER - 1;
...
begin : thread_waitn_cond_ff
    if ( ~rstn ) begin
        usig <= 0;
        thread_waitn_cond_PROC_STATE <= 0;    // test_cthread_wait_n.cpp:161:13;
...
//------------------------------------------------------------------------------
// Clocked THREAD: thread1a (test_cthread_wait_n.cpp:173:5) 
// Empty process, no code generated 

//------------------------------------------------------------------------------
// Clocked THREAD: thread1b (test_cthread_wait_n.cpp:181:5) 
...
// Next-state combinational logic
always_comb begin : thread1b_comb     // test_cthread_wait_n.cpp:181:5
    thread1b_func;
end
function void thread1b_func;
    ...
    case (thread1b_PROC_STATE)
        0: begin
            ...
            thread1b_PROC_STATE_next = 1; return;    // test_cthread_wait_n.cpp:186:13;
        end
        1: begin
...
begin : thread1b_ff
    if ( ~rstn ) begin
        thread1b_PROC_STATE <= 0;    // test_cthread_wait_n.cpp:182:9;
...
//------------------------------------------------------------------------------
// Clocked THREAD: thread1c (test_cthread_wait_n.cpp:191:5) 
...
// Next-state combinational logic
always_comb begin : thread1c_comb     // test_cthread_wait_n.cpp:191:5
    thread1c_func;
end
function void thread1c_func;
    ...
    case (thread1c_PROC_STATE)
        0: begin
            ...
            thread1c_PROC_STATE_next = 1; return;    // test_cthread_wait_n.cpp:194:13;
        end
        1: begin
...
begin : thread1c_ff
    if ( ~rstn ) begin
        thread1c_PROC_STATE <= 0;    // test_cthread_wait_n.cpp:192:9;
...
//------------------------------------------------------------------------------
// Clocked THREAD: thread1d (test_cthread_wait_n.cpp:200:5) 
// Empty process, no code generated 

//------------------------------------------------------------------------------
// Clocked THREAD: thread2 (test_cthread_wait_n.cpp:208:5) 
// Empty process, no code generated 

//------------------------------------------------------------------------------
// Clocked THREAD: thread3 (test_cthread_wait_n.cpp:215:5) 
...
// Next-state combinational logic
always_comb begin : thread3_comb     // test_cthread_wait_n.cpp:215:5
    thread3_func;
end
function void thread3_func;
    ...
    case (thread3_PROC_STATE)
        0: begin
            ...
            thread3_PROC_STATE_next = 1; return;    // test_cthread_wait_n.cpp:222:13;
        end
        1: begin
            ...
            thread3_PROC_STATE_next = 2; return;    // test_cthread_wait_n.cpp:223:13;
        end
        2: begin
            if (thread3_WAIT_N_COUNTER != 1) begin
                thread3_WAIT_N_COUNTER_next = thread3_WAIT_N_COUNTER - 1;
            ...
            thread3_PROC_STATE_next = 0; return;    // test_cthread_wait_n.cpp:220:13;
        end
    endcase
endfunction
...
begin : thread3_ff
    if ( ~rstn ) begin
        thread3_PROC_STATE <= 0;    // test_cthread_wait_n.cpp:220:13;
...
//------------------------------------------------------------------------------
// Clocked THREAD: thread4_no_waitn (test_cthread_wait_n.cpp:227:5) 
// Empty process, no code generated 

//------------------------------------------------------------------------------
// Clocked THREAD: wait_n_const (test_cthread_wait_n.cpp:236:5) 
...
// Next-state combinational logic
always_comb begin : wait_n_const_comb     // test_cthread_wait_n.cpp:236:5
    wait_n_const_func;
end
function void wait_n_const_func;
    ...
    case (wait_n_const_PROC_STATE)
        0: begin
            ...
            wait_n_const_PROC_STATE_next = 1; return;    // test_cthread_wait_n.cpp:241:13;
        end
        1: begin
...
begin : wait_n_const_ff
    if ( ~rstn ) begin
        n0 = 2;
        wait_n_const_PROC_STATE <= 0;    // test_cthread_wait_n.cpp:238:9;
...
//------------------------------------------------------------------------------
// Clocked THREAD: wait_n_var (test_cthread_wait_n.cpp:245:5) 
...
// Next-state combinational logic
always_comb begin : wait_n_var_comb     // test_cthread_wait_n.cpp:245:5
    wait_n_var_func;
end
function void wait_n_var_func;
    ...
    case (wait_n_var_PROC_STATE)
        0: begin
            ...
            wait_n_var_PROC_STATE_next = 1; return;    // test_cthread_wait_n.cpp:251:13;
        end
        1: begin
...
begin : wait_n_var_ff
    if ( ~rstn ) begin
        integer unsigned n_1;
        n_1 = 0;
        wait_n_var_PROC_STATE <= 0;    // test_cthread_wait_n.cpp:247:9;
...
//------------------------------------------------------------------------------
// Clocked THREAD: wait_n_calc (test_cthread_wait_n.cpp:255:5) 
...
// Next-state combinational logic
always_comb begin : wait_n_calc_comb     // test_cthread_wait_n.cpp:255:5
    wait_n_calc_func;
end
function void wait_n_calc_func;
    ...
    case (wait_n_calc_PROC_STATE)
        0: begin
            ...
            wait_n_calc_PROC_STATE_next = 1; return;    // test_cthread_wait_n.cpp:262:13;
        end
        1: begin
            ...
            wait_n_calc_PROC_STATE_next = 2; return;    // test_cthread_wait_n.cpp:265:13;
        end
        2: begin
            if (wait_n_calc_WAIT_N_COUNTER != 1) begin
                wait_n_calc_WAIT_N_COUNTER_next = wait_n_calc_WAIT_N_COUNTER - 1;
...
begin : wait_n_calc_ff
    if ( ~rstn ) begin
        wait_n_calc_PROC_STATE <= 0;    // test_cthread_wait_n.cpp:258:9;
...
//------------------------------------------------------------------------------
// Clocked THREAD: wait_n_calc_if (test_cthread_wait_n.cpp:270:5) 
...
// Next-state combinational logic
always_comb begin : wait_n_calc_if_comb     // test_cthread_wait_n.cpp:270:5
    wait_n_calc_if_func;
end
    ...
    case (wait_n_calc_if_PROC_STATE)
        0: begin
            ...
            begin
                ...
                wait_n_calc_if_PROC_STATE_next = 1; return;    // test_cthread_wait_n.cpp:277:27;
            end
            wait_n_calc_if_PROC_STATE_next = 2; return;    // test_cthread_wait_n.cpp:279:13;
        end
        1: begin
...
begin : wait_n_calc_if_ff
    if ( ~rstn ) begin
        wait_n_calc_if_PROC_STATE <= 0;    // test_cthread_wait_n.cpp:273:9;
...
//------------------------------------------------------------------------------
// Clocked THREAD: wait_n_calc_for (test_cthread_wait_n.cpp:284:5) 
...
// Next-state combinational logic
always_comb begin : wait_n_calc_for_comb     // test_cthread_wait_n.cpp:284:5
...
function void wait_n_calc_for_func;
    ...
    case (wait_n_calc_for_PROC_STATE)
        0: begin
            ...
            wait_n_calc_for_PROC_STATE_next = 1; return;    // test_cthread_wait_n.cpp:291:17;
        end
        1: begin
...
begin : wait_n_calc_for_ff
    if ( ~rstn ) begin
        n2 <= 3;
        wait_n_calc_for_PROC_STATE <= 0;    // test_cthread_wait_n.cpp:287:9;
...
//------------------------------------------------------------------------------
// Clocked THREAD: three_wait (test_cthread_wait_n.cpp:296:5) 
// Empty process, no code generated 

//------------------------------------------------------------------------------
// Clocked THREAD: four_wait (test_cthread_wait_n.cpp:308:5) 
// Empty process, no code generated 

//------------------------------------------------------------------------------
// Clocked THREAD: cntr_name_conflict (test_cthread_wait_n.cpp:323:5) 
...
// Next-state combinational logic
always_comb begin : cntr_name_conflict_comb     // test_cthread_wait_n.cpp:323:5
...
function void cntr_name_conflict_func;
    ...
    case (cntr_name_conflict_PROC_STATE)
        0: begin
            ...
            cntr_name_conflict_PROC_STATE_next = 1; return;    // test_cthread_wait_n.cpp:332:13;
        end
        1: begin
...
begin : cntr_name_conflict_ff
    if ( ~rstn ) begin
        ...
        cntr_name_conflict_PROC_STATE <= 0;    // test_cthread_wait_n.cpp:327:9;
...
//------------------------------------------------------------------------------
// Clocked THREAD: while_wait (test_cthread_wait_n.cpp:336:5) 
// Empty process, no code generated 

//------------------------------------------------------------------------------
// Clocked THREAD: wait_1 (test_cthread_wait_n.cpp:347:5) 
...
// Next-state combinational logic
always_comb begin : wait_1_comb     // test_cthread_wait_n.cpp:347:5
    wait_1_func;
end
