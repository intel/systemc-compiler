...
function void while_alive2_func;
    ...
    case (while_alive2_PROC_STATE)
        ...
        1: begin
            i_next11++;
            if (i_next11 < 32'(s + 2'sd1))
            begin
                while_alive2_PROC_STATE_next = 1; return;    // test_cthread_alive_loop.cpp:403:21>;
            end
            j_next7++;
            if (j_next7 < 32'(s + 3'sd2))
            begin
                i_next11 = '0;
                while_alive2_PROC_STATE_next = 1; return;    // test_cthread_alive_loop.cpp:403:21>;
            end
