...
function void range_select_lhs1a_func;
    ...
    out3_next = (x_next0[2 : 1] == in) ? x_next0[2 : 0] + 1'd1 : x_next0[1 : 1] * 2'd2;
endfunction
...
function void range_select_logic_func;
    ...
    b_1 = |x_next1[1 : 0] || x_next1[2 : 1] == 1'd1 && x_next1[3 : 0] > 1'd0;
...
function void range_select_arithm_func;
    ...
    zz = 7'(signed'({1'b0, z_next0[14 : 10]}) * 3'sd3) >>> z_next0[5 : 0];
