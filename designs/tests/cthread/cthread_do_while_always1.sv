...
function void for_ever_func;
    ...
    case (for_ever_PROC_STATE)
        ...
        1: begin
            ...
            s1_next = 3;
            for_ever_PROC_STATE_next = 0; return;    // test_do_while_always1.cpp:93:13;
        end
    endcase
endfunction
...
function void dowhile_break1_func;
    ...
    case (dowhile_break1_PROC_STATE)
        0: begin
            ...
            i_next1++;
            s2_next = i_next1;
            dowhile_break1_PROC_STATE_next = 0; return;    // test_do_while_always1.cpp:114:17;
        end
        2: begin
            // break begin
            dowhile_break1_PROC_STATE_next = 0; return;    // test_do_while_always1.cpp:118:13;
            // break end
        end
    endcase
endfunction
...
function void dowhile_break2_func;
    ...
    case (dowhile_break2_PROC_STATE)
        ...
        1: begin
            ...
            begin
                // break begin
                dowhile_break2_PROC_STATE_next = 0; return;    // test_do_while_always1.cpp:143:13;
                // break end
            end else begin
                // continue begin
                s3_next = s2;
        ...
        1: begin
            ...
            begin
                ...
                begin
                    s4_next = 1;
                    // break begin
                    dowhile_break3_PROC_STATE_next = 0; return;    // test_do_while_always1.cpp:176:13;
                    // break end
                end
                s4_next = s2;
            ...
            dowhile_break3_PROC_STATE_next = 0; return;    // test_do_while_always1.cpp:162:17;
        end
        3: begin
            if (|s2)
            begin
        ...
        1: begin
            ...
            begin
                ...
                begin
                    s5_next = 1;
                    // continue begin
                    dowhile_continue1_PROC_STATE_next = 0; return;    // test_do_while_always1.cpp:208:13;
                    // continue end
                end
        ...
        1: begin
            ...
            begin
                ...
                begin
                    ...
                    dowhile_continue2_PROC_STATE_next = 0; return;    // test_do_while_always1.cpp:238:13;
                    // continue end
                end
