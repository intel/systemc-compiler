...
begin : ar1_proc_ff
    if ( ~ar1_nrst[0] ) begin
        ...
        ar1_t0[0] <= ar1_t0_next[0];
    end
end

//------------------------------------------------------------------------------
// Clocked THREAD: ar1_proc0 (test_mif_array_differ.cpp:34:5) 

// Next-state combinational logic
always_comb begin : ar1_proc0_comb     // test_mif_array_differ.cpp:34:5
    ar1_proc0_func;
end
function void ar1_proc0_func;
    integer unsigned l;
    ar1_t0_next[1] = ar1_t0[1];
    l = ar1_V[1] + ar1_C[1];
    ar1_t0_next[1] = l;
endfunction
...
function void br1_proc_func;
    integer unsigned l;
    br1_t1_next[0] = br1_t1[0];
    proc_PROC_STATE_next = proc_PROC_STATE;
    
    case (proc_PROC_STATE)
        0: begin
            l = br1_V[0];
            proc_PROC_STATE_next = 1; return;    // test_mif_array_differ.cpp:68:13;
        end
        1: begin
            l = br1_V[0] + 1;
            br1_t1_next[0] = l;
...
begin : br1_proc_ff
    if ( ~br1_nrst[0] ) begin
        proc_PROC_STATE <= 0;    // test_mif_array_differ.cpp:65:9;
    end
    else begin
        br1_t1[0] <= br1_t1_next[0];
        proc_PROC_STATE <= proc_PROC_STATE_next;
    end
end

//------------------------------------------------------------------------------
// Clocked THREAD: br1_proc0 (test_mif_array_differ.cpp:63:5) 
...
// Next-state combinational logic
always_comb begin : br1_proc0_comb     // test_mif_array_differ.cpp:63:5
    br1_proc0_func;
end
function void br1_proc0_func;
    integer unsigned l;
    br1_t1_next[1] = br1_t1[1];
    proc_PROC_STATE_next0 = proc_PROC_STATE0;
    
    case (proc_PROC_STATE0)
        0: begin
            l = br1_V[1];
            proc_PROC_STATE_next0 = 1; return;    // test_mif_array_differ.cpp:68:13;
        end
        1: begin
            l = br1_V[1] + 1;
            br1_t1_next[1] = l;
...
begin : br1_proc0_ff
    if ( ~br1_nrst[1] ) begin
        proc_PROC_STATE0 <= 0;    // test_mif_array_differ.cpp:65:9;
    end
    else begin
        br1_t1[1] <= br1_t1_next[1];
...
begin : ar2_proc_ff
    if ( ~ar2_nrst[0] ) begin
        ...
        ar2_t0[0] <= ar2_t0_next[0];
    end
end

//------------------------------------------------------------------------------
// Clocked THREAD: ar2_proc0 (test_mif_array_differ.cpp:34:5) 

// Next-state combinational logic
always_comb begin : ar2_proc0_comb     // test_mif_array_differ.cpp:34:5
    ar2_proc0_func;
end
function void ar2_proc0_func;
    integer unsigned l;
    ar2_t0_next[1] = ar2_t0[1];
    l = ar2_V[1] + ar2_C[1];
    ar2_t0_next[1] = l;
endfunction
...
function void br2_proc_func;
    integer unsigned l;
    br2_t1_next[0] = br2_t1[0];
    proc_PROC_STATE_next1 = proc_PROC_STATE1;
    
    case (proc_PROC_STATE1)
        0: begin
            l = br2_V[0];
            proc_PROC_STATE_next1 = 1; return;    // test_mif_array_differ.cpp:68:13;
        end
        1: begin
            l = br2_V[0] + 1;
            br2_t1_next[0] = l;
...
begin : br2_proc_ff
    if ( ~br2_nrst[0] ) begin
        proc_PROC_STATE1 <= 0;    // test_mif_array_differ.cpp:65:9;
    end
    else begin
        br2_t1[0] <= br2_t1_next[0];
        proc_PROC_STATE1 <= proc_PROC_STATE_next1;
    end
end

//------------------------------------------------------------------------------
// Clocked THREAD: br2_proc0 (test_mif_array_differ.cpp:63:5) 
...
// Next-state combinational logic
always_comb begin : br2_proc0_comb     // test_mif_array_differ.cpp:63:5
    br2_proc0_func;
end
function void br2_proc0_func;
    integer unsigned l;
    br2_t1_next[1] = br2_t1[1];
    proc_PROC_STATE_next2 = proc_PROC_STATE2;
    
    case (proc_PROC_STATE2)
        0: begin
            l = br2_V[1];
            proc_PROC_STATE_next2 = 1; return;    // test_mif_array_differ.cpp:68:13;
        end
        1: begin
            l = br2_V[1] + 1;
            br2_t1_next[1] = l;
...
begin : br2_proc0_ff
    if ( ~br2_nrst[1] ) begin
        proc_PROC_STATE2 <= 0;    // test_mif_array_differ.cpp:65:9;
    end
    else begin
        br2_t1[1] <= br2_t1_next[1];
...
begin : ar3_proc_ff
    if ( ~ar3_nrst[0] ) begin
        ...
        ar3_t0[0] <= ar3_t0_next[0];
    end
end

//------------------------------------------------------------------------------
// Clocked THREAD: ar3_proc0 (test_mif_array_differ.cpp:34:5) 

// Next-state combinational logic
always_comb begin : ar3_proc0_comb     // test_mif_array_differ.cpp:34:5
    ar3_proc0_func;
end
function void ar3_proc0_func;
    integer unsigned l;
    ar3_t0_next[1] = ar3_t0[1];
    l = ar3_V[1] + ar3_C[1];
    ar3_t0_next[1] = l;
endfunction
...
function void br3_proc_func;
    integer unsigned l;
    br3_t1_next[0] = br3_t1[0];
    proc_PROC_STATE_next3 = proc_PROC_STATE3;
    
    case (proc_PROC_STATE3)
        0: begin
            l = br3_V[0];
            proc_PROC_STATE_next3 = 1; return;    // test_mif_array_differ.cpp:68:13;
        end
        1: begin
            l = br3_V[0] + 1;
            br3_t1_next[0] = l;
...
begin : br3_proc_ff
    if ( ~br3_nrst[0] ) begin
        proc_PROC_STATE3 <= 0;    // test_mif_array_differ.cpp:65:9;
    end
    else begin
        br3_t1[0] <= br3_t1_next[0];
        proc_PROC_STATE3 <= proc_PROC_STATE_next3;
    end
end

//------------------------------------------------------------------------------
// Clocked THREAD: br3_proc0 (test_mif_array_differ.cpp:63:5) 
...
// Next-state combinational logic
always_comb begin : br3_proc0_comb     // test_mif_array_differ.cpp:63:5
    br3_proc0_func;
end
function void br3_proc0_func;
    integer unsigned l;
    br3_t1_next[1] = br3_t1[1];
    proc_PROC_STATE_next4 = proc_PROC_STATE4;
    
    case (proc_PROC_STATE4)
        0: begin
            l = br3_V[1];
            proc_PROC_STATE_next4 = 1; return;    // test_mif_array_differ.cpp:68:13;
        end
        1: begin
            l = br3_V[1] + 1;
            br3_t1_next[1] = l;
...
begin : br3_proc0_ff
    if ( ~br3_nrst[1] ) begin
        proc_PROC_STATE4 <= 0;    // test_mif_array_differ.cpp:65:9;
    end
    else begin
        br3_t1[1] <= br3_t1_next[1];
