...
//------------------------------------------------------------------------------
// Clocked THREAD: array_use_def2 (test_cthread_array_access.cpp:202:5) 
...
// Next-state combinational logic
always_comb begin : array_use_def2_comb     // test_cthread_array_access.cpp:202:5
    array_use_def2_func;
end
function void array_use_def2_func;
    ...
    case (array_use_def2_PROC_STATE)
        0: begin
            ...
            y[0] = 0; y[1] = 0;
            array_use_def2_PROC_STATE_next = 1; return;    // test_cthread_array_access.cpp:214:13;
        end
        1: begin
            z_next[1] = 2;
            i = z_next[0];
            ...
            i = u_next[0];
            y[1] = 4;
            array_use_def2_PROC_STATE_next = 2; return;    // test_cthread_array_access.cpp:223:13;
        end
        2: begin
            i = u_next[0];
            y[1] = 5;
            i = y[1];
            t5_next = i;
            array_use_def2_PROC_STATE_next = 0; return;    // test_cthread_array_access.cpp:229:13;
        end
    endcase
endfunction
...
begin : array_use_def2_ff
    if ( rst ) begin
        array_use_def2_PROC_STATE <= 0;    // test_cthread_array_access.cpp:204:9;
    end
    else begin
        z0 <= z_next;
        u0 <= u_next;
...
//------------------------------------------------------------------------------
// Clocked THREAD: array_use_def_ptr1 (test_cthread_array_access.cpp:242:5) 
...
// Next-state combinational logic
always_comb begin : array_use_def_ptr1_comb     // test_cthread_array_access.cpp:242:5
...
//------------------------------------------------------------------------------
// Clocked THREAD: array_use_def_ptr2 (test_cthread_array_access.cpp:271:5) 
...
// Next-state combinational logic
always_comb begin : array_use_def_ptr2_comb     // test_cthread_array_access.cpp:271:5
...
//------------------------------------------------------------------------------
// Clocked THREAD: array_use_def_sig (test_cthread_array_access.cpp:302:5) 
...
// Next-state combinational logic
always_comb begin : array_use_def_sig_comb     // test_cthread_array_access.cpp:302:5
...
//------------------------------------------------------------------------------
// Clocked THREAD: array_elem_trhead1 (test_cthread_array_access.cpp:328:5) 
...
// Next-state combinational logic
always_comb begin : array_elem_trhead1_comb     // test_cthread_array_access.cpp:328:5
...
//------------------------------------------------------------------------------
// Clocked THREAD: array_elem_trhead2 (test_cthread_array_access.cpp:342:5) 
...
// Next-state combinational logic
always_comb begin : array_elem_trhead2_comb     // test_cthread_array_access.cpp:342:5
