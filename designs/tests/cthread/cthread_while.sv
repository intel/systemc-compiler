...
//------------------------------------------------------------------------------
// Clocked THREAD: while_with_binary_oper (test_while.cpp:213:5) 
...
// Next-state combinational logic
always_comb begin : while_with_binary_oper_comb     // test_while.cpp:213:5
...
function void while_with_binary_oper_func;
    ...
    case (while_with_binary_oper_PROC_STATE)
        0: begin
            ...
            begin
                k_next = 1;
                while_with_binary_oper_PROC_STATE_next = 1; return;    // test_while.cpp:222:17;
            end
            t0_next = k_next;
            while_with_binary_oper_PROC_STATE_next = 2; return;    // test_while.cpp:226:13;
        end
        1: begin
            k_next = 2;
            if (b1_next || b2_next)
...
begin : while_with_binary_oper_ff
    if ( ~arstn ) begin
        k <= 0;
        while_with_binary_oper_PROC_STATE <= 0;    // test_while.cpp:217:9;
    end
    else begin
        b1 <= b1_next;
        b2 <= b2_next;
...
//------------------------------------------------------------------------------
// Clocked THREAD: while_with_binary_oper1 (test_while.cpp:231:5) 
...
// Next-state combinational logic
always_comb begin : while_with_binary_oper1_comb     // test_while.cpp:231:5
...
function void while_with_binary_oper1_func;
    ...
    case (while_with_binary_oper1_PROC_STATE)
        0: begin
            ...
            begin
                k_next0 = 1;
                while_with_binary_oper1_PROC_STATE_next = 1; return;    // test_while.cpp:240:17;
            end
            t1_next = k_next0;
            while_with_binary_oper1_PROC_STATE_next = 2; return;    // test_while.cpp:244:13;
        end
        1: begin
            k_next0 = 2;
            if (b1_next0 && |s)
...
begin : while_with_binary_oper1_ff
    if ( ~arstn ) begin
        k0 <= 0;
        while_with_binary_oper1_PROC_STATE <= 0;    // test_while.cpp:235:9;
    end
    else begin
        b10 <= b1_next0;
        k0 <= k_next0;
...
//------------------------------------------------------------------------------
// Clocked THREAD: while_with_binary_oper2 (test_while.cpp:250:5) 
...
// Next-state combinational logic
always_comb begin : while_with_binary_oper2_comb     // test_while.cpp:250:5
...
function void while_with_binary_oper2_func;
    ...
    case (while_with_binary_oper2_PROC_STATE)
        0: begin
            ...
            begin
                k_next1 = 1;
                while_with_binary_oper2_PROC_STATE_next = 1; return;    // test_while.cpp:259:17;
            end
            t2_next = k_next1;
            while_with_binary_oper2_PROC_STATE_next = 2; return;    // test_while.cpp:263:13;
        end
        1: begin
            k_next1 = 2;
            if ((b1_next1 || b2_next0) && b3_next)
...
begin : while_with_binary_oper2_ff
    if ( ~arstn ) begin
        k1 <= 0;
        while_with_binary_oper2_PROC_STATE <= 0;    // test_while.cpp:254:9;
    end
    else begin
        b11 <= b1_next1;
        b20 <= b2_next0;
...
//------------------------------------------------------------------------------
// Clocked THREAD: while_with_binary_oper3 (test_while.cpp:268:5) 
...
// Next-state combinational logic
always_comb begin : while_with_binary_oper3_comb     // test_while.cpp:268:5
...
function void while_with_binary_oper3_func;
    ...
    case (while_with_binary_oper3_PROC_STATE)
        0: begin
            ...
            begin
                k_next2 = 1;
                while_with_binary_oper3_PROC_STATE_next = 1; return;    // test_while.cpp:277:17;
            end
            t3_next = k_next2;
            while_with_binary_oper3_PROC_STATE_next = 2; return;    // test_while.cpp:281:13;
        end
        1: begin
            k_next2 = 2;
            if ((b1_next2 && |s) || b3_next0)
...
begin : while_with_binary_oper3_ff
    if ( ~arstn ) begin
        k2 <= 0;
        while_with_binary_oper3_PROC_STATE <= 0;    // test_while.cpp:272:9;
    end
    else begin
        b12 <= b1_next2;
        b30 <= b3_next0;
...
//------------------------------------------------------------------------------
// Clocked THREAD: while_continue1 (test_while.cpp:303:5) 
...
// Next-state combinational logic
always_comb begin : while_continue1_comb     // test_while.cpp:303:5
...
function void while_continue1_func;
    ...
    case (while_continue1_PROC_STATE)
        0: begin
            if (!(|s))
            begin
                while_continue1_PROC_STATE_next = 1; return;    // test_while.cpp:311:17;
            end
            if (|s)
            begin
                while_continue1_PROC_STATE_next = 2; return;    // test_while.cpp:316:17;
            end
            while_continue1_PROC_STATE_next = 3; return;    // test_while.cpp:322:13;
        end
        1: begin
            s2_next = 2;
            if (!(|s))
...
begin : while_continue1_ff
    if ( ~arstn ) begin
        s2 <= 0;
        while_continue1_PROC_STATE <= 0;    // test_while.cpp:306:9;
    end
    else begin
        s2 <= s2_next;
...
//------------------------------------------------------------------------------
// Clocked THREAD: while_break1 (test_while.cpp:327:5) 
...
// Next-state combinational logic
always_comb begin : while_break1_comb     // test_while.cpp:327:5
    while_break1_func;
end
function void while_break1_func;
    ...
    case (while_break1_PROC_STATE)
        0: begin
            s3_next = 0;
            while_break1_PROC_STATE_next = 1; return;    // test_while.cpp:335:17;
        end
        1: begin
            if (|s1)
            begin
                ...
                begin
                    if (|s2)
                    begin
                        while_break1_PROC_STATE_next = 2; return;    // test_while.cpp:343:21;
                    end
                    if (s1 > s2)
                    begin
                        while_break1_PROC_STATE_next = 3; return;    // test_while.cpp:346:21;
                    end
                    s3_next = 2;
                    while_break1_PROC_STATE_next = 4; return;    // test_while.cpp:350:17;
                end
                while_break1_PROC_STATE_next = 5; return;    // test_while.cpp:353:13;
                // break end
            end
            s3_next = 1;
            while_break1_PROC_STATE_next = 1; return;    // test_while.cpp:335:17;
...
begin : while_break1_ff
    if ( ~arstn ) begin
        while_break1_PROC_STATE <= 0;    // test_while.cpp:329:9;
    end
    else begin
        s3 <= s3_next;
