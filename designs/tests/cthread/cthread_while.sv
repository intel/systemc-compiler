...
function void while_with_wait0a_func;
    ...
    case (while_with_wait0a_PROC_STATE)
        0: begin
            ...
            while_with_wait0a_PROC_STATE_next = 0; return;    // test_while.cpp:107:13;
        end
        1: begin
            i_next0++;
            if (i_next0 < 3)
...
function void while_with_wait0b_func;
    ...
    case (while_with_wait0b_PROC_STATE)
        0: begin
            ...
            while_with_wait0b_PROC_STATE_next = 0; return;    // test_while.cpp:121:13;
        end
        1: begin
            i_next1++;
            if (i_next1 < s)
...
function void while_with_wait1_func;
    ...
    case (while_with_wait1_PROC_STATE)
        ...
        1: begin
            ...
            out_next = 2;
            while_with_wait1_PROC_STATE_next = 0; return;    // test_while.cpp:140:13;
        end
    endcase
endfunction
...
function void while_with_wait2_func;
    ...
    case (while_with_wait2_PROC_STATE)
        ...
        1: begin
            ...
            out_next0 = 3;
            while_with_wait2_PROC_STATE_next = 0; return;    // test_while.cpp:164:13;
        end
        2: begin
            if (i_next3 < 3)
            begin
...
function void while_with_for_func;
    ...
    case (while_with_for_PROC_STATE)
        ...
        1: begin
            ...
            out_next1 = 3;
            while_with_for_PROC_STATE_next = 0; return;    // test_while.cpp:189:13;
        end
    endcase
endfunction
...
function void while_with_signal_cond_func;
    ...
    case (while_with_signal_cond_PROC_STATE)
        0: begin
            ...
            begin
                out_next2 = 1;
                while_with_signal_cond_PROC_STATE_next = 0; return;    // test_while.cpp:203:17;
            end
            out_next2 = 2;
            while_with_signal_cond_PROC_STATE_next = 0; return;    // test_while.cpp:207:13;
        end
    endcase
endfunction
...
function void while_with_binary_oper_func;
    ...
    case (while_with_binary_oper_PROC_STATE)
        0: begin
            ...
            t0_next = k_next;
            while_with_binary_oper_PROC_STATE_next = 0; return;    // test_while.cpp:226:13;
        end
        1: begin
            k_next = 2;
            if (b1_next || b2_next)
...
function void while_with_binary_oper1_func;
    ...
    case (while_with_binary_oper1_PROC_STATE)
        0: begin
            ...
            t1_next = k_next0;
            while_with_binary_oper1_PROC_STATE_next = 0; return;    // test_while.cpp:244:13;
        end
        1: begin
            k_next0 = 2;
            if (b1_next0 && |s)
...
function void while_with_binary_oper2_func;
    ...
    case (while_with_binary_oper2_PROC_STATE)
        0: begin
            ...
            t2_next = k_next1;
            while_with_binary_oper2_PROC_STATE_next = 0; return;    // test_while.cpp:263:13;
        end
        1: begin
            k_next1 = 2;
            if ((b1_next1 || b2_next0) && b3_next)
...
function void while_with_binary_oper3_func;
    ...
    case (while_with_binary_oper3_PROC_STATE)
        0: begin
            ...
            t3_next = k_next2;
            while_with_binary_oper3_PROC_STATE_next = 0; return;    // test_while.cpp:281:13;
        end
        1: begin
            k_next2 = 2;
            if ((b1_next2 && |s) || b3_next0)
...
function void while_continue1_func;
    ...
    case (while_continue1_PROC_STATE)
        0: begin
            ...
            while_continue1_PROC_STATE_next = 0; return;    // test_while.cpp:322:13;
        end
        1: begin
            s2_next = 2;
            if (!(|s))
    ...
    case (while_break1_PROC_STATE)
        ...
        1: begin
            ...
            begin
                ...
                while_break1_PROC_STATE_next = 0; return;    // test_while.cpp:353:13;
                // break end
            end
            s3_next = 1;
            while_break1_PROC_STATE_next = 1; return;    // test_while.cpp:335:17;
