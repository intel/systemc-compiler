...
//------------------------------------------------------------------------------
// Clocked THREAD: while_with_wait2 (test_while.cpp:131:5) 
...
// Next-state combinational logic
always_comb begin : while_with_wait2_comb     // test_while.cpp:131:5
...
function void while_with_wait2_func;
    ...
    case (while_with_wait2_PROC_STATE)
        0: begin
            ...
            i_next3++;
            out_next0 = 1;
            while_with_wait2_PROC_STATE_next = 1; return;    // test_while.cpp:142:17;
        end
        1: begin
            if (in > 1)
            begin
                out_next0 = 2;
                while_with_wait2_PROC_STATE_next = 2; return;    // test_while.cpp:146:21;
            end
            if (i_next3 < 3)
            begin
                i_next3++;
            ...
            out_next0 = 3;
            while_with_wait2_PROC_STATE_next = 0; return;    // test_while.cpp:150:13;
        end
        2: begin
            if (i_next3 < 3)
            begin
...
begin : while_with_wait2_ff
    if ( ~arstn ) begin
        out <= 0;
        while_with_wait2_PROC_STATE <= 0;    // test_while.cpp:134:9;
    end
    else begin
        out <= out_next0;
        i3 <= i_next3;
...
//------------------------------------------------------------------------------
// Clocked THREAD: while_with_for (test_while.cpp:155:5) 
...
// Next-state combinational logic
always_comb begin : while_with_for_comb     // test_while.cpp:155:5
    while_with_for_func;
end
function void while_with_for_func;
    ...
    case (while_with_for_PROC_STATE)
        0: begin
            ...
            while_with_for_PROC_STATE_next = 1; return;    // test_while.cpp:171:21;
        end
        1: begin
            j_next++;
            if (j_next < 2)
            ...
            out_next1 = 3;
            while_with_for_PROC_STATE_next = 0; return;    // test_while.cpp:175:13;
        end
    endcase
endfunction
...
begin : while_with_for_ff
    if ( ~arstn ) begin
        out <= 0;
        while_with_for_PROC_STATE <= 0;    // test_while.cpp:158:9;
    end
    else begin
        out <= out_next1;
        j <= j_next;
...
//------------------------------------------------------------------------------
// Clocked THREAD: while_with_signal_cond (test_while.cpp:180:5) 
...
// Next-state combinational logic
always_comb begin : while_with_signal_cond_comb     // test_while.cpp:180:5
...
function void while_with_signal_cond_func;
    ...
    case (while_with_signal_cond_PROC_STATE)
        0: begin
            ...
            begin
                out_next2 = 1;
                while_with_signal_cond_PROC_STATE_next = 0; return;    // test_while.cpp:189:17;
            end
            out_next2 = 2;
            while_with_signal_cond_PROC_STATE_next = 0; return;    // test_while.cpp:193:13;
        end
    endcase
endfunction
...
begin : while_with_signal_cond_ff
    if ( ~arstn ) begin
        out <= 0;
        while_with_signal_cond_PROC_STATE <= 0;    // test_while.cpp:183:9;
    end
    else begin
        out <= out_next2;
...
//------------------------------------------------------------------------------
// Clocked THREAD: while_with_binary_oper (test_while.cpp:199:5) 
...
// Next-state combinational logic
always_comb begin : while_with_binary_oper_comb     // test_while.cpp:199:5
...
function void while_with_binary_oper_func;
    ...
    case (while_with_binary_oper_PROC_STATE)
        0: begin
            ...
            begin
                k_next = 1;
                while_with_binary_oper_PROC_STATE_next = 1; return;    // test_while.cpp:208:17;
            end
            t0_next = k_next;
            while_with_binary_oper_PROC_STATE_next = 0; return;    // test_while.cpp:212:13;
        end
        1: begin
            k_next = 2;
            if (b1_next || b2_next)
...
begin : while_with_binary_oper_ff
    if ( ~arstn ) begin
        k <= 0;
        while_with_binary_oper_PROC_STATE <= 0;    // test_while.cpp:203:9;
    end
    else begin
        b1 <= b1_next;
        b2 <= b2_next;
...
//------------------------------------------------------------------------------
// Clocked THREAD: while_with_binary_oper1 (test_while.cpp:217:5) 
...
// Next-state combinational logic
always_comb begin : while_with_binary_oper1_comb     // test_while.cpp:217:5
...
function void while_with_binary_oper1_func;
    ...
    case (while_with_binary_oper1_PROC_STATE)
        0: begin
            ...
            begin
                k_next0 = 1;
                while_with_binary_oper1_PROC_STATE_next = 1; return;    // test_while.cpp:226:17;
            end
            t1_next = k_next0;
            while_with_binary_oper1_PROC_STATE_next = 0; return;    // test_while.cpp:230:13;
        end
        1: begin
            k_next0 = 2;
            if (b1_next0 && |s)
...
begin : while_with_binary_oper1_ff
    if ( ~arstn ) begin
        k0 <= 0;
        while_with_binary_oper1_PROC_STATE <= 0;    // test_while.cpp:221:9;
    end
    else begin
        b10 <= b1_next0;
        k0 <= k_next0;
...
//------------------------------------------------------------------------------
// Clocked THREAD: while_with_binary_oper2 (test_while.cpp:236:5) 
...
// Next-state combinational logic
always_comb begin : while_with_binary_oper2_comb     // test_while.cpp:236:5
...
function void while_with_binary_oper2_func;
    ...
    case (while_with_binary_oper2_PROC_STATE)
        0: begin
            ...
            begin
                k_next1 = 1;
                while_with_binary_oper2_PROC_STATE_next = 1; return;    // test_while.cpp:245:17;
            end
            t2_next = k_next1;
            while_with_binary_oper2_PROC_STATE_next = 0; return;    // test_while.cpp:249:13;
        end
        1: begin
            k_next1 = 2;
            if ((b1_next1 || b2_next0) && b3_next)
...
begin : while_with_binary_oper2_ff
    if ( ~arstn ) begin
        k1 <= 0;
        while_with_binary_oper2_PROC_STATE <= 0;    // test_while.cpp:240:9;
    end
    else begin
        b11 <= b1_next1;
        b20 <= b2_next0;
...
//------------------------------------------------------------------------------
// Clocked THREAD: while_with_binary_oper3 (test_while.cpp:254:5) 
...
// Next-state combinational logic
always_comb begin : while_with_binary_oper3_comb     // test_while.cpp:254:5
...
function void while_with_binary_oper3_func;
    ...
    case (while_with_binary_oper3_PROC_STATE)
        0: begin
            ...
            begin
                k_next2 = 1;
                while_with_binary_oper3_PROC_STATE_next = 1; return;    // test_while.cpp:263:17;
            end
            t3_next = k_next2;
            while_with_binary_oper3_PROC_STATE_next = 0; return;    // test_while.cpp:267:13;
        end
        1: begin
            k_next2 = 2;
            if ((b1_next2 && |s) || b3_next0)
...
begin : while_with_binary_oper3_ff
    if ( ~arstn ) begin
        k2 <= 0;
        while_with_binary_oper3_PROC_STATE <= 0;    // test_while.cpp:258:9;
    end
    else begin
        b12 <= b1_next2;
        b30 <= b3_next0;
...
//------------------------------------------------------------------------------
// Clocked THREAD: while_continue1 (test_while.cpp:289:5) 
...
// Next-state combinational logic
always_comb begin : while_continue1_comb     // test_while.cpp:289:5
...
function void while_continue1_func;
    ...
    case (while_continue1_PROC_STATE)
        0: begin
            if (!(|s))
            begin
                while_continue1_PROC_STATE_next = 1; return;    // test_while.cpp:297:17;
            end
            if (|s)
            begin
                while_continue1_PROC_STATE_next = 2; return;    // test_while.cpp:302:17;
            end
            while_continue1_PROC_STATE_next = 0; return;    // test_while.cpp:308:13;
        end
        1: begin
            s2_next = 2;
            if (!(|s))
...
begin : while_continue1_ff
    if ( ~arstn ) begin
        s2 <= 0;
        while_continue1_PROC_STATE <= 0;    // test_while.cpp:292:9;
    end
    else begin
        s2 <= s2_next;
...
//------------------------------------------------------------------------------
// Clocked THREAD: while_break1 (test_while.cpp:313:5) 
...
// Next-state combinational logic
always_comb begin : while_break1_comb     // test_while.cpp:313:5
    while_break1_func;
end
function void while_break1_func;
    ...
    case (while_break1_PROC_STATE)
        0: begin
            s3_next = 0;
            while_break1_PROC_STATE_next = 1; return;    // test_while.cpp:321:17;
        end
        1: begin
            if (|s1)
            begin
                ...
                begin
                    if (|s2)
                    begin
                        while_break1_PROC_STATE_next = 2; return;    // test_while.cpp:329:21;
                    end
                    if (s1 > s2)
                    begin
                        while_break1_PROC_STATE_next = 3; return;    // test_while.cpp:332:21;
                    end
                    s3_next = 2;
                    while_break1_PROC_STATE_next = 4; return;    // test_while.cpp:336:17;
                end
                while_break1_PROC_STATE_next = 0; return;    // test_while.cpp:339:13;
                // break end
            end
            s3_next = 1;
            while_break1_PROC_STATE_next = 1; return;    // test_while.cpp:321:17;
...
begin : while_break1_ff
    if ( ~arstn ) begin
        while_break1_PROC_STATE <= 0;    // test_while.cpp:315:9;
    end
    else begin
        s3 <= s3_next;
