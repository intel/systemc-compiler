...
function void test_thread1_func;
    ...
    case (test_thread1_PROC_STATE)
        0: begin
            ...
            test_thread1_PROC_STATE_next = 2; return;    // test_cthread_inner_loops.cpp:46:17;
        end
        1: begin
            out0_next = i_next;
            if (in > 10)
...
//------------------------------------------------------------------------------
// Clocked THREAD: test_thread2 (test_cthread_inner_loops.cpp:52:5) 
...
// Next-state combinational logic
always_comb begin : test_thread2_comb     // test_cthread_inner_loops.cpp:52:5
    test_thread2_func;
end
    ...
    case (test_thread2_PROC_STATE)
        0: begin
            ...
            begin
                ...
                if (in_bool)
                begin
                    test_thread2_PROC_STATE_next = 1; return;    // test_cthread_inner_loops.cpp:62:25;
                end
                test_thread2_PROC_STATE_next = 2; return;    // test_cthread_inner_loops.cpp:65:21;
            end
            test_thread2_PROC_STATE_next = 3; return;    // test_cthread_inner_loops.cpp:68:17;
        end
        1: begin
            out_next = 2;
            test_thread2_PROC_STATE_next = 2; return;    // test_cthread_inner_loops.cpp:65:21;
...
begin : test_thread2_ff
    if ( ~arstn ) begin
        out <= 0;
        test_thread2_PROC_STATE <= 0;    // test_cthread_inner_loops.cpp:55:9;
    end
    else begin
        out <= out_next;
        i0 <= i_next0;
...
//------------------------------------------------------------------------------
// Clocked THREAD: test_thread3 (test_cthread_inner_loops.cpp:75:5) 
...
// Next-state combinational logic
always_comb begin : test_thread3_comb     // test_cthread_inner_loops.cpp:75:5
    test_thread3_func;
end
    ...
    case (test_thread3_PROC_STATE)
        0: begin
            ...
            begin
                ...
                test_thread3_PROC_STATE_next = 1; return;    // test_cthread_inner_loops.cpp:85:25;
            end
            test_thread3_PROC_STATE_next = 2; return;    // test_cthread_inner_loops.cpp:87:21;
        end
        1: begin
            if (in > 10)
            begin
        ...
        2: begin
            ...
            if (in_bool)
            begin
                test_thread3_PROC_STATE_next = 3; return;    // test_cthread_inner_loops.cpp:90:21;
            end
            test_thread3_PROC_STATE_next = 4; return;    // test_cthread_inner_loops.cpp:93:17;
        end
        3: begin
            out2_next = 2;
            test_thread3_PROC_STATE_next = 4; return;    // test_cthread_inner_loops.cpp:93:17;
...
begin : test_thread3_ff
    if ( ~arstn ) begin
        out2 <= 0;
        test_thread3_PROC_STATE <= 0;    // test_cthread_inner_loops.cpp:78:9;
    end
    else begin
        out2 <= out2_next;
        j <= j_next;
