...
//------------------------------------------------------------------------------
// Clocked THREAD: concat_lhs_rhs3 (test_cthread_concat.cpp:177:5) 
...
// Next-state combinational logic
always_comb begin : concat_lhs_rhs3_comb     // test_cthread_concat.cpp:177:5
...
function void concat_lhs_rhs3_func;
    ...
    case (concat_lhs_rhs3_PROC_STATE)
        0: begin
            ...
            z = {x_next5, 3'd0};
            t0_next = z;
            concat_lhs_rhs3_PROC_STATE_next = 1; return;    // test_cthread_concat.cpp:187:13;
        end
        1: begin
...
begin : concat_lhs_rhs3_ff
    if ( ~arstn ) begin
        x5 <= 0;
        concat_lhs_rhs3_PROC_STATE <= 0;    // test_cthread_concat.cpp:180:9;
    end
    else begin
        x5 <= x_next5;
        y1 <= y_next1;
...
//------------------------------------------------------------------------------
// Clocked THREAD: concat_lhs_multi (test_cthread_concat.cpp:193:5) 
...
// Next-state combinational logic
always_comb begin : concat_lhs_multi_comb     // test_cthread_concat.cpp:193:5
...
function void concat_lhs_multi_func;
    ...
    case (concat_lhs_multi_PROC_STATE)
        0: begin
            ...
            concat_lhs_multi_PROC_STATE_next = 1; return;    // test_cthread_concat.cpp:203:13;
        end
        1: begin
            yy = tt_next;
            yy = 0;
...
begin : concat_lhs_multi_ff
    if ( ~arstn ) begin
        xx <= 0;
        zz <= 0;
        concat_lhs_multi_PROC_STATE <= 0;    // test_cthread_concat.cpp:197:9;
    end
    else begin
        xx <= xx_next;
        zz <= zz_next;
...
//------------------------------------------------------------------------------
// Clocked THREAD: concat_lhs_range (test_cthread_concat.cpp:209:5) 
...
// Next-state combinational logic
always_comb begin : concat_lhs_range_comb     // test_cthread_concat.cpp:209:5
...
//------------------------------------------------------------------------------
// Clocked THREAD: concat_lhs_cast (test_cthread_concat.cpp:224:5) 
...
// Next-state combinational logic
always_comb begin : concat_lhs_cast_comb     // test_cthread_concat.cpp:224:5
