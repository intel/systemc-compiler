...
//------------------------------------------------------------------------------
// Clocked THREAD: bug_in_array_index2 (test_cthread_array.cpp:92:5) 

// Thread-local variables
logic [1:0] master_resp_data_next[3];

// Next-state combinational logic
always_comb begin : bug_in_array_index2_comb     // test_cthread_array.cpp:92:5
...
function void bug_in_array_index2_func;
    ...
    reqOper = a;
    master_resp_data_next[reqSource] = {1'd0, 1'd0, 1'(ps), 5'd0, 1'(ps), 1'(ps), 1'(ps), 1'(ps), 1'(ps), 1'(ps), 1'(ps), 1'(ps), 1'(reqOper), 1'(reqOper)};
endfunction
...
//------------------------------------------------------------------------------
// Method process: array_of_pointers (test_cthread_array.cpp:132:5) 

always_comb 
begin : array_of_pointers     // test_cthread_array.cpp:132:5
...
//------------------------------------------------------------------------------
// Method process: chan_array_read (test_cthread_array.cpp:140:5) 

always_comb 
begin : chan_array_read     // test_cthread_array.cpp:140:5
    logic b;
    for (integer i = 0; i < DOMAIN_NUM; i++)
    begin
        b = chans[i];
...
//------------------------------------------------------------------------------
// Clocked THREAD: operProc (test_cthread_array.cpp:169:5) 
...
// Next-state combinational logic
always_comb begin : operProc_comb     // test_cthread_array.cpp:169:5
    operProc_func;
end
...
//------------------------------------------------------------------------------
// Clocked THREAD: array_of_pointers2 (test_cthread_array.cpp:190:5) 
...
// Next-state combinational logic
always_comb begin : array_of_pointers2_comb     // test_cthread_array.cpp:190:5
...
function void array_of_pointers2_func;
    ...
    case (array_of_pointers2_PROC_STATE)
        0: begin
            ...
            array_of_pointers2_PROC_STATE_next = 1; return;    // test_cthread_array.cpp:197:13;
        end
        1: begin
            n_next[0][1] = m_next[1];
...
begin : array_of_pointers2_ff
    if ( ~arstn ) begin
        ...
        i0 <= m[0];
        array_of_pointers2_PROC_STATE <= 0;    // test_cthread_array.cpp:193:9;
    end
    else begin
        i0 <= i_next;
        m <= m_next;
