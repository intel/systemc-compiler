...
//------------------------------------------------------------------------------
// Method process: chan_array_read (test_cthread_array.cpp:139:5) 

always_comb 
begin : chan_array_read     // test_cthread_array.cpp:139:5
    logic b;
    for (integer i = 0; i < DOMAIN_NUM; i++)
    begin
        b = chans[i];
...
//------------------------------------------------------------------------------
// Clocked THREAD: operProc (test_cthread_array.cpp:168:5) 
...
// Next-state combinational logic
always_comb begin : operProc_comb     // test_cthread_array.cpp:168:5
    operProc_func;
end
