...
function void local_var2_func;
    ...
    case (local_var2_PROC_STATE)
        0: begin
            ...
            if (|a)
            begin
                par_next0 = par_next0 + 1;
                local_var2_PROC_STATE_next = 2; return;    // test_cthread_var_reset.cpp:71:37;
            end
            TMP_1 = par_next0;
            // Call f2() end
            s2_next = TMP_1;
            local_var2_PROC_STATE_next = 3; return;    // test_cthread_var_reset.cpp:85:13;
        end
        1: begin
            // Call f1() begin
            if (|a)
...
function void local_rec_var2_func;
    ...
    case (local_rec_var2_PROC_STATE)
        0: begin
            ...
            local_rec_var2_PROC_STATE_next = 3; return;    // test_cthread_var_reset.cpp:124:13;
        end
        1: begin
            // Call g1() begin
            if (|a)
            ...
            TMP_2_a = par_a_next0; TMP_2_b = par_b_next0;
            // Call g2() end
            r2_a_next = TMP_2_a; r2_b_next = TMP_2_b;
            local_rec_var2_PROC_STATE_next = 3; return;    // test_cthread_var_reset.cpp:124:13;
        end
        2: begin
            // Call g2() begin
        ...
        3: begin
            ...
            TMP_3_a = par_a_next; TMP_3_b = par_b_next;
            // Call g1() end
            r2_a_next = TMP_3_a; r2_b_next = TMP_3_b;
            par_a_next0 = w_a_next; par_b_next0 = w_b_next0;
            // Call g2() begin
            if (|a)
            begin
            ...
            TMP_4_a = par_a_next0; TMP_4_b = par_b_next0;
            // Call g2() end
            r2_a_next = TMP_4_a; r2_b_next = TMP_4_b;
            local_rec_var2_PROC_STATE_next = 3; return;    // test_cthread_var_reset.cpp:124:13;
        end
    endcase
endfunction
