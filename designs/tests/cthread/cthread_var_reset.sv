...
function void local_var1_func;
    ...
    case (local_var1_PROC_STATE)
        ...
        1: begin
            s1_next = 32'(32'(32'(w_next + v_next) + wa_next[a]) + va_next[a]);
            v_next = 2;
            va_next[0] = 1; va_next[1] = 2;
            local_var1_PROC_STATE_next = 1; return;    // test_cthread_var_reset.cpp:60:13;
        end
...
function void local_rec_var1_func;
    ...
    case (local_rec_var1_PROC_STATE)
        ...
        1: begin
            r1_next = 32'(32'((v_a_next ? w_b_next : v_b_next) + wa_b_next[a]) + va_b_next[a]);
            v_a_next = |a;
            v_b_next = 42;
            va_b_next[0] = 43;
            va_b_next[1] = 44;
...
function void local_rec_var2_func;
    ...
    case (local_rec_var2_PROC_STATE)
        0: begin
            ...
            if (|a)
            begin
                par_b_next = 32'(par_b_next + 2'sd1);
            ...
            if (|a)
            begin
                par_b_next0 = 32'(par_b_next0 + 2'sd1);
