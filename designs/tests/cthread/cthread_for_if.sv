...
function void for_in_if1_func;
    ...
    case (for_in_if1_PROC_STATE)
        0: begin
            ...
            k = 2;
            t0_next = k;
            for_in_if1_PROC_STATE_next = 2; return;    // test_cthread_for_if.cpp:73:13;
        end
        1: begin
            i_next++;
            if (i_next < sleepTime_next)
...
function void for_in_if2_func;
    ...
    case (for_in_if2_PROC_STATE)
        0: begin
            ...
            for_in_if2_PROC_STATE_next = 2; return;    // test_cthread_for_if.cpp:92:13;
        end
        1: begin
            j_next--;
            if (j_next < wakeup_time)
...
function void for_in_if3_func;
    ...
    case (for_in_if3_PROC_STATE)
        0: begin
            ...
            begin
                for_in_if3_PROC_STATE_next = 1; return;    // test_cthread_for_if.cpp:107:17;
            end else begin
                i_next0 = 0;
...
function void for_in_if_bug_func;
    ...
    case (for_in_if_bug_PROC_STATE)
        0: begin
            ...
            k = 2;
            t1_next = k;
            for_in_if_bug_PROC_STATE_next = 3; return;    // test_cthread_for_if.cpp:149:13;
        end
        1: begin
            i_next1++;
            if (i_next1 < wakeupTime_next)
