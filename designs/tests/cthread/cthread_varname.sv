...
//==============================================================================
//
// Module: A (test_cthread_varname.cpp:257:5)
//
...
function void doble_varname_func_func;
    ...
    case (doble_varname_func_PROC_STATE)
        ...
        1: begin
            doble_varname_func_PROC_STATE_next = 2; return;    // test_cthread_varname.cpp:89:13;
        end
        2: begin
            // Call syncWaiting() begin
            doble_varname_func_PROC_STATE_next = 1; return;    // test_cthread_varname.cpp:76:9;
...
function void doble_varname_scope_func;
    ...
    case (doble_varname_scope_PROC_STATE)
        0: begin
            ...
            t1a_next = m2;
            doble_varname_scope_PROC_STATE_next = 2; return;    // test_cthread_varname.cpp:112:13;
        end
        1: begin
...
function void doble_varname_scope_reg_func;
    ...
    case (doble_varname_scope_reg_PROC_STATE)
        ...
        1: begin
            ...
            t2a_next = m3;
            doble_varname_scope_reg_PROC_STATE_next = 3; return;    // test_cthread_varname.cpp:135:13;
        end
        2: begin
...
function void double_reg1_func;
    ...
    case (double_reg1_PROC_STATE)
        ...
        2: begin
            varA_next = varB_next;
            double_reg1_PROC_STATE_next = 3; return;    // test_cthread_varname.cpp:182:13;
        end
        3: begin
            varB_next = 1;
            if (a)
...
function void suffix_name_func;
    ...
    case (suffix_name_PROC_STATE)
        ...
        1: begin
            ...
            suffix_name_PROC_STATE_next = 2; return;    // test_cthread_varname.cpp:228:13;
        end
        2: begin
            varB0_next = varA00_next;
            varA01_1 = 42;
