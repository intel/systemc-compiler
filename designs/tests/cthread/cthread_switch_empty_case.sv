...
function void test_switch_empty2a_func;
    ...
    case (test_switch_empty2a_PROC_STATE)
        0: begin
            ...
            endcase
            test_switch_empty2a_PROC_STATE_next = 0; return;    // test_cthread_switch_empty_case.cpp:183:13;
        end
        1: begin
            test_switch_empty2a_PROC_STATE_next = 0; return;    // test_cthread_switch_empty_case.cpp:183:13;
        end
...
function void test_thread_func;
    ...
    case (test_thread_PROC_STATE)
        0: begin
            ...
            default : begin
                test_thread_PROC_STATE_next = 2; return;    // test_cthread_switch_empty_case.cpp:509:17;
            end
            endcase
        end
        1: begin
        ...
        2: begin
            test_thread_PROC_STATE_next = 0; return;    // test_cthread_switch_empty_case.cpp:513:13;
        end
    endcase
endfunction
