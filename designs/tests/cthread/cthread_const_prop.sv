...
//==============================================================================
//
// Module: A (test_cthread_const_prop.cpp:178:5)
//
...
//------------------------------------------------------------------------------
// Clocked THREAD: pointer_compare2 (test_cthread_const_prop.cpp:68:5) 

// Thread-local variables
logic signed [31:0] t1_next;

// Next-state combinational logic
always_comb begin : pointer_compare2_comb     // test_cthread_const_prop.cpp:68:5
...
//------------------------------------------------------------------------------
// Clocked THREAD: fifoSyncProc (test_cthread_const_prop.cpp:92:5) 
...
// Next-state combinational logic
always_comb begin : fifoSyncProc_comb     // test_cthread_const_prop.cpp:92:5
    fifoSyncProc_func;
end
function void fifoSyncProc_func;
    ...
    if (a)
    begin
        if (popIndx_next == 33'(FIFO_LENGTH - 1'd1))
        begin
            popIndx_next = '0;
        end else begin
...
//------------------------------------------------------------------------------
// Clocked THREAD: priorityProc (test_cthread_const_prop.cpp:114:5) 

// Thread-local variables
logic [1:0] rr_first_indx_next;

// Next-state combinational logic
always_comb begin : priorityProc_comb     // test_cthread_const_prop.cpp:114:5
    priorityProc_func;
end
function void priorityProc_func;
    rr_first_indx_next = rr_first_indx;
    rr_first_indx_next = (rr_first_indx == 1'd1) ? 2'd2 : ((rr_first_indx == 33'(PORT_NUM - 1'd1)) ? 1'd0 : rr_first_indx + 1'd1);
endfunction
...
//------------------------------------------------------------------------------
// Method process: nested_loops (test_cthread_const_prop.cpp:143:5) 

// Process-local variables
logic signed [31:0] m;

always_comb 
begin : nested_loops     // test_cthread_const_prop.cpp:143:5
