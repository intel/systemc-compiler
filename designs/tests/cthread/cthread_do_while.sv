...
function void dowhile_with_wait1_func;
    ...
    case (dowhile_with_wait1_PROC_STATE)
        ...
        1: begin
            ...
            s1_next = 2;
            dowhile_with_wait1_PROC_STATE_next = 0; return;    // test_do_while.cpp:114:13;
        end
    endcase
endfunction
...
function void dowhile_with_wait2_func;
    ...
    case (dowhile_with_wait2_PROC_STATE)
        ...
        1: begin
            ...
            s2_next = 3;
            dowhile_with_wait2_PROC_STATE_next = 0; return;    // test_do_while.cpp:139:13;
        end
        2: begin
            if (i_next2 < 3)
            begin
...
function void dowhile_with_for_func;
    ...
    case (dowhile_with_for_PROC_STATE)
        ...
        1: begin
            ...
            s3_next = 3;
            dowhile_with_for_PROC_STATE_next = 0; return;    // test_do_while.cpp:165:13;
        end
    endcase
endfunction
...
function void dowhile_with_signal_cond_func;
    ...
    case (dowhile_with_signal_cond_PROC_STATE)
        ...
        1: begin
            ...
            s4_next = 2;
            dowhile_with_signal_cond_PROC_STATE_next = 0; return;    // test_do_while.cpp:184:13;
        end
    endcase
endfunction
...
function void dowhile_inner1_func;
    ...
    case (dowhile_inner1_PROC_STATE)
        ...
        1: begin
            ...
            dowhile_inner1_PROC_STATE_next = 0; return;    // test_do_while.cpp:212:13;
        end
    endcase
endfunction
...
function void dowhile_inner2_func;
    ...
    case (dowhile_inner2_PROC_STATE)
        ...
        2: begin
            ...
            s7_next = 0;
            dowhile_inner2_PROC_STATE_next = 0; return;    // test_do_while.cpp:239:13;
        end
    endcase
endfunction
...
function void dowhile_inner3_func;
    ...
    case (dowhile_inner3_PROC_STATE)
        ...
        1: begin
            ...
            dowhile_inner3_PROC_STATE_next = 0; return;    // test_do_while.cpp:269:13;
        end
        2: begin
            if (k_next < 10)
            begin
