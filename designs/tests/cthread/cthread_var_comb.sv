...
//------------------------------------------------------------------------------
// Clocked THREAD: comb_var_not_changed (test_cthread_var_comb.cpp:90:5) 
...
always_comb begin : comb_var_not_changed_comb     // test_cthread_var_comb.cpp:90:5
...
//------------------------------------------------------------------------------
// Clocked THREAD: comb_var_not_changed1 (test_cthread_var_comb.cpp:102:5) 
...
// Next-state combinational logic
always_comb begin : comb_var_not_changed1_comb     // test_cthread_var_comb.cpp:102:5
...
//------------------------------------------------------------------------------
// Clocked THREAD: comb_var_in_reset0 (test_cthread_var_comb.cpp:115:5) 
...
// Next-state combinational logic
always_comb begin : comb_var_in_reset0_comb     // test_cthread_var_comb.cpp:115:5
...
//------------------------------------------------------------------------------
// Clocked THREAD: comb_var_in_reset0a (test_cthread_var_comb.cpp:130:5) 
...
// Next-state combinational logic
always_comb begin : comb_var_in_reset0a_comb     // test_cthread_var_comb.cpp:130:5
...
function void comb_var_in_reset0a_func;
    ...
    case (comb_var_in_reset0a_PROC_STATE)
        0: begin
            a1 = 3;
            comb_var_in_reset0a_PROC_STATE_next = 1; return;    // test_cthread_var_comb.cpp:137:13;
        end
        1: begin
            a1 = 4;
            s1_next = a1;
            comb_var_in_reset0a_PROC_STATE_next = 0; return;    // test_cthread_var_comb.cpp:141:13;
        end
    endcase
endfunction
...
begin : comb_var_in_reset0a_ff
    if ( ~arstn ) begin
        logic [2:0] a1;
        a1 = 0;
        comb_var_in_reset0a_PROC_STATE <= 0;    // test_cthread_var_comb.cpp:133:9;
    end
    else begin
        s1 <= s1_next;
...
//------------------------------------------------------------------------------
// Clocked THREAD: comb_var_in_reset1 (test_cthread_var_comb.cpp:146:5) 
...
// Next-state combinational logic
always_comb begin : comb_var_in_reset1_comb     // test_cthread_var_comb.cpp:146:5
...
//------------------------------------------------------------------------------
// Clocked THREAD: comb_var_in_reset1a (test_cthread_var_comb.cpp:160:5) 
...
// Next-state combinational logic
always_comb begin : comb_var_in_reset1a_comb     // test_cthread_var_comb.cpp:160:5
...
function void comb_var_in_reset1a_func;
    ...
    case (comb_var_in_reset1a_PROC_STATE)
        0: begin
            b1 = 3;
            comb_var_in_reset1a_PROC_STATE_next = 1; return;    // test_cthread_var_comb.cpp:169:13;
        end
        1: begin
            b1 = 4;
            comb_var_in_reset1a_PROC_STATE_next = 0; return;    // test_cthread_var_comb.cpp:166:13;
        end
    endcase
endfunction
...
begin : comb_var_in_reset1a_ff
    if ( ~arstn ) begin
        ...
        b1 = 0;
        s2 <= b1;
        comb_var_in_reset1a_PROC_STATE <= 0;    // test_cthread_var_comb.cpp:166:13;
    end
    else begin
...
//------------------------------------------------------------------------------
// Clocked THREAD: comb_var_in_reset1b (test_cthread_var_comb.cpp:177:5) 
...
// Next-state combinational logic
always_comb begin : comb_var_in_reset1b_comb     // test_cthread_var_comb.cpp:177:5
...
function void comb_var_in_reset1b_func;
    ...
    case (comb_var_in_reset1b_PROC_STATE)
        0: begin
            b2 = 3;
            t1_next = b2;
            comb_var_in_reset1b_PROC_STATE_next = 1; return;    // test_cthread_var_comb.cpp:185:13;
        end
        1: begin
            comb_var_in_reset1b_PROC_STATE_next = 0; return;    // test_cthread_var_comb.cpp:182:13;
        end
    endcase
endfunction
...
begin : comb_var_in_reset1b_ff
    if ( ~arstn ) begin
        logic [3:0] b2;
        b2 = 0;
        comb_var_in_reset1b_PROC_STATE <= 0;    // test_cthread_var_comb.cpp:182:13;
    end
    else begin
        t1 <= t1_next;
...
//------------------------------------------------------------------------------
// Clocked THREAD: comb_var_in_reset2 (test_cthread_var_comb.cpp:191:5) 
...
// Next-state combinational logic
always_comb begin : comb_var_in_reset2_comb     // test_cthread_var_comb.cpp:191:5
...
//------------------------------------------------------------------------------
// Clocked THREAD: comb_var_in_reset2a (test_cthread_var_comb.cpp:203:5) 
...
// Next-state combinational logic
always_comb begin : comb_var_in_reset2a_comb     // test_cthread_var_comb.cpp:203:5
...
function void comb_var_in_reset2a_func;
    ...
    case (comb_var_in_reset2a_PROC_STATE)
        0: begin
            c1 = 4;
            t2_next = c1;
            comb_var_in_reset2a_PROC_STATE_next = 1; return;    // test_cthread_var_comb.cpp:211:13;
        end
        1: begin
            c1 = 3;
            comb_var_in_reset2a_PROC_STATE_next = 0; return;    // test_cthread_var_comb.cpp:207:13;
        end
    endcase
endfunction
...
begin : comb_var_in_reset2a_ff
    if ( ~arstn ) begin
        logic [4:0] c1;
        c1 = 3;
        comb_var_in_reset2a_PROC_STATE <= 0;    // test_cthread_var_comb.cpp:207:13;
    end
    else begin
        t2 <= t2_next;
...
//------------------------------------------------------------------------------
// Clocked THREAD: comb_var_in_reset3 (test_cthread_var_comb.cpp:216:5) 
...
// Next-state combinational logic
always_comb begin : comb_var_in_reset3_comb     // test_cthread_var_comb.cpp:216:5
...
//------------------------------------------------------------------------------
// Clocked THREAD: comb_var_in_reset3a (test_cthread_var_comb.cpp:228:5) 
...
// Next-state combinational logic
always_comb begin : comb_var_in_reset3a_comb     // test_cthread_var_comb.cpp:228:5
...
//------------------------------------------------------------------------------
// Clocked THREAD: loc_comb_var_in_reset (test_cthread_var_comb.cpp:239:5) 

// Next-state combinational logic
always_comb begin : loc_comb_var_in_reset_comb     // test_cthread_var_comb.cpp:239:5
...
//------------------------------------------------------------------------------
// Clocked THREAD: readonly_var_in_reset (test_cthread_var_comb.cpp:253:5) 

// Thread-local variables
logic signed [31:0] s7_next;

// Next-state combinational logic
always_comb begin : readonly_var_in_reset_comb     // test_cthread_var_comb.cpp:253:5
...
//------------------------------------------------------------------------------
// Clocked THREAD: readonly_var_in_reset2 (test_cthread_var_comb.cpp:267:5) 
...
// Next-state combinational logic
always_comb begin : readonly_var_in_reset2_comb     // test_cthread_var_comb.cpp:267:5
