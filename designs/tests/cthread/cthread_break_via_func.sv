    ...
    case (break_via_func1_PROC_STATE)
        0: begin
            ...
            begin
                ...
                // Call f() end
                k1 = 2;
                break_via_func1_PROC_STATE_next = '0; return;    // test_cthread_break_via_func.cpp:82:13;
                // break end
            end
    ...
    case (break_via_func2_PROC_STATE)
        0: begin
            ...
            begin
                ...
                // Call g() end
                break_via_func2_PROC_STATE_next = '0; return;    // test_cthread_break_via_func.cpp:98:13;
                // break end
            end
        ...
        0: begin
            ...
            begin
                ...
                begin
                    ...
                    break_via_func3_PROC_STATE_next = '0; return;    // test_cthread_break_via_func.cpp:119:13;
                    // break end
                end
...
function void break_via_func4_func;
    ...
    case (break_via_func4_PROC_STATE)
        0: begin
            ...
            // Call f1() end
            break_via_func4_PROC_STATE_next = '0; return;    // test_cthread_break_via_func.cpp:141:13;
        end
        1: begin
            // Call f1() begin
            if (b)
...
function void break_via_func5_func;
    ...
    case (break_via_func5_PROC_STATE)
        0: begin
            ...
            // Call f1() end
            break_via_func5_PROC_STATE_next = '0; return;    // test_cthread_break_via_func.cpp:166:13;
        end
        1: begin
            // Call f2() begin
            if (res_next == 1)
    ...
    case (fcall_break1_PROC_STATE)
        0: begin
            ...
            begin
                ...
                // Call f3() end
                k4_next = TMP_0;
                fcall_break1_PROC_STATE_next = '0; return;    // test_cthread_break_via_func.cpp:192:13;
                // break end
            end
