...
//------------------------------------------------------------------------------
// Clocked THREAD: comb_arr_in_reset1a (test_cthread_array_comb_reg.cpp:96:5) 
...
// Next-state combinational logic
always_comb begin : comb_arr_in_reset1a_comb     // test_cthread_array_comb_reg.cpp:96:5
...
function void comb_arr_in_reset1a_func;
    ...
    case (comb_arr_in_reset1a_PROC_STATE)
        0: begin
            comb_arr_in_reset1a_PROC_STATE_next = 1; return;    // test_cthread_array_comb_reg.cpp:102:13;
        end
        1: begin
...
begin : comb_arr_in_reset1a_ff
    if ( ~arstn ) begin
        arr2[0] <= 0;
        arr2[1] <= 1;
        comb_arr_in_reset1a_PROC_STATE <= 0;    // test_cthread_array_comb_reg.cpp:99:9;
    end
    else begin
        arr2 <= arr2_next;
        out <= out_next0;
...
//------------------------------------------------------------------------------
// Clocked THREAD: comb_arr_in_reset2 (test_cthread_array_comb_reg.cpp:108:5) 
...
// Next-state combinational logic
always_comb begin : comb_arr_in_reset2_comb     // test_cthread_array_comb_reg.cpp:108:5
...
//------------------------------------------------------------------------------
// Clocked THREAD: comb_arr_in_reset2D (test_cthread_array_comb_reg.cpp:122:5) 
...
// Next-state combinational logic
always_comb begin : comb_arr_in_reset2D_comb     // test_cthread_array_comb_reg.cpp:122:5
...
function void comb_arr_in_reset2D_func;
    ...
    case (comb_arr_in_reset2D_PROC_STATE)
        0: begin
            ...
            arr5_next[1][2] = 3;
            r3_next = arr4[1][2];
            comb_arr_in_reset2D_PROC_STATE_next = 1; return;    // test_cthread_array_comb_reg.cpp:132:13;
        end
        1: begin
...
begin : comb_arr_in_reset2D_ff
    if ( ~arstn ) begin
        ...
        arr4[0][1] = 0;
        arr5[0][1] <= 0;
        comb_arr_in_reset2D_PROC_STATE <= 0;    // test_cthread_array_comb_reg.cpp:126:9;
    end
    else begin
        arr5 <= arr5_next;
        r3 <= r3_next;
...
//------------------------------------------------------------------------------
// Clocked THREAD: comb_ptr_in_reset (test_cthread_array_comb_reg.cpp:139:5) 
...
// Next-state combinational logic
always_comb begin : comb_ptr_in_reset_comb     // test_cthread_array_comb_reg.cpp:139:5
...
function void comb_ptr_in_reset_func;
    ...
    case (comb_ptr_in_reset_PROC_STATE)
        0: begin
            ...
            q_next = 4;
            r4_next = p + 1;
            comb_ptr_in_reset_PROC_STATE_next = 1; return;    // test_cthread_array_comb_reg.cpp:148:13;
        end
        1: begin
            r4_next = q_next + 1;
            p = 3;
...
begin : comb_ptr_in_reset_ff
    if ( ~arstn ) begin
        logic [8:0] p;
        p = 0;
        comb_ptr_in_reset_PROC_STATE <= 0;    // test_cthread_array_comb_reg.cpp:142:9;
    end
    else begin
        q <= q_next;
        r4 <= r4_next;
...
//------------------------------------------------------------------------------
// Clocked THREAD: init_list1 (test_cthread_array_comb_reg.cpp:156:5) 
...
// Next-state combinational logic
always_comb begin : init_list1_comb     // test_cthread_array_comb_reg.cpp:156:5
    init_list1_func;
end
function void init_list1_func;
    ...
    case (init_list1_PROC_STATE)
        0: begin
            ...
            init_list1_PROC_STATE_next = 1; return;    // test_cthread_array_comb_reg.cpp:170:13;
        end
        1: begin
            l3[1] = 2;
            l4_next[1] = 4;
...
begin : init_list1_ff
    if ( ~arstn ) begin
        ...
        m <= 1;
        l1[0] <= 0; l1[1] <= m;
        init_list1_PROC_STATE <= 0;    // test_cthread_array_comb_reg.cpp:161:9;
    end
    else begin
        m <= m_next;
        n <= n_next;
...
//------------------------------------------------------------------------------
// Clocked THREAD: init_list2 (test_cthread_array_comb_reg.cpp:178:5) 
...
// Next-state combinational logic
always_comb begin : init_list2_comb     // test_cthread_array_comb_reg.cpp:178:5
    init_list2_func;
end
