...
begin : minst_meth_sct_i 
    ...
    begin : minst_meth     // test_mif_array_with_ports.cpp:41:5
        integer i;
        i = 32'(32'(minst_m[sct_i] + minst_A[sct_i]) + minst_B);
        minst_mout[sct_i] = 32'(minst_min[sct_i] + i);
    end
...
begin : minst_thrd_sct_i 
    ...
    function void minst_thrd_func;
        ...
        case (thrd_PROC_STATE[sct_i])
            0: begin
                i = 32'(32'(minst_n[sct_i] + minst_A[sct_i]) + minst_B);
                a_next[sct_i] = 32'(minst_in[sct_i] + i);
