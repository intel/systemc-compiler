...
function void minst_thread_member_sig_func;
    logic [3:0] k;
    integer j;
    minst_ayl_next[0][0] = minst_ayl[0][0];
    minst_y_next[0][0] = minst_y[0][0];
    j = minst_s[0][0] + minst_y_next[0][0];
    k = minst_as[0][0][1] + minst_ayl_next[0][0][2];
endfunction
...
begin : minst_thread_member_sig_ff
    if ( minst_rst[0][0] ) begin
        ...
        k = minst_as[0][0][1] + minst_ayl[0][0][2];
    end
    else begin
        minst_y[0][0] <= minst_y_next[0][0];
        minst_ayl[0][0] <= minst_ayl_next[0][0];
    end
end
...
//------------------------------------------------------------------------------
// Clocked THREAD: minst_thread_member_sig0 (test_cthread_mif_array_ptr_unkwn2.cpp:46:5) 

// Next-state combinational logic
always_comb begin : minst_thread_member_sig0_comb     // test_cthread_mif_array_ptr_unkwn2.cpp:46:5
    minst_thread_member_sig0_func;
end
function void minst_thread_member_sig0_func;
    logic [3:0] k;
    integer j;
    minst_ayl_next[0][1] = minst_ayl[0][1];
    minst_y_next[0][1] = minst_y[0][1];
    j = minst_s[0][1] + minst_y_next[0][1];
    k = minst_as[0][1][1] + minst_ayl_next[0][1][2];
endfunction
...
begin : minst_thread_member_sig0_ff
    if ( minst_rst[0][1] ) begin
        ...
        k = minst_as[0][1][1] + minst_ayl[0][1][2];
    end
    else begin
        minst_y[0][1] <= minst_y_next[0][1];
        minst_ayl[0][1] <= minst_ayl_next[0][1];
    end
end

//------------------------------------------------------------------------------
// Clocked THREAD: minst_thread_member_comb0 (test_cthread_mif_array_ptr_unkwn2.cpp:65:5) 

// Next-state combinational logic
always_comb begin : minst_thread_member_comb0_comb     // test_cthread_mif_array_ptr_unkwn2.cpp:65:5
...
//------------------------------------------------------------------------------
// Clocked THREAD: minst_thread_member_reg0 (test_cthread_mif_array_ptr_unkwn2.cpp:85:5) 

// Next-state combinational logic
always_comb begin : minst_thread_member_reg0_comb     // test_cthread_mif_array_ptr_unkwn2.cpp:85:5
