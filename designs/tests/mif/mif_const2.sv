...
begin : minst_mifProc     // test_mif_const2.cpp:34:5
    integer unsigned i;
    i = 32'(32'(minst_N + minst_A) + minst_B);
    minst_t = i;
end
...
begin : pminst_mifProc     // test_mif_const2.cpp:34:5
    integer unsigned i;
    i = 32'(32'(minst_N + minst_A) + pminst_B);
    pminst_t = i;
end
...
begin : aminst_mifProc_sct_i 
    ...
    begin : aminst_mifProc     // test_mif_const2.cpp:59:5
        ...
        integer unsigned i;
        L = 6'd56;
        i = 32'(32'(aminst_B + aminst_C[sct_i]) + L);
        aminst_t[sct_i] = i;
    end
...
//------------------------------------------------------------------------------
// Method process: topProcPtr (test_mif_const2.cpp:115:5) 

always_comb 
begin : topProcPtr     // test_mif_const2.cpp:115:5
    integer unsigned i;
    t1 = i;
end

//------------------------------------------------------------------------------
// Method process: topProcArr (test_mif_const2.cpp:125:5) 

always_comb 
begin : topProcArr     // test_mif_const2.cpp:125:5
    integer unsigned i;
    t2 = i;
end
