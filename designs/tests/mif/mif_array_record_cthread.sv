...
begin : minst_record_init_thrd_sct_i 
    ...
    function void minst_record_init_thrd_func;
        ...
        loc_a = TMP_3_a; loc_b_next[sct_i] = TMP_3_b;
        TMP_5_a = 1'd1;
        TMP_5_b[0] = 0; TMP_5_b[1] = 0; TMP_5_b[2] = 0;
        minst_mem_a[sct_i][minst_s[sct_i]] = TMP_5_a; minst_mem_b_next[sct_i][minst_s[sct_i]] = TMP_5_b;
    endfunction
    ...
    begin : minst_record_init_thrd_ff
        if ( ~minst_nrst[sct_i] ) begin
            ...
            minst_mem_a[sct_i][1] = TMP_2_a; minst_mem_b[sct_i][1] <= TMP_2_b;
        end
        else begin
