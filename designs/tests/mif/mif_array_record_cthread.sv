...
begin : minst_memRecArrThread_ff
    if ( ~minst_nrst[0] ) begin
        ...
        minst_t1[0] <= minst_t1_next[0];
    end
end

//------------------------------------------------------------------------------
// Clocked THREAD: minst_memRecThread0 (test_array_record_cthread.cpp:44:5) 

// Next-state combinational logic
always_comb begin : minst_memRecThread0_comb     // test_array_record_cthread.cpp:44:5
...
begin : minst_memRecThread0_ff
    if ( ~minst_nrst[1] ) begin
        ...
        minst_t0[1] <= minst_t0_next[1];
    end
end

//------------------------------------------------------------------------------
// Clocked THREAD: minst_memRecArrThread0 (test_array_record_cthread.cpp:66:5) 

// Next-state combinational logic
always_comb begin : minst_memRecArrThread0_comb     // test_array_record_cthread.cpp:66:5
    minst_memRecArrThread0_func;
end
function void minst_memRecArrThread0_func;
    integer i;
    minst_t1_next[1] = minst_t1[1];
