...
//------------------------------------------------------------------------------
// Clocked THREAD: minst_localRecThread (test_record_cthread.cpp:39:5) 
...
always_comb begin : minst_localRecThread_comb     // test_record_cthread.cpp:39:5
...
function void minst_localRecThread_func;
    ...
    case (localRecThread_PROC_STATE)
        0: begin
            ...
            i = t_b_next + tt_b;
            minst_t0_next = i;
            localRecThread_PROC_STATE_next = 1; return;    // test_record_cthread.cpp:51:13;
        end
        1: begin
            t_b_next = t_b_next + 1;
            tt_a = minst_s;
...
begin : minst_localRecThread_ff
    if ( ~minst_nrst ) begin
        ...
        t_a = 0;
        t_b <= 1;
        localRecThread_PROC_STATE <= 0;    // test_record_cthread.cpp:44:9;
    end
    else begin
        t_b <= t_b_next;
...
//------------------------------------------------------------------------------
// Clocked THREAD: minst_localRecArrThread (test_record_cthread.cpp:59:5) 
...
// Next-state combinational logic
always_comb begin : minst_localRecArrThread_comb     // test_record_cthread.cpp:59:5
...
//------------------------------------------------------------------------------
// Clocked THREAD: minst_memRecThread (test_record_cthread.cpp:87:5) 
...
// Next-state combinational logic
always_comb begin : minst_memRecThread_comb     // test_record_cthread.cpp:87:5
...
function void minst_memRecThread_func;
    ...
    case (memRecThread_PROC_STATE)
        0: begin
            ...
            minst_t2_next = i;
            memRecThread_PROC_STATE_next = 1; return;    // test_record_cthread.cpp:97:13;
        end
        1: begin
...
begin : minst_memRecThread_ff
    if ( ~minst_nrst ) begin
        ...
        minst_r_a = 0;
        minst_r_b <= 1;
        memRecThread_PROC_STATE <= 0;    // test_record_cthread.cpp:90:9;
    end
    else begin
...
//------------------------------------------------------------------------------
// Clocked THREAD: minst_memRecArrThread (test_record_cthread.cpp:107:5) 
...
// Next-state combinational logic
always_comb begin : minst_memRecArrThread_comb     // test_record_cthread.cpp:107:5
...
//------------------------------------------------------------------------------
// Clocked THREAD: ninst_localRecThread (test_record_cthread.cpp:39:5) 
...
// Next-state combinational logic
always_comb begin : ninst_localRecThread_comb     // test_record_cthread.cpp:39:5
...
function void ninst_localRecThread_func;
    ...
    case (localRecThread_PROC_STATE0)
        0: begin
            ...
            i = t_b_next0 + tt_b;
            ninst_t0_next = i;
            localRecThread_PROC_STATE_next0 = 1; return;    // test_record_cthread.cpp:51:13;
        end
        1: begin
...
begin : ninst_localRecThread_ff
    if ( ~ninst_nrst ) begin
        ...
        t_a = 0;
        t_b0 <= 1;
        localRecThread_PROC_STATE0 <= 0;    // test_record_cthread.cpp:44:9;
    end
    else begin
        t_b0 <= t_b_next0;
...
//------------------------------------------------------------------------------
// Clocked THREAD: ninst_localRecArrThread (test_record_cthread.cpp:59:5) 
...
// Next-state combinational logic
always_comb begin : ninst_localRecArrThread_comb     // test_record_cthread.cpp:59:5
...
//------------------------------------------------------------------------------
// Clocked THREAD: ninst_memRecThread (test_record_cthread.cpp:87:5) 
...
// Next-state combinational logic
always_comb begin : ninst_memRecThread_comb     // test_record_cthread.cpp:87:5
...
function void ninst_memRecThread_func;
    ...
    case (memRecThread_PROC_STATE0)
        0: begin
            ...
            ninst_t2_next = i;
            memRecThread_PROC_STATE_next0 = 1; return;    // test_record_cthread.cpp:97:13;
        end
        1: begin
...
begin : ninst_memRecThread_ff
    if ( ~ninst_nrst ) begin
        ...
        ninst_r_a = 0;
        ninst_r_b <= 1;
        memRecThread_PROC_STATE0 <= 0;    // test_record_cthread.cpp:90:9;
    end
    else begin
...
//------------------------------------------------------------------------------
// Clocked THREAD: ninst_memRecArrThread (test_record_cthread.cpp:107:5) 
...
// Next-state combinational logic
always_comb begin : ninst_memRecArrThread_comb     // test_record_cthread.cpp:107:5
