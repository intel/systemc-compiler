...
function void minst_record_init_thrd_func;
    ...
    TMP_3_b = '0;
    loc_a = TMP_3_a; loc_b_next = TMP_3_b;
    TMP_5_b = '0;
    minst_mem_a[minst_s] = TMP_5_a; minst_mem_b_next[minst_s] = TMP_5_b;
endfunction
...
begin : minst_record_init_thrd_ff
    if ( ~minst_nrst ) begin
        ...
        TMP_2_b = '0;
        minst_mem_a[1] = TMP_2_a; minst_mem_b[1] <= TMP_2_b;
    end
    else begin
...
function void ninst_record_init_thrd_func;
    ...
    TMP_3_b = '0;
    loc_a = TMP_3_a; loc_b_next0 = TMP_3_b;
    TMP_5_b = '0;
    ninst_mem_a[ninst_s] = TMP_5_a; ninst_mem_b_next[ninst_s] = TMP_5_b;
endfunction
...
begin : ninst_record_init_thrd_ff
    if ( ~ninst_nrst ) begin
        ...
        TMP_2_b = '0;
        ninst_mem_a[1] = TMP_2_a; ninst_mem_b[1] <= TMP_2_b;
    end
    else begin
