...
begin : mif_b_threadB_sct_i 
    ...
    function void mif_b_threadB_func;
        ...
        l = 32'(32'(32'(mif_b_mif_aa_a[sct_i] + mif_b_mif_aa_m_next[sct_i]) + mif_b_mif_a_a[sct_i][0]) + mif_b_mif_a_m_next[sct_i][0]);
...
function void mainThread_func;
    ...
    l = 32'(32'(32'(mif_b_mif_aa_b[0] + mif_b_mif_aa_b[1]) + mif_b_mif_a_b[1][0]) + mif_b_mif_a_n_next[0][1]);
