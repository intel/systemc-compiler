...
begin : mif_b_threadB_sct_i 
    ...
    function void mif_b_threadB_func;
        ...
        mif_b_mif_aa_a_next[sct_i] = 4;
        mif_b_mif_aa_m_next[sct_i] = 4;
        mif_b_mif_a_a_next[sct_i][mif_b_c[sct_i]] = 4;
        mif_b_mif_a_m_next[sct_i][mif_b_c[sct_i]] = 4;
    endfunction
    ...
    begin : mif_b_threadB_ff
        if ( ~mif_b_rstn[sct_i] ) begin
            mif_b_mif_aa_a[sct_i] <= 3;
            mif_b_mif_aa_m[sct_i] <= 3;
            mif_b_mif_a_a[sct_i][0] <= 3;
            mif_b_mif_a_m[sct_i][0] <= 3;
        end
        else begin
