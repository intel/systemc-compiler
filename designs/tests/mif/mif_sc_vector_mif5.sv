...
begin : mif_aa_threadProc_sct_i 
    ...
    function void mif_aa_threadProc_func;
        ...
        mif_b_mif_aa_resp_next[sct_i] = 32'(mif_b_mif_aa_resp[sct_i] + 1'd1);
    endfunction
...
begin : mif_a_threadProc_sct_j 
    ...
    function void mif_a_threadProc_func;
        ...
        mif_b_mif_a_resp_next[sct_i][sct_j] = 32'(mif_b_mif_a_resp[sct_i][sct_j] + 1'd1);
    endfunction
...
begin : mif_b_methProcB_sct_i 
    ...
    begin : mif_b_methProcB     // test_sc_vector_mif5.cpp:82:5
        ...
        mif_b_result[sct_i] = 32'(mif_b_mif_aa_resp[sct_i] + mif_b_mif_a_resp[sct_i][0]);
        j = 32'(mif_b_mif_aa_resp[sct_i] + mif_b_mif_a_resp[sct_i][0]);
        if (mif_b_req[sct_i])
        begin
            // Call getData() begin
...
begin : mainMeth     // test_sc_vector_mif5.cpp:129:6
    ...
    integer unsigned TMP_1;
    // Call getRes() begin
    TMP_0 = 32'(32'(32'(mif_b_result[s] + mif_b_mif_aa_resp[s]) + mif_b_mif_a_mm[s][0]) + mif_b_mif_a_resp[s][1]);
    // Call getRes() end
    l = TMP_0;
    // Call getData() begin
