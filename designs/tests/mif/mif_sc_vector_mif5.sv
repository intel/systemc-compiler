...
// Thread-local variables
logic [31:0] mif_b_mif_a_mm[2][3];
logic [31:0] mif_b_mif_a_mm_next[2][3];
...
function void mainThread_func;
    integer unsigned l;
    integer unsigned TMP_0;
    mif_b_mif_a_mm_next = mif_b_mif_a_mm;
    l = mif_b_mif_aa_resp[s];
    l = mif_b_mif_a_resp[s][0];
    l = mif_b_mif_a_resp[s + 1][s + 2];
    // Call getRes() begin
    TMP_0 = mif_b_result[s] + mif_b_mif_aa_resp[s] + mif_b_mif_a_mm_next[s][0] + mif_b_mif_a_resp[s][1];
    // Call getRes() end
    l = TMP_0;
endfunction
...
begin : mainThread_ff
    if ( ~rstn ) begin
        ...
        mif_b_mif_a_mm <= mif_b_mif_a_mm_next;
    end
end
