...
begin : mif_aa_threadProc_sct_i 
    ...
    function void mif_aa_threadProc_func;
        ...
        mif_b_mif_aa_resp_next[sct_i] = mif_b_mif_aa_resp[sct_i] + 1;
    endfunction
...
begin : mif_a_threadProc_sct_j 
    ...
    function void mif_a_threadProc_func;
        ...
        mif_b_mif_a_resp_next[sct_i][sct_j] = mif_b_mif_a_resp[sct_i][sct_j] + 1;
    endfunction
...
begin : mif_b_methProcB_sct_i 
    ...
    begin : mif_b_methProcB     // test_sc_vector_mif5.cpp:82:5
        ...
        begin
            ...
            // Call getData() end
            mif_b_result[sct_i] = TMP_0 % 3;
            // Call getData() begin
            TMP_1 = mif_b_mif_a_resp[sct_i][j];
            // Call getData() end
            mif_b_result[sct_i] = TMP_1 % 3;
        end
    end
