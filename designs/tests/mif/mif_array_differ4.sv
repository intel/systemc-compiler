...
localparam logic [31:0] a1_mif1_AR[2] = '{ 42, 43 };
localparam logic [31:0] a1_mif2_M = 43;
localparam logic [31:0] a1_mif2_AR[2] = '{ 43, 44 };
localparam logic [31:0] a1_mif_arr_M[2] = '{ 42, 43 };
localparam logic [31:0] a1_mif_arr_AR[2][2] = '{ '{ 42, 43 }, '{ 43, 44 } };
...
localparam logic [31:0] a2_mif1_AR[2] = '{ 43, 44 };
localparam logic [31:0] a2_mif2_M = 44;
localparam logic [31:0] a2_mif2_AR[2] = '{ 44, 45 };
localparam logic [31:0] a2_mif_arr_M[2] = '{ 43, 44 };
localparam logic [31:0] a2_mif_arr_AR[2][2] = '{ '{ 43, 44 }, '{ 44, 45 } };
...
localparam logic [31:0] ar_mif1_M[2] = '{ 0, 1 };
localparam logic [31:0] ar_mif1_AR[2][2] = '{ '{ 0, 1 }, '{ 1, 2 } };
localparam logic [31:0] ar_mif2_M[2] = '{ 1, 2 };
localparam logic [31:0] ar_mif2_AR[2][2] = '{ '{ 1, 2 }, '{ 2, 3 } };
localparam logic [31:0] ar_mif_arr_M[2][2] = '{ '{ 0, 1 }, '{ 1, 2 } };
localparam logic [31:0] ar_mif_arr_AR[2][2][2] = '{ '{ '{ 0, 1 }, '{ 1, 2 } }, '{ '{ 1, 2 }, '{ 2, 3 } } };
...
begin : mif_arr_mif_proc_sct_i 
    ...
    begin : mif_arr_mif_proc     // test_mif_array_differ.cpp:37:5
        ...
        if (a1_mif_arr_M[sct_i] == 6'd42)
        begin
            a1_mif_arr_tt[sct_i] = a1_mif_arr_AR[sct_i][1];
        end
        if (a1_mif_arr_AR[sct_i][0] == 2'd2)
        begin
...
begin : mif_arr_mif_proc0_sct_i 
    ...
    begin : mif_arr_mif_proc0     // test_mif_array_differ.cpp:37:5
        ...
        if (a2_mif_arr_M[sct_i] == 6'd42)
        begin
            a2_mif_arr_tt[sct_i] = a2_mif_arr_AR[sct_i][1];
        end
        if (a2_mif_arr_AR[sct_i][0] == 2'd2)
        begin
...
begin : mif1_mif_proc1_sct_i 
    ...
    begin : mif1_mif_proc1     // test_mif_array_differ.cpp:37:5
        ...
        if (ar_mif1_M[sct_i] == 6'd42)
        begin
            ar_mif1_tt[sct_i] = ar_mif1_AR[sct_i][1];
        end
        if (ar_mif1_AR[sct_i][0] == 2'd2)
        begin
            ar_mif1_tt[sct_i] = '0;
        end
    end
...
begin : mif2_mif_proc1_sct_i 
    ...
    begin : mif2_mif_proc1     // test_mif_array_differ.cpp:37:5
        ...
        if (ar_mif2_M[sct_i] == 6'd42)
        begin
            ar_mif2_tt[sct_i] = ar_mif2_AR[sct_i][1];
        end
        if (ar_mif2_AR[sct_i][0] == 2'd2)
        begin
            ar_mif2_tt[sct_i] = '0;
        end
    end
...
begin : mif_arr_mif_proc1_sct_j 
    ...
    begin : mif_arr_mif_proc1     // test_mif_array_differ.cpp:37:5
        ...
        if (ar_mif_arr_M[sct_i][sct_j] == 6'd42)
        begin
            ar_mif_arr_tt[sct_i][sct_j] = ar_mif_arr_AR[sct_i][sct_j][1];
        end
        if (ar_mif_arr_AR[sct_i][sct_j][0] == 2'd2)
        begin
...
begin : ar_proc1_sct_i 
    ...
    begin : ar_proc1     // test_mif_array_differ.cpp:97:5
        ...
        l = (ar_C[sct_i] == 1'd1) ? 6'd42 : 32'(ar_W[sct_i] + 1'd1);
        l = ar_Z[sct_i] ? 1 : 2;
        ar_t0[sct_i] = l;
    end
