...
begin : minst_mifMeth_sct_i 
    ...
    begin : minst_mifMeth     // test_mif_array_sens.cpp:47:5
        ...
        l = minst_B[sct_i];
        l = minst_C[sct_i];
        l = 32'(minst_AR[1] + minst_BR[sct_i][1]);
        l = 32'(minst_AR[minst_r[sct_i]] + minst_BR[sct_i][minst_r[sct_i]]);
        l = minst_B[sct_i];
        l = 32'(minst_BR[sct_i][0] + minst_br[sct_i][0]);
        minst_t0[sct_i] = l;
    end
...
begin : top_method4     // test_mif_array_sens.cpp:158:5
    ...
    lu = minst_BR[i][0];
    lu = 32'(L[1] + BA[2]);
    lu = 32'(32'(SA[1] + SB[2]) + COUPLED_BLOCK_DOMAIN[0]);
    t0 = lu;
