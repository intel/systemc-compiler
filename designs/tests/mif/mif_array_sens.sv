...
//------------------------------------------------------------------------------
// Method process: minst_mifMeth (test_mif_array_sens.cpp:46:5) 

// Process-local variables
logic [31:0] minst_br[3][2];

always_comb 
begin : minst_mifMeth     // test_mif_array_sens.cpp:46:5
    integer unsigned l;
    minst_s1[0] = 0;
    l = minst_A;
    l = minst_B[0];
...
//------------------------------------------------------------------------------
// Method process: minst_mifMeth0 (test_mif_array_sens.cpp:46:5) 

always_comb 
begin : minst_mifMeth0     // test_mif_array_sens.cpp:46:5
    integer unsigned l;
    minst_s1[1] = 0;
...
//------------------------------------------------------------------------------
// Method process: minst_mifMeth1 (test_mif_array_sens.cpp:46:5) 

always_comb 
begin : minst_mifMeth1     // test_mif_array_sens.cpp:46:5
    integer unsigned l;
    minst_s1[2] = 0;
    l = minst_A;
    l = minst_B[2];
...
//------------------------------------------------------------------------------
// Method process: top_method1 (test_mif_array_sens.cpp:115:5) 

always_comb 
begin : top_method1     // test_mif_array_sens.cpp:115:5
    integer unsigned i;
    i = t;
    // Call f1() begin
    minst_s1[i] = 1;
...
//------------------------------------------------------------------------------
// Method process: top_method2 (test_mif_array_sens.cpp:120:5) 

always_comb 
begin : top_method2     // test_mif_array_sens.cpp:120:5
    integer unsigned i;
    i = t;
    // Call f2() begin
    minst_s2[2] = 1;
...
//------------------------------------------------------------------------------
// Method process: top_method3 (test_mif_array_sens.cpp:133:5) 

always_comb 
begin : top_method3     // test_mif_array_sens.cpp:133:5
    integer unsigned i;
    i = t;
    // Call f3() begin
    if (minst_C[i] == 12)
...
//------------------------------------------------------------------------------
// Method process: top_method4 (test_mif_array_sens.cpp:146:5) 

// Process-local variables
logic [31:0] minst_br[3][2];

always_comb 
begin : top_method4     // test_mif_array_sens.cpp:146:5
    integer unsigned i;
    integer unsigned lu;
    logic signed [7:0] bi;
    i = t;
