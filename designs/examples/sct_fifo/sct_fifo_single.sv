...
//------------------------------------------------------------------------------
// Method process: fifo_asyncProc (sct_fifo.h:274:5) 

always_comb 
begin : fifo_asyncProc     // sct_fifo.h:274:5
    logic outValid;
    logic readyPush;
    logic popIndx;
    logic notEmpty;
...
//------------------------------------------------------------------------------
// Clocked THREAD: fifo_syncProc (sct_fifo.h:327:5) 
...
// Next-state combinational logic
always_comb begin : fifo_syncProc_comb     // sct_fifo.h:327:5
    fifo_syncProc_func;
end
