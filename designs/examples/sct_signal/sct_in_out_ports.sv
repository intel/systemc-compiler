...
begin : fifo_asyncProc     // sct_fifo.h:328:5
    ...
    notFull = fifo_element_num_d != 3'd4;
    push = fifo_put_req;
    pop = fifo_get_req;
    outValid = notEmpty;
    readyPush = notFull;
...
function void fifo_syncProc_func;
    ...
    if (pop)
    begin
        fifo_pop_indx_next = (fifo_pop_indx == 4'(3'd4 - 1'd1)) ? 1'd0 : fifo_pop_indx + 1'd1;
    end
    if (push)
    begin
        fifo_buffer_next[fifo_push_indx] = fifo_data_in;
        fifo_push_indx_next = (fifo_push_indx == 4'(3'd4 - 1'd1)) ? 1'd0 : fifo_push_indx + 1'd1;
    end
