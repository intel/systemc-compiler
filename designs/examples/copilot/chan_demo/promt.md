...
Promt to create synthesizable SystemC design with SingleSource channels

/systemc-tools create a project `copilot_chan_demo` to demonstrate how SingleSource channels work.
...
Add tracing of the channels with sc_trace.