...
/systemc-tools create APB subordinate port module in #file:apb_port.h and testbench in #file:sc_main.cpp. The APB port has the following external ports:
...
PSLVERR - indicates a transfer failure. APB peripherals are not required to support the PSLVERR pin. 
...
Store traces of all #sym:apb_port inputs/outputs with sc_trace.