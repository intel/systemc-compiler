...
function void init_thread_func;
    ...
    case (init_thread_PROC_STATE)
        ...
        2: begin
            ...
            if (!TMP_1)
            begin
                init_thread_PROC_STATE_next = 2; return;    // method_test.h:115:33;
            end
        ...
        8: begin
            ...
            if (!TMP_4)
            begin
                init_thread_PROC_STATE_next = 8; return;    // method_test.h:124:33;
            end
        ...
        10: begin
            ...
            if (!TMP_5)
            begin
                init_thread_PROC_STATE_next = 10; return;    // method_test.h:126:33;
            end
        ...
        12: begin
            ...
            if (!TMP_6)
            begin
                init_thread_PROC_STATE_next = 12; return;    // method_test.h:129:30;
            end
        ...
        14: begin
            ...
            if (!TMP_7)
            begin
                init_thread_PROC_STATE_next = 14; return;    // method_test.h:131:30;
            end
        ...
        16: begin
            ...
            if (!TMP_8)
            begin
                init_thread_PROC_STATE_next = 16; return;    // method_test.h:133:30;
            end
        ...
        18: begin
            ...
            if (!TMP_9)
            begin
                init_thread_PROC_STATE_next = 18; return;    // method_test.h:135:33;
            end
        ...
        20: begin
            ...
            if (!TMP_10)
            begin
                init_thread_PROC_STATE_next = 20; return;    // method_test.h:137:33;
            end
        ...
        22: begin
            ...
            if (!TMP_11)
            begin
                init_thread_PROC_STATE_next = 22; return;    // method_test.h:139:33;
            end
        ...
        25: begin
            init_thread_PROC_STATE_next = 25; return;    // method_test.h:146:13;
        end
    endcase
endfunction
