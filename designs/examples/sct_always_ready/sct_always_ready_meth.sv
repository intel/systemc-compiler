...
//------------------------------------------------------------------------------
// Clocked THREAD: tresp_always_ready_thread (sct_target.h:301:5) 
...
// Next-state combinational logic
always_comb begin : tresp_always_ready_thread_comb     // sct_target.h:301:5
...
//------------------------------------------------------------------------------
// Method process: tresp_core_ready_meth (sct_target.h:321:5) 
...
function void init_thread_func;
    ...
    case (init_thread_PROC_STATE)
        ...
        1: begin
            ...
            if (!tresp_core_req_d)
            begin
                init_thread_PROC_STATE_next = 1; return;    // sct_target.h:191:45;
            end
            tresp_get_req_next = !tresp_get_req;
...
//------------------------------------------------------------------------------
// Clocked THREAD: run_always_ready_thread (sct_target.h:301:5) 
// Empty process, no code generated 

//------------------------------------------------------------------------------
// Method process: run_core_ready_meth (sct_target.h:321:5) 
