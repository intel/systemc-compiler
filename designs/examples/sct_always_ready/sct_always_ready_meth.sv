...
//------------------------------------------------------------------------------
// Clocked THREAD: trun_core_thread (sct_initiator.h:269:5) 

// Thread-local variables
logic trun_put_req_d_next;

// Next-state combinational logic
always_comb begin : trun_core_thread_comb     // sct_initiator.h:269:5
...
//------------------------------------------------------------------------------
// Clocked THREAD: tresp_always_ready_thread (sct_target.h:288:5) 
...
// Next-state combinational logic
always_comb begin : tresp_always_ready_thread_comb     // sct_target.h:288:5
...
//------------------------------------------------------------------------------
// Method process: tresp_core_ready_meth (sct_target.h:308:5) 

assign tresp_core_ready = 1;

//------------------------------------------------------------------------------
// Method process: tresp_core_data_mux (sct_target.h:218:5) 

always_comb 
begin : tresp_core_data_mux     // sct_target.h:218:5
...
function void init_thread_func;
    ...
    case (init_thread_PROC_STATE)
        ...
        1: begin
            ...
            if (!tresp_core_req_d)
            begin
                init_thread_PROC_STATE_next = 1; return;    // sct_target.h:179:41;
            end
            tresp_get_req_next = !tresp_get_req;
