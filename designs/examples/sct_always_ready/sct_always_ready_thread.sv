...
//------------------------------------------------------------------------------
// Clocked THREAD: resp_always_ready_thread (sct_target.h:301:5) 

// Thread-local variables
logic resp_get_req_d_next;

// Next-state combinational logic
always_comb begin : resp_always_ready_thread_comb     // sct_target.h:301:5
...
//------------------------------------------------------------------------------
// Method process: resp_core_ready_meth (sct_target.h:321:5) 
...
// Next-state combinational logic
always_comb begin : run_always_ready_thread_comb     // sct_target.h:301:5
...
function void inThreadProc_func;
    ...
    case (inThreadProc_PROC_STATE)
        0: begin
            ...
            if (!run_core_req)
            begin
                inThreadProc_PROC_STATE_next = 1; return;    // sct_target.h:193:43;
            end
            run_get_req_next = !run_get_req;
            TMP_0 = run_core_data;
            // Call b_get() end
