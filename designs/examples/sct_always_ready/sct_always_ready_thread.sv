...
//------------------------------------------------------------------------------
// Clocked THREAD: resp_always_ready_thread (sct_target.h:273:5) 
// Empty process, no code generated 

//------------------------------------------------------------------------------
// Method process: resp_core_ready_meth (sct_target.h:297:5) 

assign resp_core_ready = 1'd1;
...
function void init_thread_func;
    ...
    case (init_thread_PROC_STATE)
        ...
        1: begin
            ...
            if (!TMP_1)
            begin
                init_thread_PROC_STATE_next = 1; return;    // thread_test.h:112:33;
            end
...
function void inThreadProc_func;
    ...
    case (inThreadProc_PROC_STATE)
        0: begin
            ...
            if (!run_core_req)
            begin
                inThreadProc_PROC_STATE_next = '0; return;    // sct_target.h:178:39;
            end
            run_get_req_next = !run_get_req;
            ...
            // Call put() end
            inThreadProc_PROC_STATE_next = '0; return;    // thread_test.h:50:13;
        end
    endcase
endfunction
