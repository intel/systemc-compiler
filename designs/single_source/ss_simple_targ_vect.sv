...
begin : run_core_data_mux     // sct_target.h:218:5
    if (run_reg_full[0])
    begin
        run_core_data_out[0] = run_core_data_d[0];
    end else begin
        run_core_data_out[0] = run_core_data[0];
    end
end

//------------------------------------------------------------------------------
// Method process: run_ready_control0 (sct_target.h:243:5) 

always_comb 
begin : run_ready_control0     // sct_target.h:243:5
    logic A;
    A = run_get_req_d[1];
...
//------------------------------------------------------------------------------
// Method process: run_full_control0 (sct_target.h:248:5) 

always_comb 
begin : run_full_control0     // sct_target.h:248:5
    logic A;
    A = run_get_req_d[1];
    if (A)
    begin
...
//------------------------------------------------------------------------------
// Clocked THREAD: run_core_thread0 (sct_target.h:260:5) 

// Next-state combinational logic
always_comb begin : run_core_thread0_comb     // sct_target.h:260:5
...
//------------------------------------------------------------------------------
// Method process: run_put_to_fifo0 (sct_target.h:229:5) 
// Empty process, no code generated 

//------------------------------------------------------------------------------
// Method process: run_core_data_mux0 (sct_target.h:218:5) 

always_comb 
begin : run_core_data_mux0     // sct_target.h:218:5
    if (run_reg_full[1])
    begin
        run_core_data_out[1] = run_core_data_d[1];
    end else begin
        run_core_data_out[1] = run_core_data[1];
    end
end

//------------------------------------------------------------------------------
// Method process: run_ready_control1 (sct_target.h:243:5) 

always_comb 
begin : run_ready_control1     // sct_target.h:243:5
    logic A;
    A = run_get_req_d[2];
...
//------------------------------------------------------------------------------
// Method process: run_full_control1 (sct_target.h:248:5) 

always_comb 
begin : run_full_control1     // sct_target.h:248:5
    logic A;
    A = run_get_req_d[2];
    if (A)
    begin
...
//------------------------------------------------------------------------------
// Clocked THREAD: run_core_thread1 (sct_target.h:260:5) 

// Next-state combinational logic
always_comb begin : run_core_thread1_comb     // sct_target.h:260:5
...
//------------------------------------------------------------------------------
// Method process: run_put_to_fifo1 (sct_target.h:229:5) 
// Empty process, no code generated 

//------------------------------------------------------------------------------
// Method process: run_core_data_mux1 (sct_target.h:218:5) 

always_comb 
begin : run_core_data_mux1     // sct_target.h:218:5
    if (run_reg_full[2])
    begin
        run_core_data_out[2] = run_core_data_d[2];
    end else begin
        run_core_data_out[2] = run_core_data[2];
    end
end

//------------------------------------------------------------------------------
// Method process: run_ready_control2 (sct_target.h:243:5) 

always_comb 
begin : run_ready_control2     // sct_target.h:243:5
    logic A;
    A = run_get_req_d[3];
...
//------------------------------------------------------------------------------
// Method process: run_full_control2 (sct_target.h:248:5) 

always_comb 
begin : run_full_control2     // sct_target.h:248:5
    logic A;
    A = run_get_req_d[3];
    if (A)
    begin
...
//------------------------------------------------------------------------------
// Clocked THREAD: run_core_thread2 (sct_target.h:260:5) 

// Next-state combinational logic
always_comb begin : run_core_thread2_comb     // sct_target.h:260:5
...
//------------------------------------------------------------------------------
// Method process: run_put_to_fifo2 (sct_target.h:229:5) 
// Empty process, no code generated 

//------------------------------------------------------------------------------
// Method process: run_core_data_mux2 (sct_target.h:218:5) 

always_comb 
begin : run_core_data_mux2     // sct_target.h:218:5
    if (run_reg_full[3])
    begin
        run_core_data_out[3] = run_core_data_d[3];
    end else begin
        run_core_data_out[3] = run_core_data[3];
    end
end

//------------------------------------------------------------------------------
// Method process: run_ready_control3 (sct_target.h:243:5) 

always_comb 
begin : run_ready_control3     // sct_target.h:243:5
    logic A;
    A = run_get_req_d[4];
...
//------------------------------------------------------------------------------
// Method process: run_full_control3 (sct_target.h:248:5) 

always_comb 
begin : run_full_control3     // sct_target.h:248:5
    logic A;
    A = run_get_req_d[4];
    if (A)
    begin
...
//------------------------------------------------------------------------------
// Clocked THREAD: run_core_thread3 (sct_target.h:260:5) 

// Next-state combinational logic
always_comb begin : run_core_thread3_comb     // sct_target.h:260:5
...
//------------------------------------------------------------------------------
// Method process: run_put_to_fifo3 (sct_target.h:229:5) 
// Empty process, no code generated 

//------------------------------------------------------------------------------
// Method process: run_core_data_mux3 (sct_target.h:218:5) 

always_comb 
begin : run_core_data_mux3     // sct_target.h:218:5
    if (run_reg_full[4])
    begin
        run_core_data_out[4] = run_core_data_d[4];
    end else begin
        run_core_data_out[4] = run_core_data[4];
    end
end

//------------------------------------------------------------------------------
// Method process: run_ready_control4 (sct_target.h:243:5) 

always_comb 
begin : run_ready_control4     // sct_target.h:243:5
    logic A;
    A = run_get_req_d[5];
...
//------------------------------------------------------------------------------
// Method process: run_full_control4 (sct_target.h:248:5) 

always_comb 
begin : run_full_control4     // sct_target.h:248:5
    logic A;
    A = run_get_req_d[5];
    if (A)
    begin
...
//------------------------------------------------------------------------------
// Clocked THREAD: run_core_thread4 (sct_target.h:260:5) 

// Next-state combinational logic
always_comb begin : run_core_thread4_comb     // sct_target.h:260:5
...
//------------------------------------------------------------------------------
// Method process: run_put_to_fifo4 (sct_target.h:229:5) 
// Empty process, no code generated 

//------------------------------------------------------------------------------
// Method process: run_core_data_mux4 (sct_target.h:218:5) 

always_comb 
begin : run_core_data_mux4     // sct_target.h:218:5
    if (run_reg_full[5])
    begin
        run_core_data_out[5] = run_core_data_d[5];
    end else begin
        run_core_data_out[5] = run_core_data[5];
    end
end

//------------------------------------------------------------------------------
// Method process: run_ready_control5 (sct_target.h:243:5) 

always_comb 
begin : run_ready_control5     // sct_target.h:243:5
    logic A;
    A = run_get_req_d[6];
...
//------------------------------------------------------------------------------
// Method process: run_full_control5 (sct_target.h:248:5) 

always_comb 
begin : run_full_control5     // sct_target.h:248:5
    logic A;
    A = run_get_req_d[6];
    if (A)
    begin
...
//------------------------------------------------------------------------------
// Clocked THREAD: run_core_thread5 (sct_target.h:260:5) 

// Next-state combinational logic
always_comb begin : run_core_thread5_comb     // sct_target.h:260:5
...
//------------------------------------------------------------------------------
// Method process: run_put_to_fifo5 (sct_target.h:229:5) 
// Empty process, no code generated 

//------------------------------------------------------------------------------
// Method process: run_core_data_mux5 (sct_target.h:218:5) 

always_comb 
begin : run_core_data_mux5     // sct_target.h:218:5
    if (run_reg_full[6])
    begin
        run_core_data_out[6] = run_core_data_d[6];
    end else begin
        run_core_data_out[6] = run_core_data[6];
    end
end

//------------------------------------------------------------------------------
// Method process: run_ready_control6 (sct_target.h:243:5) 

always_comb 
begin : run_ready_control6     // sct_target.h:243:5
    logic A;
    A = run_get_req_d[7];
...
//------------------------------------------------------------------------------
// Method process: run_full_control6 (sct_target.h:248:5) 

always_comb 
begin : run_full_control6     // sct_target.h:248:5
    logic A;
    A = run_get_req_d[7];
    if (A)
    begin
...
//------------------------------------------------------------------------------
// Clocked THREAD: run_core_thread6 (sct_target.h:260:5) 

// Next-state combinational logic
always_comb begin : run_core_thread6_comb     // sct_target.h:260:5
...
//------------------------------------------------------------------------------
// Method process: run_put_to_fifo6 (sct_target.h:229:5) 
// Empty process, no code generated 

//------------------------------------------------------------------------------
// Method process: run_core_data_mux6 (sct_target.h:218:5) 

always_comb 
begin : run_core_data_mux6     // sct_target.h:218:5
    if (run_reg_full[7])
    begin
        run_core_data_out[7] = run_core_data_d[7];
    end else begin
        run_core_data_out[7] = run_core_data[7];
    end
end

//------------------------------------------------------------------------------
// Method process: run_ready_control7 (sct_target.h:243:5) 

always_comb 
begin : run_ready_control7     // sct_target.h:243:5
    logic A;
    A = run_get_req_d[8];
...
//------------------------------------------------------------------------------
// Method process: run_full_control7 (sct_target.h:248:5) 

always_comb 
begin : run_full_control7     // sct_target.h:248:5
    logic A;
    A = run_get_req_d[8];
    if (A)
    begin
...
//------------------------------------------------------------------------------
// Clocked THREAD: run_core_thread7 (sct_target.h:260:5) 

// Next-state combinational logic
always_comb begin : run_core_thread7_comb     // sct_target.h:260:5
...
//------------------------------------------------------------------------------
// Method process: run_put_to_fifo7 (sct_target.h:229:5) 
// Empty process, no code generated 

//------------------------------------------------------------------------------
// Method process: run_core_data_mux7 (sct_target.h:218:5) 

always_comb 
begin : run_core_data_mux7     // sct_target.h:218:5
    if (run_reg_full[8])
    begin
        run_core_data_out[8] = run_core_data_d[8];
    end else begin
        run_core_data_out[8] = run_core_data[8];
    end
end

//------------------------------------------------------------------------------
// Method process: run_ready_control8 (sct_target.h:243:5) 

always_comb 
begin : run_ready_control8     // sct_target.h:243:5
    logic A;
    A = run_get_req_d[9];
...
//------------------------------------------------------------------------------
// Method process: run_full_control8 (sct_target.h:248:5) 

always_comb 
begin : run_full_control8     // sct_target.h:248:5
    logic A;
    A = run_get_req_d[9];
    if (A)
    begin
...
//------------------------------------------------------------------------------
// Clocked THREAD: run_core_thread8 (sct_target.h:260:5) 

// Next-state combinational logic
always_comb begin : run_core_thread8_comb     // sct_target.h:260:5
...
//------------------------------------------------------------------------------
// Method process: run_put_to_fifo8 (sct_target.h:229:5) 
// Empty process, no code generated 

//------------------------------------------------------------------------------
// Method process: run_core_data_mux8 (sct_target.h:218:5) 

always_comb 
begin : run_core_data_mux8     // sct_target.h:218:5
    if (run_reg_full[9])
    begin
        run_core_data_out[9] = run_core_data_d[9];
    end else begin
        run_core_data_out[9] = run_core_data[9];
    end
end
...
begin : methProc     // targ_vect.h:41:5
    ...
    begin
        // Call request() begin
        TMP_0 = run_core_req[i_1] || run_reg_full[i_1];
        // Call request() end
    end
end
