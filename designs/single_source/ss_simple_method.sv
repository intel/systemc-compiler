...
function void init_thread_func;
    ...
    case (init_thread_PROC_STATE)
        ...
        2: begin
            ...
            if (!TMP_2)
            begin
                init_thread_PROC_STATE_next = 3; return;    // method_test.h:116:33;
            end
        ...
        8: begin
            ...
            if (!TMP_8)
            begin
                init_thread_PROC_STATE_next = 9; return;    // method_test.h:125:33;
            end
        ...
        10: begin
            ...
            if (!TMP_10)
            begin
                init_thread_PROC_STATE_next = 11; return;    // method_test.h:127:33;
            end
        ...
        12: begin
            ...
            if (!TMP_12)
            begin
                init_thread_PROC_STATE_next = 13; return;    // method_test.h:130:30;
            end
        ...
        14: begin
            ...
            if (!TMP_14)
            begin
                init_thread_PROC_STATE_next = 15; return;    // method_test.h:132:30;
            end
        ...
        16: begin
            ...
            if (!TMP_16)
            begin
                init_thread_PROC_STATE_next = 17; return;    // method_test.h:134:30;
            end
        ...
        18: begin
            ...
            if (!TMP_18)
            begin
                init_thread_PROC_STATE_next = 19; return;    // method_test.h:136:33;
            end
        ...
        20: begin
            ...
            if (!TMP_20)
            begin
                init_thread_PROC_STATE_next = 21; return;    // method_test.h:138:33;
            end
        ...
        22: begin
            ...
            if (!TMP_22)
            begin
                init_thread_PROC_STATE_next = 23; return;    // method_test.h:140:33;
            end
