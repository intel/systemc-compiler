...
//------------------------------------------------------------------------------
// Clocked THREAD: return_func4 (test_return.cpp:105:5) 
...
// Next-state combinational logic
always_comb begin : return_func4_comb     // test_return.cpp:105:5
    return_func4_func;
end
function void return_func4_func;
    ...
    case (return_func4_PROC_STATE)
        0: begin
            blockIndx_next = s;
            // Call ff5() begin
            return_func4_PROC_STATE_next = 1; return;    // test_return.cpp:99:13;
            // Call ff5() end
        end
        1: begin
            // Call ff5() begin
            ...
            // Call ff5() end
            return_func4_PROC_STATE_next = 2; return;    // test_return.cpp:111:13;
        end
        2: begin
            blockIndx_next = s;
            // Call ff5() begin
...
begin : return_func4_ff
    if ( ~rst ) begin
        return_func4_PROC_STATE <= 0;    // test_return.cpp:107:9;
    end
    else begin
