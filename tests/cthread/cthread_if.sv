...
//------------------------------------------------------------------------------
// Clocked THREAD: smem_if_binary_const (test_if.cpp:191:5) 
...
// Next-state combinational logic
always_comb begin : smem_if_binary_const_comb     // test_if.cpp:191:5
...
//------------------------------------------------------------------------------
// Method process: simple_no_wait (test_if.cpp:203:5) 

always_comb 
begin : simple_no_wait     // test_if.cpp:203:5
    integer k;
    k = 0;
    if (|in)
    begin
...
//------------------------------------------------------------------------------
// Clocked THREAD: simple_wait (test_if.cpp:226:5) 
...
// Next-state combinational logic
always_comb begin : simple_wait_comb     // test_if.cpp:226:5
    simple_wait_func;
end
function void simple_wait_func;
    ...
    case (simple_wait_PROC_STATE)
        0: begin
            ...
            begin
                k = 1;
                simple_wait_PROC_STATE_next = 1; return;    // test_if.cpp:234:17;
            end else begin
                if (|out)
                begin
                    k = 4;
                    simple_wait_PROC_STATE_next = 3; return;    // test_if.cpp:246:21;
                end
            end
            simple_wait_PROC_STATE_next = 4; return;    // test_if.cpp:250:13;
        end
        1: begin
            if (|out)
            begin
                k = 2;
                simple_wait_PROC_STATE_next = 2; return;    // test_if.cpp:238:21;
            end else begin
                k = 3;
            end
            simple_wait_PROC_STATE_next = 4; return;    // test_if.cpp:250:13;
...
begin : simple_wait_ff
    if ( ~arstn ) begin
        integer k;
        k = 0;
        simple_wait_PROC_STATE <= 0;    // test_if.cpp:229:9;
    end
    else begin
...
//------------------------------------------------------------------------------
// Clocked THREAD: if_stmt_wait0 (test_if.cpp:255:5) 
...
// Next-state combinational logic
always_comb begin : if_stmt_wait0_comb     // test_if.cpp:255:5
    if_stmt_wait0_func;
end
function void if_stmt_wait0_func;
    ...
    case (if_stmt_wait0_PROC_STATE)
        0: begin
            ...
            begin
                k = 1;
                if_stmt_wait0_PROC_STATE_next = 1; return;    // test_if.cpp:263:17;
            end
            k = 2;
            if_stmt_wait0_PROC_STATE_next = 2; return;    // test_if.cpp:267:13;
        end
        1: begin
            k = 2;
            if_stmt_wait0_PROC_STATE_next = 2; return;    // test_if.cpp:267:13;
...
begin : if_stmt_wait0_ff
    if ( ~arstn ) begin
        integer k;
        k = 0;
        if_stmt_wait0_PROC_STATE <= 0;    // test_if.cpp:258:9;
    end
    else begin
...
//------------------------------------------------------------------------------
// Clocked THREAD: if_stmt_wait1 (test_if.cpp:273:5) 
...
// Next-state combinational logic
always_comb begin : if_stmt_wait1_comb     // test_if.cpp:273:5
    if_stmt_wait1_func;
end
function void if_stmt_wait1_func;
    ...
    case (if_stmt_wait1_PROC_STATE)
        0: begin
            k = 1;
            if_stmt_wait1_PROC_STATE_next = 1; return;    // test_if.cpp:280:13;
        end
        1: begin
            if (|in)
            begin
                k = 2;
                if_stmt_wait1_PROC_STATE_next = 2; return;    // test_if.cpp:284:17;
            end
            k = 1;
            if_stmt_wait1_PROC_STATE_next = 1; return;    // test_if.cpp:280:13;
        end
...
begin : if_stmt_wait1_ff
    if ( ~arstn ) begin
        integer k;
        k = 0;
        if_stmt_wait1_PROC_STATE <= 0;    // test_if.cpp:276:9;
    end
    else begin
...
//------------------------------------------------------------------------------
// Clocked THREAD: if_stmt_wait2 (test_if.cpp:290:5) 
...
// Next-state combinational logic
always_comb begin : if_stmt_wait2_comb     // test_if.cpp:290:5
    if_stmt_wait2_func;
end
function void if_stmt_wait2_func;
    ...
    case (if_stmt_wait2_PROC_STATE)
        0: begin
            ...
            begin
                k = 1;
                if_stmt_wait2_PROC_STATE_next = 1; return;    // test_if.cpp:298:17;
            end else begin
                k = 3;
                if_stmt_wait2_PROC_STATE_next = 2; return;    // test_if.cpp:303:17;
            end
        end
        1: begin
            k = 2;
...
begin : if_stmt_wait2_ff
    if ( ~arstn ) begin
        integer k;
        k = 0;
        if_stmt_wait2_PROC_STATE <= 0;    // test_if.cpp:293:9;
    end
    else begin
...
//------------------------------------------------------------------------------
// Clocked THREAD: if_stmt_wait2a (test_if.cpp:309:5) 
...
// Next-state combinational logic
always_comb begin : if_stmt_wait2a_comb     // test_if.cpp:309:5
    if_stmt_wait2a_func;
end
function void if_stmt_wait2a_func;
    ...
    case (if_stmt_wait2a_PROC_STATE)
        0: begin
            ...
            begin
                k = 1;
                if_stmt_wait2a_PROC_STATE_next = 1; return;    // test_if.cpp:317:17;
            end else begin
                k = 3;
                if_stmt_wait2a_PROC_STATE_next = 2; return;    // test_if.cpp:322:17;
            end
        end
        1: begin
            k = 2;
...
begin : if_stmt_wait2a_ff
    if ( ~arstn ) begin
        integer k;
        k = 0;
        if_stmt_wait2a_PROC_STATE <= 0;    // test_if.cpp:312:9;
    end
    else begin
...
//------------------------------------------------------------------------------
// Clocked THREAD: if_stmt_wait3 (test_if.cpp:331:5) 
...
// Next-state combinational logic
always_comb begin : if_stmt_wait3_comb     // test_if.cpp:331:5
    if_stmt_wait3_func;
end
function void if_stmt_wait3_func;
    ...
    case (if_stmt_wait3_PROC_STATE)
        0: begin
            ...
            begin
                k = 1;
                if_stmt_wait3_PROC_STATE_next = 1; return;    // test_if.cpp:339:17;
            end else begin
                if (|out)
                begin
                    if (out == in)
                    begin
                        k = 4;
                        if_stmt_wait3_PROC_STATE_next = 3; return;    // test_if.cpp:352:25;
                    end
                end
            end
            if_stmt_wait3_PROC_STATE_next = 4; return;    // test_if.cpp:358:13;
        end
        1: begin
            if (|out)
            begin
                k = 2;
                if_stmt_wait3_PROC_STATE_next = 2; return;    // test_if.cpp:343:21;
            end else begin
                k = 3;
            end
            if_stmt_wait3_PROC_STATE_next = 4; return;    // test_if.cpp:358:13;
...
begin : if_stmt_wait3_ff
    if ( ~arstn ) begin
        integer k;
        k = 0;
        if_stmt_wait3_PROC_STATE <= 0;    // test_if.cpp:334:9;
    end
    else begin
...
//------------------------------------------------------------------------------
// Clocked THREAD: if_stmt_wait_for0 (test_if.cpp:364:5) 
...
// Next-state combinational logic
always_comb begin : if_stmt_wait_for0_comb     // test_if.cpp:364:5
...
function void if_stmt_wait_for0_func;
    ...
    case (if_stmt_wait_for0_PROC_STATE)
        0: begin
            ...
            begin
                k_next = 1;
                if_stmt_wait_for0_PROC_STATE_next = 1; return;    // test_if.cpp:377:17;
            end
            ...
            begin
                k_next = 2;
                if_stmt_wait_for0_PROC_STATE_next = 2; return;    // test_if.cpp:386:17;
            end
            if_stmt_wait_for0_PROC_STATE_next = 3; return;    // test_if.cpp:389:13;
        end
        1: begin
            for (integer i_1 = 0; i_1 < 3; i_1++)
            begin
...
begin : if_stmt_wait_for0_ff
    if ( ~arstn ) begin
        k0 <= 0;
        if_stmt_wait_for0_PROC_STATE <= 0;    // test_if.cpp:367:9;
    end
    else begin
        k0 <= k_next;
...
//------------------------------------------------------------------------------
// Clocked THREAD: if_stmt_wait_for1 (test_if.cpp:395:5) 
...
// Next-state combinational logic
always_comb begin : if_stmt_wait_for1_comb     // test_if.cpp:395:5
    ...
    case (if_stmt_wait_for1_PROC_STATE)
        0: begin
            ...
            begin
                ...
                k_next0 = 1;
                if_stmt_wait_for1_PROC_STATE_next = 1; return;    // test_if.cpp:407:17;
            end else begin
                k_next0 = 4;
                if_stmt_wait_for1_PROC_STATE_next = 4; return;    // test_if.cpp:423:17;
            end
        end
        1: begin
            if (|out)
            begin
                ...
                k_next0 = 3;
                if_stmt_wait_for1_PROC_STATE_next = 2; return;    // test_if.cpp:415:21;
            end
            k_next0 = 2;
            if_stmt_wait_for1_PROC_STATE_next = 3; return;    // test_if.cpp:418:17;
        end
        2: begin
            k_next0 = 2;
            if_stmt_wait_for1_PROC_STATE_next = 3; return;    // test_if.cpp:418:17;
...
begin : if_stmt_wait_for1_ff
    if ( ~arstn ) begin
        k1 <= 0;
        if_stmt_wait_for1_PROC_STATE <= 0;    // test_if.cpp:398:9;
    end
    else begin
        k1 <= k_next0;
...
//------------------------------------------------------------------------------
// Clocked THREAD: if_stmt_wait_for2 (test_if.cpp:430:5) 
...
// Next-state combinational logic
always_comb begin : if_stmt_wait_for2_comb     // test_if.cpp:430:5
...
function void if_stmt_wait_for2_func;
    ...
    case (if_stmt_wait_for2_PROC_STATE)
        0: begin
            ...
            begin
                k = 1;
                if_stmt_wait_for2_PROC_STATE_next = 1; return;    // test_if.cpp:440:21;
            end
            if_stmt_wait_for2_PROC_STATE_next = 2; return;    // test_if.cpp:443:17;
        end
        1: begin
            if_stmt_wait_for2_PROC_STATE_next = 2; return;    // test_if.cpp:443:17;
        end
...
begin : if_stmt_wait_for2_ff
    if ( ~arstn ) begin
        integer k;
        k = 0;
        if_stmt_wait_for2_PROC_STATE <= 0;    // test_if.cpp:433:9;
    end
    else begin
        i0 <= i_next;
...
//------------------------------------------------------------------------------
// Clocked THREAD: if_stmt_wait_for2a (test_if.cpp:448:5) 
...
// Next-state combinational logic
always_comb begin : if_stmt_wait_for2a_comb     // test_if.cpp:448:5
...
function void if_stmt_wait_for2a_func;
    ...
    case (if_stmt_wait_for2a_PROC_STATE)
        0: begin
            ...
            begin
                k = 1;
                if_stmt_wait_for2a_PROC_STATE_next = 1; return;    // test_if.cpp:459:25;
            end
            if_stmt_wait_for2a_PROC_STATE_next = 2; return;    // test_if.cpp:462:21;
        end
        1: begin
            if_stmt_wait_for2a_PROC_STATE_next = 2; return;    // test_if.cpp:462:21;
        end
        2: begin
            ...
            if_stmt_wait_for2a_PROC_STATE_next = 3; return;    // test_if.cpp:466:13;
        end
        3: begin
            i_next0 = 0;
            j_next = 0;
...
begin : if_stmt_wait_for2a_ff
    if ( ~arstn ) begin
        integer k;
        k = 0;
        if_stmt_wait_for2a_PROC_STATE <= 0;    // test_if.cpp:451:9;
    end
    else begin
        j0 <= j_next;
        i1 <= i_next0;
...
//------------------------------------------------------------------------------
// Clocked THREAD: if_stmt_wait_for2b (test_if.cpp:470:5) 
...
// Next-state combinational logic
always_comb begin : if_stmt_wait_for2b_comb     // test_if.cpp:470:5
...
function void if_stmt_wait_for2b_func;
    ...
    case (if_stmt_wait_for2b_PROC_STATE)
        0: begin
            ...
            begin
                k = 1;
                if_stmt_wait_for2b_PROC_STATE_next = 1; return;    // test_if.cpp:480:21;
            end
            j_next0 = 0;
            if (|out)
            begin
                ...
                k = 3;
                if_stmt_wait_for2b_PROC_STATE_next = 2; return;    // test_if.cpp:488:25;
            end
            if_stmt_wait_for2b_PROC_STATE_next = 3; return;    // test_if.cpp:490:21;
        end
        1: begin
            j_next0 = 0;
            if (|out)
        ...
        3: begin
            ...
            if_stmt_wait_for2b_PROC_STATE_next = 4; return;    // test_if.cpp:493:17;
        end
        4: begin
            i_next1++;
            if (i_next1 < 3)
...
begin : if_stmt_wait_for2b_ff
    if ( ~arstn ) begin
        integer k;
        k = 0;
        if_stmt_wait_for2b_PROC_STATE <= 0;    // test_if.cpp:473:9;
    end
    else begin
        i2 <= i_next1;
        j1 <= j_next0;
...
//------------------------------------------------------------------------------
// Clocked THREAD: if_stmt_const_prop1 (test_if.cpp:498:5) 

// Next-state combinational logic
always_comb begin : if_stmt_const_prop1_comb     // test_if.cpp:498:5
...
//------------------------------------------------------------------------------
// Clocked THREAD: if_stmt_const_prop2 (test_if.cpp:516:5) 

// Next-state combinational logic
always_comb begin : if_stmt_const_prop2_comb     // test_if.cpp:516:5
