...
//------------------------------------------------------------------------------
// Clocked THREAD: while_with_wait0 (test_while.cpp:72:5) 
...
always_comb begin : while_with_wait0_comb     // test_while.cpp:72:5
...
function void while_with_wait0_func;
    ...
    case (while_with_wait0_PROC_STATE)
        0: begin
            i_next = 0;
            while_with_wait0_PROC_STATE_next = 1; return;    // test_while.cpp:80:17;
        end
        1: begin
            i_next++;
            if (i_next < 3)
...
begin : while_with_wait0_ff
    if ( ~arstn ) begin
        while_with_wait0_PROC_STATE <= 0;    // test_while.cpp:74:9;
    end
    else begin
        i <= i_next;
...
//------------------------------------------------------------------------------
// Clocked THREAD: while_with_wait0a (test_while.cpp:87:5) 
...
// Next-state combinational logic
always_comb begin : while_with_wait0a_comb     // test_while.cpp:87:5
...
function void while_with_wait0a_func;
    ...
    case (while_with_wait0a_PROC_STATE)
        0: begin
            if (i_next0 < 3)
            begin
                while_with_wait0a_PROC_STATE_next = 1; return;    // test_while.cpp:94:17;
            end
            while_with_wait0a_PROC_STATE_next = 2; return;    // test_while.cpp:97:13;
        end
        1: begin
            i_next0++;
            if (i_next0 < 3)
...
begin : while_with_wait0a_ff
    if ( ~arstn ) begin
        i0 <= 0;
        while_with_wait0a_PROC_STATE <= 0;    // test_while.cpp:90:9;
    end
    else begin
        i0 <= i_next0;
...
//------------------------------------------------------------------------------
// Clocked THREAD: while_with_wait0b (test_while.cpp:101:5) 
...
// Next-state combinational logic
always_comb begin : while_with_wait0b_comb     // test_while.cpp:101:5
...
function void while_with_wait0b_func;
    ...
    case (while_with_wait0b_PROC_STATE)
        0: begin
            if (i_next1 < s)
            begin
                while_with_wait0b_PROC_STATE_next = 1; return;    // test_while.cpp:108:17;
            end
            while_with_wait0b_PROC_STATE_next = 2; return;    // test_while.cpp:111:13;
        end
        1: begin
            i_next1++;
            if (i_next1 < s)
...
begin : while_with_wait0b_ff
    if ( ~arstn ) begin
        i1 <= 0;
        while_with_wait0b_PROC_STATE <= 0;    // test_while.cpp:104:9;
    end
    else begin
        i1 <= i_next1;
...
//------------------------------------------------------------------------------
// Clocked THREAD: while_with_wait1 (test_while.cpp:116:5) 
...
// Next-state combinational logic
always_comb begin : while_with_wait1_comb     // test_while.cpp:116:5
...
function void while_with_wait1_func;
    ...
    case (while_with_wait1_PROC_STATE)
        0: begin
            ...
            i_next2++;
            out_next = 1;
            while_with_wait1_PROC_STATE_next = 1; return;    // test_while.cpp:127:17;
        end
        1: begin
            if (i_next2 < 3)
            begin
            ...
            out_next = 2;
            while_with_wait1_PROC_STATE_next = 2; return;    // test_while.cpp:130:13;
        end
        2: begin
            i_next2 = 0;
            i_next2++;
...
begin : while_with_wait1_ff
    if ( ~arstn ) begin
        out <= 0;
        while_with_wait1_PROC_STATE <= 0;    // test_while.cpp:119:9;
    end
    else begin
        out <= out_next;
        i2 <= i_next2;
...
//------------------------------------------------------------------------------
// Clocked THREAD: while_with_wait2 (test_while.cpp:135:5) 
...
// Next-state combinational logic
always_comb begin : while_with_wait2_comb     // test_while.cpp:135:5
...
function void while_with_wait2_func;
    ...
    case (while_with_wait2_PROC_STATE)
        0: begin
            ...
            i_next3++;
            out_next0 = 1;
            while_with_wait2_PROC_STATE_next = 1; return;    // test_while.cpp:146:17;
        end
        1: begin
            if (in > 1)
            begin
                out_next0 = 2;
                while_with_wait2_PROC_STATE_next = 2; return;    // test_while.cpp:150:21;
            end
            if (i_next3 < 3)
            begin
                i_next3++;
            ...
            out_next0 = 3;
            while_with_wait2_PROC_STATE_next = 3; return;    // test_while.cpp:154:13;
        end
        2: begin
            if (i_next3 < 3)
            begin
...
begin : while_with_wait2_ff
    if ( ~arstn ) begin
        out <= 0;
        while_with_wait2_PROC_STATE <= 0;    // test_while.cpp:138:9;
    end
    else begin
        out <= out_next0;
        i3 <= i_next3;
...
//------------------------------------------------------------------------------
// Clocked THREAD: while_with_for (test_while.cpp:159:5) 
...
// Next-state combinational logic
always_comb begin : while_with_for_comb     // test_while.cpp:159:5
    while_with_for_func;
end
function void while_with_for_func;
    ...
    case (while_with_for_PROC_STATE)
        0: begin
            ...
            while_with_for_PROC_STATE_next = 1; return;    // test_while.cpp:175:21;
        end
        1: begin
            j_next++;
            if (j_next < 2)
            ...
            out_next1 = 3;
            while_with_for_PROC_STATE_next = 2; return;    // test_while.cpp:179:13;
        end
        2: begin
            i_next4 = 0;
            i_next4++;
...
begin : while_with_for_ff
    if ( ~arstn ) begin
        out <= 0;
        while_with_for_PROC_STATE <= 0;    // test_while.cpp:162:9;
    end
    else begin
        out <= out_next1;
        j <= j_next;
...
//------------------------------------------------------------------------------
// Clocked THREAD: while_with_signal_cond (test_while.cpp:184:5) 
...
// Next-state combinational logic
always_comb begin : while_with_signal_cond_comb     // test_while.cpp:184:5
...
function void while_with_signal_cond_func;
    ...
    case (while_with_signal_cond_PROC_STATE)
        0: begin
            ...
            begin
                out_next2 = 1;
                while_with_signal_cond_PROC_STATE_next = 1; return;    // test_while.cpp:193:17;
            end
            out_next2 = 2;
            while_with_signal_cond_PROC_STATE_next = 2; return;    // test_while.cpp:197:13;
        end
        1: begin
            if (|in)
            begin
...
begin : while_with_signal_cond_ff
    if ( ~arstn ) begin
        out <= 0;
        while_with_signal_cond_PROC_STATE <= 0;    // test_while.cpp:187:9;
    end
    else begin
        out <= out_next2;
...
function void while_with_binary_oper_func;
    ...
    case (while_with_binary_oper_PROC_STATE)
        0: begin
            ...
            while_with_binary_oper_PROC_STATE_next = 2; return;    // test_while.cpp:214:13;
        end
        1: begin
            k = 2;
            if (b1_next || b2_next)
...
//------------------------------------------------------------------------------
// Clocked THREAD: while_with_binary_oper1 (test_while.cpp:218:5) 
...
// Next-state combinational logic
always_comb begin : while_with_binary_oper1_comb     // test_while.cpp:218:5
...
function void while_with_binary_oper1_func;
    ...
    case (while_with_binary_oper1_PROC_STATE)
        0: begin
            ...
            begin
                k = 1;
                while_with_binary_oper1_PROC_STATE_next = 1; return;    // test_while.cpp:227:17;
            end
            while_with_binary_oper1_PROC_STATE_next = 2; return;    // test_while.cpp:230:13;
        end
        1: begin
            k = 2;
            if (b1_next0 && b2_next0)
...
begin : while_with_binary_oper1_ff
    if ( ~arstn ) begin
        integer k;
        k = 0;
        while_with_binary_oper1_PROC_STATE <= 0;    // test_while.cpp:222:9;
    end
    else begin
        b10 <= b1_next0;
        b20 <= b2_next0;
...
//------------------------------------------------------------------------------
// Clocked THREAD: while_with_binary_oper2 (test_while.cpp:235:5) 
...
// Next-state combinational logic
always_comb begin : while_with_binary_oper2_comb     // test_while.cpp:235:5
...
function void while_with_binary_oper2_func;
    ...
    case (while_with_binary_oper2_PROC_STATE)
        0: begin
            ...
            begin
                k = 1;
                while_with_binary_oper2_PROC_STATE_next = 1; return;    // test_while.cpp:244:17;
            end
            while_with_binary_oper2_PROC_STATE_next = 2; return;    // test_while.cpp:247:13;
        end
        1: begin
            k = 2;
            if ((b1_next1 || b2_next1) && b3_next)
...
begin : while_with_binary_oper2_ff
    if ( ~arstn ) begin
        integer k;
        k = 0;
        while_with_binary_oper2_PROC_STATE <= 0;    // test_while.cpp:239:9;
    end
    else begin
        b11 <= b1_next1;
        b21 <= b2_next1;
...
//------------------------------------------------------------------------------
// Clocked THREAD: while_with_binary_oper3 (test_while.cpp:251:5) 
...
// Next-state combinational logic
always_comb begin : while_with_binary_oper3_comb     // test_while.cpp:251:5
...
function void while_with_binary_oper3_func;
    ...
    case (while_with_binary_oper3_PROC_STATE)
        0: begin
            ...
            begin
                k = 1;
                while_with_binary_oper3_PROC_STATE_next = 1; return;    // test_while.cpp:260:17;
            end
            while_with_binary_oper3_PROC_STATE_next = 2; return;    // test_while.cpp:263:13;
        end
        1: begin
            k = 2;
            if ((b1_next2 && b2_next2) || b3_next0)
...
begin : while_with_binary_oper3_ff
    if ( ~arstn ) begin
        integer k;
        k = 0;
        while_with_binary_oper3_PROC_STATE <= 0;    // test_while.cpp:255:9;
    end
    else begin
        b12 <= b1_next2;
        b22 <= b2_next2;
