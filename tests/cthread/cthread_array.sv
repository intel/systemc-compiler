...
// C++ data variables
localparam logic [31:0] DOMAIN_NUM = 'd1;
localparam logic [31:0] ECC_NUM = 'd0;
...
function void operProc_func;
    ...
    operProc_PROC_STATE_next = operProc_PROC_STATE;
    
    case (operProc_PROC_STATE)
        default : begin
            pwrout__next = 1;
            pwrout_nenable_next = 1;
            ...
            operProc_PROC_STATE_next = 0; return;    // test_cthread_array.cpp:181:13;
        end
        0: begin
            pwrout_nenable_next = pwrout__next;
            pwrout__next = pwrin_nenable;
...
begin : operProc_ff
    begin
        ...
        operProc_PROC_STATE <= operProc_PROC_STATE_next;
    end
end

//------------------------------------------------------------------------------
// Clocked THREAD: array_of_pointers2 (test_cthread_array.cpp:186:5) 
...
// Next-state combinational logic
always_comb begin : array_of_pointers2_comb     // test_cthread_array.cpp:186:5
...
function void array_of_pointers2_func;
    ...
    case (array_of_pointers2_PROC_STATE)
        0: begin
            ...
            array_of_pointers2_PROC_STATE_next = 1; return;    // test_cthread_array.cpp:193:13;
        end
        1: begin
            n[0][1] = m_next[1];
            m_next[1] = m_next[0] + i_next;
...
begin : array_of_pointers2_ff
    if ( ~arstn ) begin
        ...
        i <= m[0];
        array_of_pointers2_PROC_STATE <= 0;    // test_cthread_array.cpp:189:9;
    end
    else begin
        i <= i_next;
        m <= m_next;
