...
//------------------------------------------------------------------------------
// Clocked THREAD: wait_n_reset_decl (test_cthread_wait_n.cpp:85:5) 
...
always_comb begin : wait_n_reset_decl_comb     // test_cthread_wait_n.cpp:85:5
...
function void wait_n_reset_decl_func;
    ...
    case (wait_n_reset_decl_PROC_STATE)
        0: begin
            ...
            wait_n_reset_decl_PROC_STATE_next = 1; return;    // test_cthread_wait_n.cpp:92:13;
        end
        1: begin
...
begin : wait_n_reset_decl_ff
    if ( ~rstn ) begin
        ...
        k = 1;
        i = k + 1;
        wait_n_reset_decl_PROC_STATE <= 0;    // test_cthread_wait_n.cpp:89:9;
...
//------------------------------------------------------------------------------
// Clocked THREAD: one_wait_n (test_cthread_wait_n.cpp:96:5) 
...
// Next-state combinational logic
always_comb begin : one_wait_n_comb     // test_cthread_wait_n.cpp:96:5
    one_wait_n_func;
end
function void one_wait_n_func;
    ...
    case (one_wait_n_PROC_STATE)
        0: begin
            one_wait_n_PROC_STATE_next = 1; return;    // test_cthread_wait_n.cpp:100:13;
        end
        1: begin
            i_next++;
            one_wait_n_WAIT_N_COUNTER_next = 2;
            one_wait_n_PROC_STATE_next = 2; return;    // test_cthread_wait_n.cpp:102:13;
        end
        2: begin
...
begin : one_wait_n_ff
    if ( ~rstn ) begin
        i <= 0;
        one_wait_n_PROC_STATE <= 0;    // test_cthread_wait_n.cpp:98:9;
...
//------------------------------------------------------------------------------
// Clocked THREAD: thread0 (test_cthread_wait_n.cpp:106:5) 
...
// Next-state combinational logic
always_comb begin : thread0_comb     // test_cthread_wait_n.cpp:106:5
    thread0_func;
end
function void thread0_func;
    ...
    case (thread0_PROC_STATE)
        0: begin
            ...
            thread0_PROC_STATE_next = 1; return;    // test_cthread_wait_n.cpp:109:13;
        end
        1: begin
            ...
            thread0_PROC_STATE_next = 2; return;    // test_cthread_wait_n.cpp:110:13;
        end
        2: begin
            if (thread0_WAIT_N_COUNTER != 1) begin
                thread0_WAIT_N_COUNTER_next = thread0_WAIT_N_COUNTER - 1;
            ...
            thread0_PROC_STATE_next = 3; return;    // test_cthread_wait_n.cpp:111:13;
        end
        3: begin
            if (thread0_WAIT_N_COUNTER != 1) begin
                thread0_WAIT_N_COUNTER_next = thread0_WAIT_N_COUNTER - 1;
            ...
            thread0_PROC_STATE_next = 0; return;    // test_cthread_wait_n.cpp:108:13;
        end
    endcase
endfunction
...
begin : thread0_ff
    if ( ~rstn ) begin
        thread0_PROC_STATE <= 0;    // test_cthread_wait_n.cpp:108:13;
...
//------------------------------------------------------------------------------
// Clocked THREAD: thread1 (test_cthread_wait_n.cpp:117:5) 
...
// Next-state combinational logic
always_comb begin : thread1_comb     // test_cthread_wait_n.cpp:117:5
    thread1_func;
end
    ...
    case (thread1_PROC_STATE)
        0: begin
            if (thread1_WAIT_N_COUNTER != 1) begin
                ...
                thread1_PROC_STATE_next = 0; return;    // test_cthread_wait_n.cpp:120:13;
            end;
            usig_next = 1;
...
begin : thread1_ff
    if ( ~rstn ) begin
        ...
        thread1_PROC_STATE <= 0;    // test_cthread_wait_n.cpp:120:13;
...
//------------------------------------------------------------------------------
// Clocked THREAD: thread1a (test_cthread_wait_n.cpp:125:5) 
...
// Next-state combinational logic
always_comb begin : thread1a_comb     // test_cthread_wait_n.cpp:125:5
    thread1a_func;
end
function void thread1a_func;
    ...
    case (thread1a_PROC_STATE)
        0: begin
            ...
            thread1a_PROC_STATE_next = 1; return;    // test_cthread_wait_n.cpp:128:13;
        end
        1: begin
...
begin : thread1a_ff
    if ( ~rstn ) begin
        thread1a_PROC_STATE <= 0;    // test_cthread_wait_n.cpp:126:9;
...
//------------------------------------------------------------------------------
// Clocked THREAD: thread1b (test_cthread_wait_n.cpp:132:5) 
...
// Next-state combinational logic
always_comb begin : thread1b_comb     // test_cthread_wait_n.cpp:132:5
    thread1b_func;
end
function void thread1b_func;
    ...
    case (thread1b_PROC_STATE)
        0: begin
            ...
            thread1b_PROC_STATE_next = 1; return;    // test_cthread_wait_n.cpp:136:13;
        end
        1: begin
...
begin : thread1b_ff
    if ( ~rstn ) begin
        thread1b_PROC_STATE <= 0;    // test_cthread_wait_n.cpp:133:9;
...
//------------------------------------------------------------------------------
// Clocked THREAD: thread1c (test_cthread_wait_n.cpp:140:5) 
...
// Next-state combinational logic
always_comb begin : thread1c_comb     // test_cthread_wait_n.cpp:140:5
    thread1c_func;
end
function void thread1c_func;
    ...
    case (thread1c_PROC_STATE)
        0: begin
            ...
            thread1c_PROC_STATE_next = 1; return;    // test_cthread_wait_n.cpp:143:13;
        end
        1: begin
...
begin : thread1c_ff
    if ( ~rstn ) begin
        thread1c_PROC_STATE <= 0;    // test_cthread_wait_n.cpp:141:9;
...
//------------------------------------------------------------------------------
// Clocked THREAD: thread1d (test_cthread_wait_n.cpp:148:5) 
...
// Next-state combinational logic
always_comb begin : thread1d_comb     // test_cthread_wait_n.cpp:148:5
    thread1d_func;
end
function void thread1d_func;
    ...
    case (thread1d_PROC_STATE)
        0: begin
            ...
            thread1d_PROC_STATE_next = 1; return;    // test_cthread_wait_n.cpp:152:13;
        end
        1: begin
...
begin : thread1d_ff
    if ( ~rstn ) begin
        integer i;
        i = 1;
        thread1d_PROC_STATE <= 0;    // test_cthread_wait_n.cpp:150:9;
...
//------------------------------------------------------------------------------
// Clocked THREAD: thread2 (test_cthread_wait_n.cpp:156:5) 
...
// Next-state combinational logic
always_comb begin : thread2_comb     // test_cthread_wait_n.cpp:156:5
    thread2_func;
end
    ...
    case (thread2_PROC_STATE)
        0: begin
            if (thread2_WAIT_N_COUNTER != 1) begin
                ...
                thread2_PROC_STATE_next = 0; return;    // test_cthread_wait_n.cpp:158:13;
            end;
            thread2_WAIT_N_COUNTER_next = 1 + 1 + 1;
            thread2_PROC_STATE_next = 1; return;    // test_cthread_wait_n.cpp:159:13;
        end
        1: begin
            if (thread2_WAIT_N_COUNTER != 1) begin
                thread2_WAIT_N_COUNTER_next = thread2_WAIT_N_COUNTER - 1;
...
begin : thread2_ff
    if ( ~rstn ) begin
        ...
        thread2_PROC_STATE <= 0;    // test_cthread_wait_n.cpp:158:13;
...
//------------------------------------------------------------------------------
// Clocked THREAD: thread3 (test_cthread_wait_n.cpp:163:5) 
...
// Next-state combinational logic
always_comb begin : thread3_comb     // test_cthread_wait_n.cpp:163:5
    thread3_func;
end
function void thread3_func;
    ...
    case (thread3_PROC_STATE)
        0: begin
            ...
            thread3_PROC_STATE_next = 1; return;    // test_cthread_wait_n.cpp:170:13;
        end
        1: begin
            ...
            thread3_PROC_STATE_next = 2; return;    // test_cthread_wait_n.cpp:171:13;
        end
        2: begin
            if (thread3_WAIT_N_COUNTER != 1) begin
                thread3_WAIT_N_COUNTER_next = thread3_WAIT_N_COUNTER - 1;
            ...
            thread3_PROC_STATE_next = 0; return;    // test_cthread_wait_n.cpp:168:13;
        end
    endcase
endfunction
...
begin : thread3_ff
    if ( ~rstn ) begin
        thread3_PROC_STATE <= 0;    // test_cthread_wait_n.cpp:168:13;
...
//------------------------------------------------------------------------------
// Clocked THREAD: thread4_no_waitn (test_cthread_wait_n.cpp:175:5) 
...
// Next-state combinational logic
always_comb begin : thread4_no_waitn_comb     // test_cthread_wait_n.cpp:175:5
...
function void thread4_no_waitn_func;
    ...
    case (thread4_no_waitn_PROC_STATE)
        0: begin
            i_next0 = 0;
            thread4_no_waitn_PROC_STATE_next = 1; return;    // test_cthread_wait_n.cpp:179:17;
        end
        1: begin
            ++i_next0;
            if (i_next0 < 3)
            ...
            thread4_no_waitn_PROC_STATE_next = 0; return;    // test_cthread_wait_n.cpp:177:13;
        end
    endcase
endfunction
...
begin : thread4_no_waitn_ff
    if ( ~rstn ) begin
        thread4_no_waitn_PROC_STATE <= 0;    // test_cthread_wait_n.cpp:177:13;
    end
    else begin
        i0 <= i_next0;
...
//------------------------------------------------------------------------------
// Clocked THREAD: wait_n_const (test_cthread_wait_n.cpp:184:5) 
...
// Next-state combinational logic
always_comb begin : wait_n_const_comb     // test_cthread_wait_n.cpp:184:5
    wait_n_const_func;
end
function void wait_n_const_func;
    ...
    case (wait_n_const_PROC_STATE)
        0: begin
            ...
            wait_n_const_PROC_STATE_next = 1; return;    // test_cthread_wait_n.cpp:189:13;
        end
        1: begin
...
begin : wait_n_const_ff
    if ( ~rstn ) begin
        n0 = 2;
        wait_n_const_PROC_STATE <= 0;    // test_cthread_wait_n.cpp:186:9;
...
//------------------------------------------------------------------------------
// Clocked THREAD: wait_n_var (test_cthread_wait_n.cpp:193:5) 
...
// Next-state combinational logic
always_comb begin : wait_n_var_comb     // test_cthread_wait_n.cpp:193:5
    wait_n_var_func;
end
function void wait_n_var_func;
    ...
    case (wait_n_var_PROC_STATE)
        0: begin
            ...
            wait_n_var_PROC_STATE_next = 1; return;    // test_cthread_wait_n.cpp:199:13;
        end
        1: begin
...
begin : wait_n_var_ff
    if ( ~rstn ) begin
        integer unsigned n;
        n = 0;
        wait_n_var_PROC_STATE <= 0;    // test_cthread_wait_n.cpp:195:9;
...
//------------------------------------------------------------------------------
// Clocked THREAD: wait_n_calc (test_cthread_wait_n.cpp:203:5) 
...
// Next-state combinational logic
always_comb begin : wait_n_calc_comb     // test_cthread_wait_n.cpp:203:5
    wait_n_calc_func;
end
function void wait_n_calc_func;
    ...
    case (wait_n_calc_PROC_STATE)
        0: begin
            ...
            wait_n_calc_PROC_STATE_next = 1; return;    // test_cthread_wait_n.cpp:210:13;
        end
        1: begin
            ...
            wait_n_calc_PROC_STATE_next = 2; return;    // test_cthread_wait_n.cpp:213:13;
        end
        2: begin
            if (wait_n_calc_WAIT_N_COUNTER != 1) begin
                wait_n_calc_WAIT_N_COUNTER_next = wait_n_calc_WAIT_N_COUNTER - 1;
...
begin : wait_n_calc_ff
    if ( ~rstn ) begin
        wait_n_calc_PROC_STATE <= 0;    // test_cthread_wait_n.cpp:206:9;
...
//------------------------------------------------------------------------------
// Clocked THREAD: wait_n_calc_if (test_cthread_wait_n.cpp:218:5) 
...
// Next-state combinational logic
always_comb begin : wait_n_calc_if_comb     // test_cthread_wait_n.cpp:218:5
    wait_n_calc_if_func;
end
    ...
    case (wait_n_calc_if_PROC_STATE)
        0: begin
            ...
            begin
                ...
                wait_n_calc_if_PROC_STATE_next = 1; return;    // test_cthread_wait_n.cpp:225:27;
            end
            wait_n_calc_if_PROC_STATE_next = 2; return;    // test_cthread_wait_n.cpp:227:13;
        end
        1: begin
...
begin : wait_n_calc_if_ff
    if ( ~rstn ) begin
        wait_n_calc_if_PROC_STATE <= 0;    // test_cthread_wait_n.cpp:221:9;
...
//------------------------------------------------------------------------------
// Clocked THREAD: wait_n_calc_for (test_cthread_wait_n.cpp:232:5) 
...
// Next-state combinational logic
always_comb begin : wait_n_calc_for_comb     // test_cthread_wait_n.cpp:232:5
...
function void wait_n_calc_for_func;
    ...
    case (wait_n_calc_for_PROC_STATE)
        0: begin
            ...
            wait_n_calc_for_PROC_STATE_next = 1; return;    // test_cthread_wait_n.cpp:239:17;
        end
        1: begin
...
begin : wait_n_calc_for_ff
    if ( ~rstn ) begin
        n2 <= 3;
        wait_n_calc_for_PROC_STATE <= 0;    // test_cthread_wait_n.cpp:235:9;
...
//------------------------------------------------------------------------------
// Clocked THREAD: three_wait (test_cthread_wait_n.cpp:244:5) 
...
// Next-state combinational logic
always_comb begin : three_wait_comb     // test_cthread_wait_n.cpp:244:5
    three_wait_func;
end
function void three_wait_func;
    ...
    case (three_wait_PROC_STATE)
        0: begin
            three_wait_PROC_STATE_next = 1; return;    // test_cthread_wait_n.cpp:249:13;
        end
        1: begin
            three_wait_PROC_STATE_next = 2; return;    // test_cthread_wait_n.cpp:250:13;
        end
        2: begin
            three_wait_PROC_STATE_next = 3; return;    // test_cthread_wait_n.cpp:251:13;
        end
        3: begin
            three_wait_PROC_STATE_next = 1; return;    // test_cthread_wait_n.cpp:249:13;
        end
...
begin : three_wait_ff
    if ( ~rstn ) begin
        three_wait_PROC_STATE <= 0;    // test_cthread_wait_n.cpp:246:9;
    end
    else begin
...
//------------------------------------------------------------------------------
// Clocked THREAD: four_wait (test_cthread_wait_n.cpp:256:5) 
...
// Next-state combinational logic
always_comb begin : four_wait_comb     // test_cthread_wait_n.cpp:256:5
    four_wait_func;
end
function void four_wait_func;
    ...
    case (four_wait_PROC_STATE)
        0: begin
            four_wait_PROC_STATE_next = 1; return;    // test_cthread_wait_n.cpp:261:13;
        end
        1: begin
            four_wait_PROC_STATE_next = 2; return;    // test_cthread_wait_n.cpp:262:13;
        end
        2: begin
            four_wait_PROC_STATE_next = 3; return;    // test_cthread_wait_n.cpp:263:13;
        end
        3: begin
            four_wait_PROC_STATE_next = 4; return;    // test_cthread_wait_n.cpp:264:13;
        end
        4: begin
            four_wait_PROC_STATE_next = 1; return;    // test_cthread_wait_n.cpp:261:13;
        end
...
begin : four_wait_ff
    if ( ~rstn ) begin
        four_wait_PROC_STATE <= 0;    // test_cthread_wait_n.cpp:258:9;
    end
    else begin
...
//------------------------------------------------------------------------------
// Clocked THREAD: cntr_name_conflict (test_cthread_wait_n.cpp:271:5) 
...
// Next-state combinational logic
always_comb begin : cntr_name_conflict_comb     // test_cthread_wait_n.cpp:271:5
...
function void cntr_name_conflict_func;
    ...
    case (cntr_name_conflict_PROC_STATE)
        0: begin
            ...
            cntr_name_conflict_PROC_STATE_next = 1; return;    // test_cthread_wait_n.cpp:280:13;
        end
        1: begin
...
begin : cntr_name_conflict_ff
    if ( ~rstn ) begin
        ...
        cntr_name_conflict_PROC_STATE <= 0;    // test_cthread_wait_n.cpp:275:9;
...
//------------------------------------------------------------------------------
// Clocked THREAD: while_wait (test_cthread_wait_n.cpp:284:5) 
...
// Next-state combinational logic
always_comb begin : while_wait_comb     // test_cthread_wait_n.cpp:284:5
    while_wait_func;
end
    ...
    case (while_wait_PROC_STATE)
        0: begin
            ...
            begin
                ...
                while_wait_PROC_STATE_next = 1; return;    // test_cthread_wait_n.cpp:289:23;
            end
            while_wait_PROC_STATE_next = 2; return;    // test_cthread_wait_n.cpp:290:13;
        end
        1: begin
...
begin : while_wait_ff
    if ( ~rstn ) begin
        while_wait_PROC_STATE <= 0;    // test_cthread_wait_n.cpp:286:9;
...
//------------------------------------------------------------------------------
// Clocked THREAD: wait_1 (test_cthread_wait_n.cpp:295:5) 
...
// Next-state combinational logic
always_comb begin : wait_1_comb     // test_cthread_wait_n.cpp:295:5
    wait_1_func;
end
