...
//==============================================================================
//
// Module: derived (test_cthread_virtual_wait.cpp:58:5)
//
module derived // "t.d"
(
    input logic clk
...
//------------------------------------------------------------------------------
// Clocked THREAD: test_thread (test_cthread_virtual_wait.cpp:29:5) 
...
always_comb begin : test_thread_comb     // test_cthread_virtual_wait.cpp:29:5
    test_thread_func;
end
function void test_thread_func;
    ...
    case (test_thread_PROC_STATE)
        0: begin
            ...
            x_next = 0;
            test_thread_PROC_STATE_next = 1; return;    // test_cthread_virtual_wait.cpp:47:9;
            // Call virtual_wait() end
        end
        1: begin
            // Call virtual_wait() begin
            x_next = 1;
            test_thread_PROC_STATE_next = 2; return;    // test_cthread_virtual_wait.cpp:49:9;
            // Call virtual_wait() end
        end
        2: begin
            // Call virtual_wait() begin
...
begin : test_thread_ff
    if (nrst ) begin
        test_thread_PROC_STATE <= 0;    // test_cthread_virtual_wait.cpp:30:9;
    end
    else begin
        x <= x_next;
