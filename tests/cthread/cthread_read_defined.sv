...
// C++ data variables
localparam logic signed [31:0] CI = 'd1;
...
function void linear1_func;
    integer i;
    m_next = m;
    linear1_PROC_STATE_next = linear1_PROC_STATE;
    
    case (linear1_PROC_STATE)
        default : begin
            i = 1;
            k = m_next + CI;
            m_next = k - 1;
...
begin : linear1_ff
    begin
        m <= m_next;
        linear1_PROC_STATE <= linear1_PROC_STATE_next;
    end
end
...
logic signed [31:0] m2_next;
logic signed [31:0] k2;
logic signed [31:0] k2_next;
logic linear_comp_assign_PROC_STATE;
...
function void linear_comp_assign_func;
    ...
    k2_next = k2;
    m2_next = m2;
    linear_comp_assign_PROC_STATE_next = linear_comp_assign_PROC_STATE;
    
    case (linear_comp_assign_PROC_STATE)
        default : begin
            i = 1;
            i = i + 1;
...
begin : linear_comp_assign_ff
    begin
        m2 <= m2_next;
        k2 <= k2_next;
        linear_comp_assign_PROC_STATE <= linear_comp_assign_PROC_STATE_next;
    end
end
...
logic signed [31:0] k3_next;
logic signed [31:0] m3;
logic signed [31:0] m3_next;
logic signed [31:0] n3;
logic signed [31:0] n3_next;
logic linear_unary_PROC_STATE;
...
function void linear_unary_func;
    ...
    m3_next = m3;
    n3_next = n3;
    linear_unary_PROC_STATE_next = linear_unary_PROC_STATE;
    
    case (linear_unary_PROC_STATE)
        default : begin
            i = k3_next;
            i = --m3_next;
            n3_next++;
...
begin : linear_unary_ff
    begin
        ...
        m3 <= m3_next;
        n3 <= n3_next;
        linear_unary_PROC_STATE <= linear_unary_PROC_STATE_next;
    end
end
...
function void decl_init_func;
    ...
    logic [1:0] d[2];
    logic [2:0] e[3];
    decl_init_PROC_STATE_next = decl_init_PROC_STATE;
    
    case (decl_init_PROC_STATE)
        default : begin
            i = 0;
            j = i;
            b[0] = 1; b[1] = 2;
...
begin : decl_init_ff
    begin
        decl_init_PROC_STATE <= decl_init_PROC_STATE_next;
    end
end
...
function void decl_init_array_func;
    ...
    logic [3:0] c[2][3];
    integer d[4];
    decl_init_array_PROC_STATE_next = decl_init_array_PROC_STATE;
    
    case (decl_init_array_PROC_STATE)
        default : begin
            a[0] = 1; a[1] = 2; a[2] = 3;
...
begin : decl_init_array_ff
    begin
        decl_init_array_PROC_STATE <= decl_init_array_PROC_STATE_next;
    end
end
