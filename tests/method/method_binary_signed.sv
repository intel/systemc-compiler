...
begin : liter_suff_L     // test_binary_signed.cpp:72:5
    ...
    bz = 1 <<< 62;
    `ifndef INTEL_SVA_OFF
        assert (bz == 63'h4000000000000000) else $error("Assertion failed at test_binary_signed.cpp:50:24>");
    `endif // INTEL_SVA_OFF
    bz = (1 <<< 62) * (-2'sd1);
    `ifndef INTEL_SVA_OFF
    ...
    `ifndef INTEL_SVA_OFF
        assert (bz == 61'h1FFFFFFFFFFFFFFE) else $error("Assertion failed at test_binary_signed.cpp:50:24>");
    `endif // INTEL_SVA_OFF
end
