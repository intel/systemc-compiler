...
begin : sc_shift_type_extension_big_binary     // test_shift_type_ext.cpp:178:5
    ...
    x = 131'(y * z) >>> 8;
    x = 133'(y * z) >>> 8;
    x = 106'(y * 'hE8D4A51000) >>> 8;
    x = 117'(y * 'h4000000000000) >>> 8;
    x = 67'(y - 'hE8D4A51000) >>> 8;
    x = 72'(('h4000000000000 <<< 20) + y) >>> 8;
    x = 86'(y <<< 20) >>> 8;
    x = 42'(y <<< 20) >>> 8;
    x = 42'(y <<< x) >>> 8;
...
begin : sc_shift_type_extension_channel     // test_shift_type_ext.cpp:229:5
    ...
    a_1 = 0;
    x = 0;
    a_1 = 17'(signed'({1'b0, c1}) + c2) >>> 8;
    a_1 = 24'(signed'({1'b0, c1}) * c2) >>> 8;
...
begin : cpp_shift_type_extension     // test_shift_type_ext.cpp:350:5
    ...
    a_1 = 4 >>> c_1;
    a_1 = 64'(b_1 * c_1) >>> 8;
    b_1 = (signed'({1'b0, c_1}) + a_1) <<< a_1;
    b_1 = 33'(signed'({1'b0, c_1}) - a_1) >>> 32'(signed'({1'b0, b_1}) * a_1 + 1);
    l1 = 64'(b_1 * c_1) >>> 8;
    l2 = (l1 * 3) <<< 3;
    e = 0;
    a_1 = (e * b_1) <<< 3;
