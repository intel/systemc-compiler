...
localparam logic [31:0] minst_0_A = 'd1;
localparam logic [31:0] minst_0_B = 'd2;
...
begin : minst_meth     // test_mif_array_with_ports.cpp:41:5
    integer i;
    i = minst_m[0] + minst_0_A + minst_0_B;
...
function void minst_thrd_func;
    ...
    case (thrd_PROC_STATE)
        0: begin
            i = minst_n_next[0] + minst_0_A + minst_0_B;
            a_next = minst_in[0] + i;
...
begin : minst_meth0     // test_mif_array_with_ports.cpp:41:5
    integer i;
    i = minst_m[1] + minst_0_A + minst_0_B;
...
function void minst_thrd0_func;
    ...
    case (thrd_PROC_STATE0)
        0: begin
            i = minst_n_next[1] + minst_0_A + minst_0_B;
