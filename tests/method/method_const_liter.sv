...
localparam logic [31:0] C2 = 'd41;
localparam logic [3:0] SU = 'd4;
localparam logic signed [3:0] SI = -'d4;
localparam logic [31:0] BYTE_NUMBER = 'd4;
localparam logic [31:0] PORT_NUM = 'd1;
localparam logic [31:0] DATA_WIDTH = 'd8;
localparam logic [31:0] U = 'd4;
localparam logic signed [31:0] I = -'d4;
...
begin : sc_shift_type_extension_channel     // test_const_liter.cpp:98:5
    ...
    a = 0;
    x = 0;
    a = 17'(signed'({1'b0, c1}) + c2) >>> 8;
    a = 24'(signed'({1'b0, c1}) * c2) >>> 8;
    x = 137'(signed'({1'b0, c3}) * c4 - c2) >>> 17'(signed'({1'b0, c1}) + c2);
end
...
begin : extra_signed_remove     // test_const_liter.cpp:140:5
    ...
    u = signed'({1'b0, uu}) + c;
    `ifndef INTEL_SVA_OFF
        assert (u == 32'hFFFFFFFC) else $error("Assertion failed at test_const_liter.cpp:68:24>");
    `endif // INTEL_SVA_OFF
    ww = -7'sd42;
    w = ww + signed'({1'b0, u});
    `ifndef INTEL_SVA_OFF
