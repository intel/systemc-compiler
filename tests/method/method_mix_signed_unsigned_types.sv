...
begin : mix_sign_unsign     // test_mix_signed_unsigned_types.cpp:49:5
    ...
    A = par1;
    B = par2;
    C = par2 / signed'({1'b0, par1});
    // Call mix_sign_unsign_fn() end
    par1_1 = -32'sd2; par2_1 = 5; par3_1 = 0;
    // Call mix_sign_unsign_fn() begin
    A_1 = par1_1;
    B_1 = par2_1;
    C_1 = signed'({1'b0, par2_1}) / par1_1;
    // Call mix_sign_unsign_fn() end
    par1_2 = 2; par2_2 = -64'sd5; par3_2 = 'h7FFFFFFFFFFFFFFD;
    // Call mix_sign_unsign_fn() begin
    A_2 = par1_2;
    B_2 = par2_2;
    C_2 = par2_2 / signed'({1'b0, par1_2});
    // Call mix_sign_unsign_fn() end
    par1_3 = -64'sd2; par2_3 = 5; par3_3 = 0;
    // Call mix_sign_unsign_fn() begin
    A_3 = par1_3;
    B_3 = par2_3;
    C_3 = signed'({1'b0, par2_3}) / par1_3;
    // Call mix_sign_unsign_fn() end
