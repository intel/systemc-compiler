...
function void minst_thread_member_reg_func;
    ...
    l = minst_w_next[0][0] + minst_aw_next[0][0][j_next0] + minst_as[0][0][j_next0 + 1] + minst_asp[0][0][j_next0 + 2];
endfunction
...
function void minst_thread_member_reg0_func;
    ...
    l = minst_w_next[1][0] + minst_aw_next[1][0][j_next2] + minst_as[1][0][j_next2 + 1] + minst_asp[1][0][j_next2 + 2];
endfunction
