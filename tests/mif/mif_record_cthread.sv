...
function void minst_memRecArrThread_func;
    ...
    for (integer i = 0; i < 4; ++i)
    begin
        minst_ww_b[i] = (i < 2) ? minst_w_b_next[i] : 4'(i);
        sum = sum + minst_ww_b[i];
    end
endfunction
...
function void ninst_memRecArrThread_func;
    ...
    for (integer i = 0; i < 4; ++i)
    begin
        ninst_ww_b[i] = (i < 2) ? ninst_w_b_next[i] : 4'(i);
        sum = sum + ninst_ww_b[i];
    end
endfunction
