...
//------------------------------------------------------------------------------
// Clocked THREAD: record_return (test_return_cthread3.cpp:38:5) 
...
always_comb begin : record_return_comb     // test_return_cthread3.cpp:38:5
    record_return_func;
end
function void record_return_func;
    ...
    case (record_return_PROC_STATE)
        0: begin
            ...
            record_return_PROC_STATE_next = 1; return;    // test_return_cthread3.cpp:44:13;
        end
        1: begin
...
begin : record_return_ff
    if ( ~rstn ) begin
        record_return_PROC_STATE <= 0;    // test_return_cthread3.cpp:40:9;
    end
    else begin
        r_sin <= r_sin_next;
        r_cos <= r_cos_next;
