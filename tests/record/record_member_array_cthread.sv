...
function void fcall_param_func;
    ...
    // Call rec_param2_ref() end
    j_1 = sig;
    par_a = rarr_a_next[j_1]; par_b_2 = rarr_b_next[j_1];
    // Call rec_param0() begin
    l = par_b_2[0];
    // Call rec_param0() end
    par_a_next = rarr_a_next[j_1]; par_b_1 = rarr_b_next[j_1]; j = 0;
    // Call rec_param2_val() begin
...
function void fcall_return_func;
    ...
    case (fcall_return_PROC_STATE)
        0: begin
            par_a_1 = z_a_next; par_b_2 = z_b_next;
            // Call rec_return2() begin
            res_a_next = par_a_1; res_b_next = par_b_2;
        ...
        1: begin
            ...
            j = sig;
            par_a_1 = zarr_a_next[j]; par_b_2 = zarr_b_next[j];
            // Call rec_return2() begin
            res_a_next = par_a_1; res_b_next = par_b_2;
...
begin : fcall_return_ff
    if ( rst ) begin
        ...
        par_a = z_a; par_b_1 = z_b;
        // Call rec_return1() begin
        TMP_0_a = par_a; TMP_0_b = par_b_1;
