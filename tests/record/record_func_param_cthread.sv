...
function void record_fcall_val_reg_func;
    ...
    s_a_next0 = s_a0;
    s_b_next0 = s_b0;
    par_a = s_a_next0; par_b = s_b_next0;
    // Call f2() begin
    b = par_a;
    par_b = 2;
    // Call f2() end
...
function void record_fcall_two_val_func;
    ...
    s_a_next1 = s_a1;
    s_b_next1 = s_b1;
    par1_a = s_a_next1; par1_b = s_b_next1; par2_a = r_a; par2_b = r_b;
    // Call f3() begin
    b = par1_a || par2_a;
    par1_a = |(b + 1);
    par2_a = |(b - 1);
...
function void record_fcall_two_val2_func;
    ...
    gr_b_next = gr_b;
    gr_a_next = 1;
    par1_a = gr_a_next; par1_b = gr_b_next; par2_a = s_a; par2_b = s_b;
    // Call f3() begin
    b = 1;
    par1_a = |(b + 1);
    par2_a = |(b - 1);
...
logic s_a2;
logic s_a_next2;
logic signed [31:0] s_b2;
logic signed [31:0] s_b_next2;
...
function void record_fcall_const_ref2_func;
    ...
    case (record_fcall_const_ref2_PROC_STATE)
        ...
        1: begin
            // Call cref_cmp() begin
            TMP_0 = r_a_next0 == t_a_next && r_b_next0 == t_b_next;
            // Call cref_cmp() end
            b = TMP_0;
            t_a_next = 1;
            record_fcall_const_ref2_PROC_STATE_next = 1; return;    // test_func_param_cthread.cpp:202:13;
