...
//------------------------------------------------------------------------------
// Clocked THREAD: const_loc_thread (test_const_remove.cpp:376:5) 
...
// Next-state combinational logic
always_comb begin : const_loc_thread_comb     // test_const_remove.cpp:376:5
...
function void const_loc_thread_func;
    ...
    case (const_loc_thread_PROC_STATE)
        0: begin
            CC_next = 11;
            const_loc_thread_PROC_STATE_next = 1; return;    // test_const_remove.cpp:384:13;
        end
        1: begin
            i = CC_next + DD;
            CC_next = 11;
...
begin : const_loc_thread_ff
    if ( ~nrst ) begin
        ...
        EE = 22;
        DD = EE + 1;
        const_loc_thread_PROC_STATE <= 0;    // test_const_remove.cpp:380:9;
    end
    else begin
        CC <= CC_next;
