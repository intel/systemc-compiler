...
//------------------------------------------------------------------------------
// Clocked THREAD: empty_loop_thread (test_fcall_empty.cpp:90:5) 
...
always_comb begin : empty_loop_thread_comb     // test_fcall_empty.cpp:90:5
...
function void empty_loop_thread_func;
    ...
    case (empty_loop_thread_PROC_STATE)
        0: begin
            ...
            if (|s)
            begin
                empty_loop_thread_PROC_STATE_next = 1; return;    // test_fcall_empty.cpp:98:31;
            end
            empty_loop_thread_PROC_STATE_next = 2; return;    // test_fcall_empty.cpp:99:13;
        end
        1: begin
            if (|s)
            begin
...
begin : empty_loop_thread_ff
    if ( ~nrst ) begin
        empty_loop_thread_PROC_STATE <= 0;    // test_fcall_empty.cpp:93:9;
    end
    else begin
...
//------------------------------------------------------------------------------
// Method process: fcall_method (test_fcall_empty.cpp:105:5) 

always_comb 
begin : fcall_method     // test_fcall_empty.cpp:105:5
end

//------------------------------------------------------------------------------
// Clocked THREAD: fcall_thread (test_fcall_empty.cpp:109:5) 

// Next-state combinational logic
always_comb begin : fcall_thread_comb     // test_fcall_empty.cpp:109:5
    fcall_thread_func;
end
