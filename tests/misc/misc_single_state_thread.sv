...
logic signed [31:0] x_next10;
logic multistate_thread6_PROC_STATE;
...
function void multistate_thread6_func;
    x_next10 = x10;
    multistate_thread6_PROC_STATE_next = multistate_thread6_PROC_STATE;
    
    case (multistate_thread6_PROC_STATE)
        default : begin
            x_next10 = 0;
            x_next10++;
...
begin : multistate_thread6_ff
    begin
        x10 <= x_next10;
        multistate_thread6_PROC_STATE <= multistate_thread6_PROC_STATE_next;
    end
end
