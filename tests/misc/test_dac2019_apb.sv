...
logic apb_tar_psel_next;
logic apb_tar_penable_next;
logic apb_tar_pwrite_next;
logic [31:0] apb_tar_pwdata_next;
...
function void apb_tar_apb_thread_func;
    ...
    logic is_read;
    logic TMP_1;
    apb_tar_paddr_next = apb_tar_paddr;
    apb_tar_penable_next = apb_tar_penable;
    apb_tar_prdata_next = apb_tar_prdata;
    apb_tar_pready_next = apb_tar_pready;
    apb_tar_psel_next = apb_tar_psel;
    apb_tar_pslverr_next = apb_tar_pslverr;
    apb_tar_pwdata_next = apb_tar_pwdata;
    apb_tar_pwrite_next = apb_tar_pwrite;
...
begin : apb_tar_apb_thread_ff
    if ( ~apb_tar_rstn ) begin
        ...
        apb_tar_psel <= apb_tar_psel_next;
        apb_tar_penable <= apb_tar_penable_next;
        apb_tar_pwrite <= apb_tar_pwrite_next;
        apb_tar_pwdata <= apb_tar_pwdata_next;
